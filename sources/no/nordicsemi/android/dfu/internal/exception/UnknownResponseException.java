...
public class UnknownResponseException extends Exception {
    ...
    public String getMessage() {
        ...
        return String.format(locale, "%s (response: %s, expected: 0x%02X%02X..)", new Object[]{message, bytesToHex(bArr, 0, bArr.length), Integer.valueOf(this.mExpectedReturnCode), Integer.valueOf(this.mExpectedOpCode)});
    }
}
