...
interface DfuService extends DfuCallback {
    boolean initialize(@NonNull Intent intent, @NonNull BluetoothGatt bluetoothGatt, @FileType int i, @NonNull InputStream inputStream, @Nullable InputStream inputStream2) throws DfuException, DeviceDisconnectedException, UploadAbortedException;
