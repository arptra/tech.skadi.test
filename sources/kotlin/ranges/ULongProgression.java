...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1249fromClosedRange7ftBX0g(long j, long j2, long j3) {
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return ((int) ((j3 >>> 32) ^ j3)) + (((((int) ULong.m194constructorimpl(j ^ ULong.m194constructorimpl(j >>> 32))) * 31) + ((int) ULong.m194constructorimpl(j2 ^ ULong.m194constructorimpl(j2 >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m240toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m240toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    private ULongProgression(long j, long j2, long j3) {
        if (j3 == 0) {
            ...
            this.first = j;
            this.last = UProgressionUtilKt.m1223getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
        } else {
