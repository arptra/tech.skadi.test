...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ Object next() {
        return UInt.m109boximpl(m1241nextpVg5ArA());
    }

    /* renamed from: next-pVg5ArA  reason: not valid java name */
    public int m1241nextpVg5ArA() {
        int i = this.next;
        if (i != this.finalElement) {
            this.next = UInt.m115constructorimpl(this.step + i);
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m115constructorimpl(i3);
