...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    public static final class DefaultImpls {
        public static int compareTo(@NotNull ComparableTimeMark comparableTimeMark, @NotNull ComparableTimeMark comparableTimeMark2) {
            ...
            return Duration.m1350compareToLRDsOJo(comparableTimeMark.m1344minusUwyO8pc(comparableTimeMark2), Duration.Companion.m1454getZEROUwyO8pc());
        }
        ...
        public static ComparableTimeMark m1346minusLRDsOJo(@NotNull ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.m1345plusLRDsOJo(Duration.m1404unaryMinusUwyO8pc(j));
        }
    }
    ...
    @NotNull
    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    ComparableTimeMark m1343minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc  reason: not valid java name */
    long m1344minusUwyO8pc(@NotNull ComparableTimeMark comparableTimeMark);

    @NotNull
    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    ComparableTimeMark m1345plusLRDsOJo(long j);
}
