...
public final class TimedValue<T> {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.value, (Object) timedValue.value) && Duration.m1356equalsimpl0(this.duration, timedValue.duration);
    }
    ...
    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m1379hashCodeimpl(this.duration);
    }

    @NotNull
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1400toStringimpl(this.duration) + ')';
    }
