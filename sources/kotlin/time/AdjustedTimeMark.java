...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long m1339elapsedNowUwyO8pc() {
        return Duration.m1386minusLRDsOJo(this.mark.m1488elapsedNowUwyO8pc(), this.adjustment);
    }
    ...
    public TimeMark m1341minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1491minusLRDsOJo(this, j);
    }

    @NotNull
    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1342plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1387plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
