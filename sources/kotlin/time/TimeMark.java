...
public interface TimeMark {
    ...
    public static final class DefaultImpls {
        public static boolean hasNotPassedNow(@NotNull TimeMark timeMark) {
            return Duration.m1384isNegativeimpl(timeMark.m1488elapsedNowUwyO8pc());
        }
        ...
        public static TimeMark m1491minusLRDsOJo(@NotNull TimeMark timeMark, long j) {
            return timeMark.m1490plusLRDsOJo(Duration.m1404unaryMinusUwyO8pc(j));
        }

        @NotNull
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1492plusLRDsOJo(@NotNull TimeMark timeMark, long j) {
