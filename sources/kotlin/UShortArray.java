...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static final class Iterator implements java.util.Iterator<UShort>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ Object next() {
            return UShort.m295boximpl(m369nextMh2AYeg());
        }

        /* renamed from: next-Mh2AYeg  reason: not valid java name */
        public short m369nextMh2AYeg() {
            int i = this.index;
            short[] sArr = this.array;
            if (i < sArr.length) {
                this.index = i + 1;
                return UShort.m301constructorimpl(sArr[i]);
            }
    ...
    public static short[] m354constructorimpl(@NotNull short[] sArr) {
    ...
    public static boolean m356containsAllimpl(short[] r3, @org.jetbrains.annotations.NotNull java.util.Collection<kotlin.UShort> r4) {
        /*
