                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m587contentEqualslec5QzE(((ULongArray) t).m263unboximpl(), ((ULongArray) t2).m263unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m585contentEqualsKJPZfPQ(((UIntArray) t).m184unboximpl(), ((UIntArray) t2).m184unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m584contentEqualsFGO6Aew(((UShortArray) t).m368unboximpl(), ((UShortArray) t2).m368unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m586contentEqualskV0jMPg(((UByteArray) t).m105unboximpl(), ((UByteArray) t2).m105unboximpl())) {
                                                        return false;
                                                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m592contentToString2csIQuQ(((UByteArray) t).m105unboximpl()));
            } else if (t instanceof UShortArray) {
                sb.append(UArraysKt.m594contentToStringd6D3K8(((UShortArray) t).m368unboximpl()));
            } else if (t instanceof UIntArray) {
                sb.append(UArraysKt.m593contentToStringXUkPCBk(((UIntArray) t).m184unboximpl()));
            } else if (t instanceof ULongArray) {
                sb.append(UArraysKt.m595contentToStringuLth9ew(((ULongArray) t).m263unboximpl()));
            } else {
