...
public final class UNumbersKt {
    ...
    private static final int m270countOneBits7apg3OU(byte b) {
        return Integer.bitCount(UInt.m115constructorimpl(b & 255));
    }
    ...
    private static final int m273countOneBitsxj2QHRw(short s) {
        return Integer.bitCount(UInt.m115constructorimpl(s & UShort.MAX_VALUE));
    }
    ...
    private static final byte m279rotateLeftLxnNnR4(byte b, int i) {
        return UByte.m38constructorimpl(NumbersKt__NumbersKt.rotateLeft(b, i));
    }
    ...
    private static final int m280rotateLeftV7xB4Y4(int i, int i2) {
        return UInt.m115constructorimpl(Integer.rotateLeft(i, i2));
    }
    ...
    private static final short m281rotateLeftolVBNx4(short s, int i) {
        return UShort.m301constructorimpl(NumbersKt__NumbersKt.rotateLeft(s, i));
    }
    ...
    private static final byte m283rotateRightLxnNnR4(byte b, int i) {
        return UByte.m38constructorimpl(NumbersKt__NumbersKt.rotateRight(b, i));
    }
    ...
    private static final int m284rotateRightV7xB4Y4(int i, int i2) {
        return UInt.m115constructorimpl(Integer.rotateRight(i, i2));
    }
    ...
    private static final short m285rotateRightolVBNx4(short s, int i) {
        return UShort.m301constructorimpl(NumbersKt__NumbersKt.rotateRight(s, i));
    }
    ...
    private static final byte m286takeHighestOneBit7apg3OU(byte b) {
        return UByte.m38constructorimpl((byte) Integer.highestOneBit(b & 255));
    }
    ...
    private static final int m288takeHighestOneBitWZ4Q5Ns(int i) {
        return UInt.m115constructorimpl(Integer.highestOneBit(i));
    }
    ...
    private static final byte m290takeLowestOneBit7apg3OU(byte b) {
        return UByte.m38constructorimpl((byte) Integer.lowestOneBit(b & 255));
    }
    ...
    private static final int m292takeLowestOneBitWZ4Q5Ns(int i) {
        return UInt.m115constructorimpl(Integer.lowestOneBit(i));
    }
