...
class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static final byte[] readBytes(@org.jetbrains.annotations.NotNull java.io.File r10) {
        ...
        L_0x002b:
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r7)     // Catch:{ all -> 0x0028 }
            goto L_0x0068
        L_0x0038:
        ...
        L_0x0040:
            ...
            r5 = 2
            kotlin.io.ByteStreamsKt.copyTo$default(r0, r6, r3, r5, r8)     // Catch:{ all -> 0x0028 }
            int r5 = r6.size()     // Catch:{ all -> 0x0028 }
            int r5 = r5 + r1
            if (r5 < 0) goto L_0x006c
            byte[] r10 = r6.getBuffer()     // Catch:{ all -> 0x0028 }
            byte[] r2 = java.util.Arrays.copyOf(r2, r5)     // Catch:{ all -> 0x0028 }
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r7)     // Catch:{ all -> 0x0028 }
            int r4 = r6.size()     // Catch:{ all -> 0x0028 }
            byte[] r2 = kotlin.collections.ArraysKt.copyInto((byte[]) r10, (byte[]) r2, (int) r1, (int) r3, (int) r4)     // Catch:{ all -> 0x0028 }
        L_0x0068:
    ...
    @org.jetbrains.annotations.NotNull
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.lang.String readText(@org.jetbrains.annotations.NotNull java.io.File r2, @org.jetbrains.annotations.NotNull java.nio.charset.Charset r3) {
        /*
            java.lang.String r0 = "<this>"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r2, r0)
    ...
    public static final <T> T useLines(@org.jetbrains.annotations.NotNull java.io.File r2, @org.jetbrains.annotations.NotNull java.nio.charset.Charset r3, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<java.lang.String>, ? extends T> r4) {
        ...
        L_0x0028:
            r2 = 0
            r3 = 1
            kotlin.sequences.Sequence r1 = kotlin.io.TextStreamsKt.lineSequence(r0)     // Catch:{ all -> 0x0047 }
            java.lang.Object r4 = r4.invoke(r1)     // Catch:{ all -> 0x0047 }
    ...
    public static /* synthetic */ java.lang.Object useLines$default(java.io.File r1, java.nio.charset.Charset r2, kotlin.jvm.functions.Function1 r3, int r4, java.lang.Object r5) {
        ...
        L_0x002e:
            r1 = 0
            kotlin.sequences.Sequence r2 = kotlin.io.TextStreamsKt.lineSequence(r4)     // Catch:{ all -> 0x004c }
            java.lang.Object r2 = r3.invoke(r2)     // Catch:{ all -> 0x004c }
    ...
    public static final void forEachBlock(@org.jetbrains.annotations.NotNull java.io.File r1, int r2, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function2<? super byte[], ? super java.lang.Integer, kotlin.Unit> r3) {
        ...
        L_0x0017:
            ...
            if (r1 > 0) goto L_0x0026
            kotlin.Unit r1 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0024 }
            r1 = 0
            kotlin.io.CloseableKt.closeFinally(r0, r1)
            return
        L_0x0024:
        ...
        L_0x0026:
            ...
            r3.invoke(r2, r1)     // Catch:{ all -> 0x0024 }
            goto L_0x0017
        L_0x002e:
