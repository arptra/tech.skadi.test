...
public final class KFunctionImpl extends KCallableImpl<Object> implements FunctionBase<Object>, KFunction<Object>, FunctionWithAllInvokes {
    ...
    public final CallerImpl<Constructor<?>> createConstructorCaller(Constructor<?> constructor, FunctionDescriptor functionDescriptor, boolean z) {
        return (z || !InlineClassManglingRulesKt.shouldHideConstructorDueToInlineClassTypeValueParameters(functionDescriptor)) ? isBound() ? new CallerImpl.BoundConstructor(constructor, getBoundReceiver()) : new CallerImpl.Constructor(constructor) : isBound() ? new CallerImpl.AccessorForHiddenBoundConstructor(constructor, getBoundReceiver()) : new CallerImpl.AccessorForHiddenConstructor(constructor);
    }
    ...
    private KFunctionImpl(KDeclarationContainerImpl kDeclarationContainerImpl, String str, String str2, FunctionDescriptor functionDescriptor, Object obj) {
        ...
        this.caller$delegate = LazyKt.lazy(lazyThreadSafetyMode, new KFunctionImpl$caller$2(this));
        this.defaultCaller$delegate = LazyKt.lazy(lazyThreadSafetyMode, new KFunctionImpl$defaultCaller$2(this));
    }
