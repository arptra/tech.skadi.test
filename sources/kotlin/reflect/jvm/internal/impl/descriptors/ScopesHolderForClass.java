...
public final class ScopesHolderForClass<T extends MemberScope> {
    ...
    public final T getScope(@NotNull KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        return !kotlinTypeRefiner.isRefinementNeededForTypeConstructor(typeConstructor) ? getScopeForOwnerModule() : kotlinTypeRefiner.getOrPutScopeForClass(this.classDescriptor, new ScopesHolderForClass$getScope$1(this, kotlinTypeRefiner));
    }
