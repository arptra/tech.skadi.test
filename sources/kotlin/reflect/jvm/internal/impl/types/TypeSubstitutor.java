...
public class TypeSubstitutor {
    ...
    private static Annotations filterOutUnsafeVariance(@NotNull Annotations annotations) {
        ...
        return !annotations.hasAnnotation(StandardNames.FqNames.unsafeVariance) ? annotations : new FilteredAnnotations(annotations, new Function1<FqName, Boolean>() {
            private static /* synthetic */ void $$$reportNull$$$0(int i) {
    ...
    private List<TypeProjection> substituteTypeArguments(List<TypeParameterDescriptor> list, List<TypeProjection> list2, int i) throws SubstitutionException {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            ...
            } else if (i3 == 3 && typeParameterDescriptor.getVariance() != (variance = Variance.INVARIANT) && !unsafeSubstitute.isStarProjection()) {
