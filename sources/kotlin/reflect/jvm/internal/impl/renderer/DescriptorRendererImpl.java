...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:10:0x0032, code lost:
        if (getAlwaysRenderModifiers() != false) goto L_0x0034;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0065, code lost:
        if (getAlwaysRenderModifiers() != false) goto L_0x0067;
     */
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ...
        if (!(annotationClass == null || (unsubstitutedPrimaryConstructor = annotationClass.getUnsubstitutedPrimaryConstructor()) == null || (valueParameters = unsubstitutedPrimaryConstructor.getValueParameters()) == null)) {
            ...
            for (ValueParameterDescriptor name : arrayList) {
        ...
        for (Object next2 : list) {
            Name name2 = (Name) next2;
            Intrinsics.checkNotNullExpressionValue(name2, "it");
            if (!allValueArguments.containsKey(name2)) {
        ...
        for (Map.Entry entry : entrySet) {
            ...
            sb.append(name3.asString());
            sb.append(" = ");
            sb.append(!list.contains(name3) ? renderConstant(constantValue) : "...");
            arrayList5.add(sb.toString());
        }
        return CollectionsKt.sorted(CollectionsKt.plus(arrayList4, arrayList5));
    }
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!getStartFromName()) {
            ...
            renderModifier(sb, getModifiers().contains(DescriptorRendererModifier.VALUE) && classDescriptor.isValue(), AccountConstantKt.RESPONSE_VALUE);
    ...
    private final void renderWhereSuffix(List<? extends TypeParameterDescriptor> list, StringBuilder sb) {
        if (!getWithoutTypeParameters()) {
            ...
            for (TypeParameterDescriptor typeParameterDescriptor : list) {
                ...
                for (T t : CollectionsKt.drop(upperBounds, 1)) {
