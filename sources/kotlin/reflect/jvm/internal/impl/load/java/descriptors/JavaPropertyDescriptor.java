...
public class JavaPropertyDescriptor extends PropertyDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    public JavaCallableMemberDescriptor enhance(@Nullable KotlinType kotlinType, @NotNull List<KotlinType> list, @NotNull KotlinType kotlinType2, @Nullable Pair<CallableDescriptor.UserDataKey<?>, ?> pair) {
        ...
        if (function0 != null) {
            javaPropertyDescriptor3.setCompileTimeInitializer(this.compileTimeInitializer, function0);
        }
        javaPropertyDescriptor3.setOverriddenDescriptors(getOverriddenDescriptors());
        javaPropertyDescriptor3.setType(kotlinType2, getTypeParameters(), getDispatchReceiverParameter(), kotlinType3 == null ? null : DescriptorFactory.createExtensionReceiverParameterForCallable(this, kotlinType3, Annotations.Companion.getEMPTY()), CollectionsKt.emptyList());
