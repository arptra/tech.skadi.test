...
public final class JvmAnnotationNames {
    public static final Name DEFAULT_ANNOTATION_MEMBER_NAME = Name.identifier(AccountConstantKt.RESPONSE_VALUE);
    ...
    static {
        ...
        METADATA_DESC = "L" + JvmClassName.byFqNameWithoutInnerClasses(fqName).getInternalName() + MzContactsContract.MzGroups.GROUP_SPLIT_MARK_VCARD;
        FqName fqName2 = new FqName("kotlin.jvm.internal.SerializedIr");
        SERIALIZED_IR_FQ_NAME = fqName2;
        SERIALIZED_IR_DESC = "L" + JvmClassName.byFqNameWithoutInnerClasses(fqName2).getInternalName() + MzContactsContract.MzGroups.GROUP_SPLIT_MARK_VCARD;
    }
}
