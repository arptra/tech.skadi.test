...
public enum PrimitiveType {
    ...
    private PrimitiveType(String str) {
        ...
        this.typeFqName$delegate = LazyKt.lazy(lazyThreadSafetyMode, new PrimitiveType$typeFqName$2(this));
        this.arrayTypeFqName$delegate = LazyKt.lazy(lazyThreadSafetyMode, new PrimitiveType$arrayTypeFqName$2(this));
    }
