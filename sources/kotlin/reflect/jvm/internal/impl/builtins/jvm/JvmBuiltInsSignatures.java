...
public final class JvmBuiltInsSignatures {
    ...
    static {
        ...
        Set<T> plus = SetsKt.plus(buildPrimitiveStringConstructorsSet, signatureBuildingComponents.inJavaLang("Float", (String[]) Arrays.copyOf(constructors, constructors.length)));
        ...
        HIDDEN_CONSTRUCTOR_SIGNATURES = SetsKt.plus(plus, signatureBuildingComponents.inJavaLang("String", (String[]) Arrays.copyOf(constructors2, constructors2.length)));
    ...
    private final Set<String> buildPrimitiveStringConstructorsSet() {
        ...
        List<JvmPrimitiveType> listOf = CollectionsKt.listOf(jvmPrimitiveType, jvmPrimitiveType2, JvmPrimitiveType.DOUBLE, JvmPrimitiveType.FLOAT, jvmPrimitiveType2, JvmPrimitiveType.INT, JvmPrimitiveType.LONG, JvmPrimitiveType.SHORT);
    ...
    private final Set<String> buildPrimitiveValueMethodsSet() {
        SignatureBuildingComponents signatureBuildingComponents = SignatureBuildingComponents.INSTANCE;
        List<JvmPrimitiveType> listOf = CollectionsKt.listOf(JvmPrimitiveType.BOOLEAN, JvmPrimitiveType.CHAR);
        LinkedHashSet linkedHashSet = new LinkedHashSet();
