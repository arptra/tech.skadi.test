...
public final class KClassifiers {
    ...
    public static final KType createType(@NotNull KClassifier kClassifier, @NotNull List<KTypeProjection> list, boolean z, @NotNull List<? extends Annotation> list2) {
        ...
        if (parameters.size() == list.size()) {
            return new KTypeImpl(createKotlinType(list2.isEmpty() ? TypeAttributes.Companion.getEmpty() : TypeAttributes.Companion.getEmpty(), typeConstructor, list, z), (Function0) null, 2, (DefaultConstructorMarker) null);
        }
