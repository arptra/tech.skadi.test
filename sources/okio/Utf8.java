...
public final class Utf8 {
    ...
    public static final void processUtf16Chars(@org.jetbrains.annotations.NotNull byte[] r16, int r17, int r18, @org.jetbrains.annotations.NotNull kotlin.jvm.functions.Function1<? super java.lang.Character, kotlin.Unit> r19) {
        ...
        L_0x00ad:
            ...
            goto L_0x00be
        L_0x00b7:
            if (r14 > r8) goto L_0x00bc
            if (r8 >= r13) goto L_0x00bc
            goto L_0x00ac
        L_0x00bc:
            char r8 = (char) r8
            goto L_0x00ad
        ...
        while (i < i2) {
            ...
            if (Intrinsics.compare((int) charAt2, 128) < 0) {
                ...
                if (Intrinsics.compare((int) charAt2, 2048) < 0) {
                    ...
                    function1.invoke(Byte.valueOf((byte) ((charAt2 & '?') | 128)));
                } else if (Intrinsics.compare((int) charAt2, (int) GeneratorBase.SURR1_LAST) > 0 || i2 <= (i3 = i + 1) || 56320 > (charAt = str.charAt(i3)) || charAt >= 57344) {
                    function1.invoke(Byte.valueOf(REPLACEMENT_BYTE));
                } else {
                    int charAt3 = ((charAt2 << 10) + str.charAt(i3)) - 56613888;
                    function1.invoke(Byte.valueOf((byte) ((charAt3 >> 18) | CircularProgressButton.MorphingAnimation.DURATION_NORMAL)));
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:57:0x00f8, code lost:
        if ((r0[r8] & 192) == 128) goto L_0x00fa;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
