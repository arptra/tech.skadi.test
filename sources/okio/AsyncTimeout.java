    ...
    public static final class Watchdog extends Thread {
        ...
        public void run() {
            /*
                r2 = this;
            L_0x0000:
                okio.AsyncTimeout$Companion r2 = okio.AsyncTimeout.Companion     // Catch:{ InterruptedException -> 0x0000 }
                java.util.concurrent.locks.ReentrantLock r0 = r2.getLock()     // Catch:{ InterruptedException -> 0x0000 }
                r0.lock()     // Catch:{ InterruptedException -> 0x0000 }
                okio.AsyncTimeout r2 = r2.awaitTimeout$okio()     // Catch:{ all -> 0x001b }
                okio.AsyncTimeout r1 = okio.AsyncTimeout.head     // Catch:{ all -> 0x001b }
                if (r2 != r1) goto L_0x001d
                r2 = 0
                okio.AsyncTimeout.head = r2     // Catch:{ all -> 0x001b }
            ...
            L_0x0028:
                r0.unlock()     // Catch:{ InterruptedException -> 0x0000 }
                throw r2     // Catch:{ InterruptedException -> 0x0000 }
            */
