...
public abstract class ForwardingFileSystem extends FileSystem {
    ...
    public FileMetadata metadataOrNull(@NotNull Path path) throws IOException {
        ...
        return metadataOrNull.getSymlinkTarget() == null ? metadataOrNull : FileMetadata.copy$default(metadataOrNull, false, false, onPathResult(metadataOrNull.getSymlinkTarget(), "metadataOrNull"), (Long) null, (Long) null, (Long) null, (Long) null, (Map) null, 251, (Object) null);
    }
