...
public final class HostnamesKt {
    ...
    public static final String toCanonicalHost(@NotNull String str) {
        ...
        if (StringsKt.contains$default((CharSequence) str, (CharSequence) AccountConstantKt.CODE_SEPARTOR, false, 2, (Object) null)) {
            ...
            if (address.length == 16) {
                Intrinsics.checkNotNullExpressionValue(address, MzContactsContract.MzContactColumns.ADDRESS);
