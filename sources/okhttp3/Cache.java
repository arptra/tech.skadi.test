...
public final class Cache implements Closeable, Flushable {
    ...
    public static final class Companion {
        ...
        private final Set<String> varyFields(Headers headers) {
            ...
            for (int i = 0; i < size; i++) {
                if (StringsKt.equals("Vary", headers.name(i), true)) {
                    ...
                    for (String trim : StringsKt.split$default((CharSequence) value, new char[]{StringUtil.COMMA}, false, 0, 6, (Object) null)) {
                        treeSet.add(StringsKt.trim((CharSequence) trim).toString());
                    }
                }
            }
        ...
        public final int readInt$okhttp(@NotNull BufferedSource bufferedSource) throws IOException {
            ...
            try {
                ...
                if (readDecimalLong >= 0 && readDecimalLong <= UpdateOptions.SOURCE_ANY && readUtf8LineStrict.length() <= 0) {
    ...
    public final File m1537deprecated_directory() {
    ...
    public static final class Entry {
        ...
        private final boolean isHttps() {
            return Intrinsics.areEqual((Object) this.url.scheme(), (Object) URIUtil.HTTPS);
        }
