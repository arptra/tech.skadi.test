...
public final class ChannelsKt__ChannelsKt$trySendBlocking$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (sendChannel.L(obj3, this) == coroutine_suspended) {
        ...
        return ChannelResult.b(Result.m27isSuccessimpl(obj2) ? ChannelResult.b.c(Unit.INSTANCE) : ChannelResult.b.a(Result.m23exceptionOrNullimpl(obj2)));
    }
