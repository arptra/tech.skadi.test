...
public final class CancellableKt {
    ...
    public static final void b(Continuation continuation, Continuation continuation2) {
        try {
            ...
            Result.Companion companion = Result.Companion;
            DispatchedContinuationKt.c(intercepted, Result.m20constructorimpl(Unit.INSTANCE), (Function1) null, 2, (Object) null);
        } catch (Throwable th) {
            a(continuation2, th);
        }
    }
    ...
    public static final void d(Function2 function2, Object obj, Continuation continuation, Function1 function1) {
        try {
            Continuation<Unit> intercepted = IntrinsicsKt.intercepted(IntrinsicsKt.createCoroutineUnintercepted(function2, obj, continuation));
            Result.Companion companion = Result.Companion;
            DispatchedContinuationKt.b(intercepted, Result.m20constructorimpl(Unit.INSTANCE), function1);
        } catch (Throwable th) {
            a(continuation, th);
        }
    }
