...
public final class DebuggerInfo implements Serializable {
    ...
    public DebuggerInfo(@NotNull DebugCoroutineInfoImpl debugCoroutineInfoImpl, @NotNull CoroutineContext coroutineContext) {
        Thread.State state2;
        CoroutineId coroutineId2 = (CoroutineId) coroutineContext.get(CoroutineId.b);
        String str = null;
        this.coroutineId = coroutineId2 != null ? Long.valueOf(coroutineId2.d0()) : null;
        ...
        this.name = coroutineName != null ? coroutineName.d0() : null;
