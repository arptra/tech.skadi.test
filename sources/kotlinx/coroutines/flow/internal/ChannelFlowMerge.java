...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    public Object g(ProducerScope producerScope, Continuation continuation) {
        Object collect = this.d.collect(new ChannelFlowMerge$collectTo$2((Job) continuation.getContext().get(Job.b0), SemaphoreKt.b(this.e, 0, 2, (Object) null), producerScope, new SendingCollector(producerScope)), continuation);
