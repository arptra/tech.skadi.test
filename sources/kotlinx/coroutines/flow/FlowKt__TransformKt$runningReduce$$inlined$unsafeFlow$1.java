...
public final class FlowKt__TransformKt$runningReduce$$inlined$unsafeFlow$1 implements Flow<Object> {
    ...
    public final /* synthetic */ Flow f3860a;
    public final /* synthetic */ Function3 b;

    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Ref.ObjectRef objectRef = new Ref.ObjectRef();
        objectRef.element = NullSurrogateKt.f3899a;
        Object collect = this.f3860a.collect(new FlowKt__TransformKt$runningReduce$1$1(objectRef, this.b, flowCollector), continuation);
