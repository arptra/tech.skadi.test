...
public final class MapEntrySerializer$descriptor$1 extends Lambda implements Function1<ClassSerialDescriptorBuilder, Unit> {
    ...
    public final void invoke(@NotNull ClassSerialDescriptorBuilder classSerialDescriptorBuilder) {
        ...
        ClassSerialDescriptorBuilder.b(classSerialDescriptorBuilder, IntentKey.ACTIVITY.ACTION_KEY, this.$keySerializer.getDescriptor(), (List) null, false, 12, (Object) null);
        ClassSerialDescriptorBuilder.b(classSerialDescriptorBuilder, AccountConstantKt.RESPONSE_VALUE, this.$valueSerializer.getDescriptor(), (List) null, false, 12, (Object) null);
    }
}
