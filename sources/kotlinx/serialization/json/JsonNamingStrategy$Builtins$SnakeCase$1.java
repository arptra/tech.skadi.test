...
public final class JsonNamingStrategy$Builtins$SnakeCase$1 implements JsonNamingStrategy {
    public String a(SerialDescriptor serialDescriptor, int i, String str) {
        ...
        return JsonNamingStrategy.Builtins.f4085a.b(str, '_');
    }
