...
public class StandardOrganizations {
    ...
    public static final Map f3326a;
    ...
    static {
        ...
        treeMap.put(ExifInterface.TAG_RW2_ISO, "International Organization for Standardization");
    ...
    public static String a() {
        return "(" + String.join(MzContactsContract.MzGroups.GROUP_SPLIT_MARK_XML, f3326a.keySet()) + ")";
    }
}
