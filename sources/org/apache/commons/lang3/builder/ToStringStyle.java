...
public abstract class ToStringStyle implements Serializable {
    ...
    private String arraySeparator = MzContactsContract.MzGroups.GROUP_SPLIT_MARK_EXTRA;
    private String arrayStart = "{";
    private String contentEnd = "]";
    private String contentStart = "[";
    private boolean defaultFullDetail = true;
    private String fieldNameValueSeparator = "=";
    private String fieldSeparator = MzContactsContract.MzGroups.GROUP_SPLIT_MARK_EXTRA;
    ...
    public static final class JsonToStringStyle extends ToStringStyle {
        ...
        public JsonToStringStyle() {
            ...
            setArrayStart("[");
            setArrayEnd("]");
            setFieldSeparator(MzContactsContract.MzGroups.GROUP_SPLIT_MARK_EXTRA);
            setFieldNameValueSeparator(AccountConstantKt.CODE_SEPARTOR);
            setNullText("null");
    ...
    public static final class MultiLineToStringStyle extends ToStringStyle {
        ...
        public MultiLineToStringStyle() {
            setContentStart("[");
            setFieldSeparator(System.lineSeparator() + FastRecordHistoryDetailActivity.TAG_SPLIT);
