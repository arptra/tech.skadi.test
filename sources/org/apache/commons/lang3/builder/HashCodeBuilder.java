...
public class HashCodeBuilder implements Builder<Integer> {
    ...
    private static void reflectionAppend(java.lang.Object r5, java.lang.Class<?> r6, org.apache.commons.lang3.builder.HashCodeBuilder r7, boolean r8, java.lang.String[] r9) {
        /*
            ...
            return
        L_0x0007:
            register(r5)     // Catch:{ all -> 0x004a }
            java.lang.reflect.Field[] r6 = r6.getDeclaredFields()     // Catch:{ all -> 0x004a }
            com.honey.account.yb.a r0 = new com.honey.account.yb.a     // Catch:{ all -> 0x004a }
            r0.<init>()     // Catch:{ all -> 0x004a }
            java.util.Comparator r0 = java.util.Comparator.comparing(r0)     // Catch:{ all -> 0x004a }
            java.lang.Object[] r6 = org.apache.commons.lang3.ArraySorter.sort(r6, r0)     // Catch:{ all -> 0x004a }
            java.lang.reflect.Field[] r6 = (java.lang.reflect.Field[]) r6     // Catch:{ all -> 0x004a }
            r0 = 1
            java.lang.reflect.AccessibleObject.setAccessible(r6, r0)     // Catch:{ all -> 0x004a }
            int r0 = r6.length     // Catch:{ all -> 0x004a }
            r1 = 0
        L_0x0023:
            if (r1 >= r0) goto L_0x0071
            r2 = r6[r1]     // Catch:{ all -> 0x004a }
            java.lang.String r3 = r2.getName()     // Catch:{ all -> 0x004a }
            boolean r3 = org.apache.commons.lang3.ArrayUtils.contains((java.lang.Object[]) r9, (java.lang.Object) r3)     // Catch:{ all -> 0x004a }
            ...
            int r3 = r2.getModifiers()     // Catch:{ all -> 0x004a }
            boolean r3 = java.lang.reflect.Modifier.isTransient(r3)     // Catch:{ all -> 0x004a }
            if (r3 != 0) goto L_0x006e
            goto L_0x004c
        L_0x004a:
            r6 = move-exception
        ...
        L_0x004c:
            int r3 = r2.getModifiers()     // Catch:{ all -> 0x004a }
            boolean r3 = java.lang.reflect.Modifier.isStatic(r3)     // Catch:{ all -> 0x004a }
            if (r3 != 0) goto L_0x006e
            ...
            boolean r3 = r2.isAnnotationPresent(r3)     // Catch:{ all -> 0x004a }
            if (r3 != 0) goto L_0x006e
            java.lang.Object r2 = r2.get(r5)     // Catch:{ IllegalAccessException -> 0x0066 }
            r7.append((java.lang.Object) r2)     // Catch:{ IllegalAccessException -> 0x0066 }
            goto L_0x006e
        L_0x0066:
            java.lang.InternalError r6 = new java.lang.InternalError     // Catch:{ all -> 0x004a }
