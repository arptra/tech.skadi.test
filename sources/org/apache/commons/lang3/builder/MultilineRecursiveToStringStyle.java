...
public class MultilineRecursiveToStringStyle extends RecursiveToStringStyle {
    ...
    private void resetIndent() {
        ...
        setArraySeparator(MzContactsContract.MzGroups.GROUP_SPLIT_MARK_EXTRA + System.lineSeparator() + spacer(this.spaces));
        setArrayEnd(System.lineSeparator() + spacer(this.spaces + -2) + "}");
        setContentStart("[" + System.lineSeparator() + spacer(this.spaces));
        setFieldSeparator(MzContactsContract.MzGroups.GROUP_SPLIT_MARK_EXTRA + System.lineSeparator() + spacer(this.spaces));
