...
import com.honey.account.xb.e0;
import com.honey.account.xb.f0;
import com.honey.account.xb.g0;
import com.honey.account.xb.h0;
import com.honey.account.xb.i0;
import com.honey.account.xb.j0;
...
public class Validate {
    ...
    public static void isInstanceOf(Class<?> cls, Object obj) {
        ...
        if (!cls.isInstance(obj)) {
            ...
            throw new IllegalArgumentException(String.format(DEFAULT_IS_INSTANCE_OF_EX_MESSAGE, new Object[]{name, str}));
        }
    }
    ...
    public static <T extends CharSequence> T notBlank(T t, String str, Object... objArr) {
        Objects.requireNonNull(t, new f0(str, objArr));
    ...
    public static <T> T[] notEmpty(T[] tArr, String str, Object... objArr) {
        Objects.requireNonNull(tArr, new j0(str, objArr));
        if (tArr.length != 0) {
            return tArr;
        }
        throw new IllegalArgumentException(String.format(str, objArr));
    ...
    public static <T> T notNull(T t, String str, Object... objArr) {
        Objects.requireNonNull(t, new g0(str, objArr));
        return t;
    }
    ...
    public static <T extends Collection<?>> T notEmpty(T t, String str, Object... objArr) {
        Objects.requireNonNull(t, new i0(str, objArr));
        if (!t.isEmpty()) {
            return t;
        }
        throw new IllegalArgumentException(String.format(str, objArr));
    ...
    public static <T extends Map<?, ?>> T notEmpty(T t, String str, Object... objArr) {
        Objects.requireNonNull(t, new e0(str, objArr));
        if (!t.isEmpty()) {
            return t;
        }
        throw new IllegalArgumentException(String.format(str, objArr));
    ...
    public static <T extends CharSequence> T notEmpty(T t, String str, Object... objArr) {
        Objects.requireNonNull(t, new h0(str, objArr));
        if (t.length() != 0) {
            return t;
        }
        throw new IllegalArgumentException(String.format(str, objArr));
