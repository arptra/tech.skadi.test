...
public final class FastRecordSummaryFragment$initViewModel$6 extends Lambda implements Function1<RecordEntity, Unit> {
    final /* synthetic */ FastRecordSummaryFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FastRecordSummaryFragment$initViewModel$6(FastRecordSummaryFragment fastRecordSummaryFragment) {
        super(1);
    ...
    public final void invoke(RecordEntity recordEntity) {
        if (recordEntity != null) {
            ...
            LogExt.logE("curRecordData value = " + recordEntity, "SummaryFragment");
            fastRecordSummaryFragment.setBottomBtnState();
        }
    }
}
