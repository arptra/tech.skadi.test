...
public final class FastRecordFragment$initViewModel$7 extends Lambda implements Function1<ArrayList<RecordEntity>, Unit> {
    final /* synthetic */ FastRecordFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FastRecordFragment$initViewModel$7(FastRecordFragment fastRecordFragment) {
        super(1);
    ...
    public final void invoke(ArrayList<RecordEntity> arrayList) {
        if (Intrinsics.areEqual((Object) this.this$0.recordType, (Object) "phone")) {
            LogExt.logE("phoneFastRecordData", "FastRecordFragment");
