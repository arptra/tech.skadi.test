...
public final class FastRecordHistoryDetailActivity$initAiTodoStateObserver$1 extends Lambda implements Function1<ArrayList<Long>, Unit> {
    final /* synthetic */ FastRecordHistoryDetailActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FastRecordHistoryDetailActivity$initAiTodoStateObserver$1(FastRecordHistoryDetailActivity fastRecordHistoryDetailActivity) {
        super(1);
    ...
    public final void invoke(@Nullable ArrayList<Long> arrayList) {
        ...
        if (curRecordEntity != null) {
            ...
            if (arrayList != null) {
                LogExt.logW("recordAiTodoFinish list id = " + arrayList, "FastRecordHistoryDetailActivity");
            }
            long recordId = curRecordEntity.getRecordId();
            LogExt.logW("recordAiTodoFinish curRecord recordId = " + recordId, "FastRecordHistoryDetailActivity");
