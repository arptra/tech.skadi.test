...
public final class FastRecordAiSummaryOperatorManager$startAiSummaryOperator$3 extends Lambda implements Function2<String, Integer, Unit> {
    final /* synthetic */ SummaryRequestBean $mSummaryRequestBean;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FastRecordAiSummaryOperatorManager$startAiSummaryOperator$3(SummaryRequestBean summaryRequestBean) {
        super(2);
    ...
    public final void invoke(@NotNull String str, int i) {
        ...
        if (aiSummaryCallbackInterface != null) {
            aiSummaryCallbackInterface.onGetSummaryFail(str, i);
        }
