...
public final class FastRecordHistoryAsrOperator$initSingleAsr$1$onRemoteAsrResult$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ AsrResult $asrResult;
    final /* synthetic */ FastRecordHistoryAsrOperator this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FastRecordHistoryAsrOperator$initSingleAsr$1$onRemoteAsrResult$1(FastRecordHistoryAsrOperator fastRecordHistoryAsrOperator, AsrResult asrResult) {
        super(0);
    ...
    public final void invoke() {
        ...
        fastRecordHistoryAsrOperator.saveSceneRecordVoiceWord(str, startTime, src3 != null ? src3.getEndTime() : 0, RecordConstants.SCENE_ONLY, this.$asrResult.getExt());
    }
}
