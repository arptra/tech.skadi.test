...
public final class FastRecordHistoryAsrOperator$initTwoSocketAsr$1$onProximalAsrResult$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ AsrResult $asrResult;
    final /* synthetic */ FastRecordHistoryAsrOperator this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FastRecordHistoryAsrOperator$initTwoSocketAsr$1$onProximalAsrResult$1(FastRecordHistoryAsrOperator fastRecordHistoryAsrOperator, AsrResult asrResult) {
        super(0);
    ...
    public final void invoke() {
        ...
        fastRecordHistoryAsrOperator.savePhoneTypeVoiceWord(str, startTime, src3 != null ? src3.getEndTime() : 0, RecordConstants.SCENE_PHONE_OTHER, this.$asrResult.getExt());
    }
}
