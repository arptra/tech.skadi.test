...
public final class FastRecordHistoryAsrOperatorManager$initTwoAsrOperator$3 extends Lambda implements Function1<Long, Unit> {
    public static final FastRecordHistoryAsrOperatorManager$initTwoAsrOperator$3 INSTANCE = new FastRecordHistoryAsrOperatorManager$initTwoAsrOperator$3();

    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "com.upuphone.ar.fastrecord.phone.ui.viewmodel.history.FastRecordHistoryAsrOperatorManager$initTwoAsrOperator$3$1", f = "FastRecordHistoryAsrOperatorManager.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.upuphone.ar.fastrecord.phone.ui.viewmodel.history.FastRecordHistoryAsrOperatorManager$initTwoAsrOperator$3$1  reason: invalid class name */
    ...
    public FastRecordHistoryAsrOperatorManager$initTwoAsrOperator$3() {
        super(1);
    }
    ...
    public final void invoke(final long j) {
        ...
        LogExt.logW("initTwoAsrOperator setEmptyCallBack record id = " + j, "FastRecordHistoryAsrOperatorManager");
