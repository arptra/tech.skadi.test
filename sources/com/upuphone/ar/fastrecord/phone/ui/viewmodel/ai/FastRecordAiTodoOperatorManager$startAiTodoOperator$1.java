...
public final class FastRecordAiTodoOperatorManager$startAiTodoOperator$1 extends Lambda implements Function2<String, SensitivePayload, Unit> {
    final /* synthetic */ SummaryRequestBean $mSummaryRequestBean;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FastRecordAiTodoOperatorManager$startAiTodoOperator$1(SummaryRequestBean summaryRequestBean) {
        super(2);
    ...
    public final void invoke(@NotNull String str, @Nullable SensitivePayload sensitivePayload) {
        ...
        if (aiTodoCallbackInterface != null) {
            aiTodoCallbackInterface.onTodoSensitive(str, sensitivePayload);
        }
