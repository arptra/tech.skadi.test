...
@DebugMetadata(c = "com.upuphone.ar.fastrecord.phone.ui.viewmodel.FastRecordSummaryViewModel$requestSummaryInfo$1", f = "FastRecordSummaryViewModel.kt", i = {1}, l = {201, 212}, m = "invokeSuspend", n = {"mRecordSummaryEntity"}, s = {"L$1"})
public final class FastRecordSummaryViewModel$requestSummaryInfo$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    Object L$0;
    Object L$1;
    int label;
    ...
    public FastRecordSummaryViewModel$requestSummaryInfo$1(FastRecordSummaryViewModel fastRecordSummaryViewModel, Continuation<? super FastRecordSummaryViewModel$requestSummaryInfo$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new FastRecordSummaryViewModel$requestSummaryInfo$1(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            if (requestBean != null) {
                ...
                LogExt.logE("requestSummaryInfo data = " + requestBean, "SummaryViewModel");
                ...
                this.label = 1;
                obj = fastRecordSummaryDao.queryByRecordId(longValue, this);
        ...
        Boolean boxBoolean = recordSummaryEntity != null ? Boxing.boxBoolean(recordSummaryEntity.isNeedRequestServer()) : null;
        LogExt.logE("requestSummaryInfo RecordSummaryEntity request state = " + boxBoolean, "SummaryViewModel");
        if (recordSummaryEntity == null || recordSummaryEntity.isNeedRequestServer()) {
            LogExt.logE("requestSummaryInfo getSummaryFromServer", "SummaryViewModel");
            fastRecordSummaryViewModel.startAiSummaryTask();
            return Unit.INSTANCE;
        }
        if (recordSummaryEntity.isFinishDel()) {
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((FastRecordSummaryViewModel$requestSummaryInfo$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
