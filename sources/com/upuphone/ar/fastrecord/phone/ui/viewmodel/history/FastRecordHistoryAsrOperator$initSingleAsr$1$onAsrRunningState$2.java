...
public final class FastRecordHistoryAsrOperator$initSingleAsr$1$onAsrRunningState$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ AsrMessageState $state;
    final /* synthetic */ FastRecordHistoryAsrOperator this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FastRecordHistoryAsrOperator$initSingleAsr$1$onAsrRunningState$2(FastRecordHistoryAsrOperator fastRecordHistoryAsrOperator, AsrMessageState asrMessageState) {
        super(0);
    ...
    public final void invoke() {
        ...
        fastRecordHistoryAsrOperator.createOrPostHandlerCommand(new Function0<Unit>() {
            public final void invoke() {
                LogExt.logE("initSingleAsr showComplianceFailForSingleSocket checkAsrResultForScene", FastRecordHistoryAsrOperator.TAG);
                ...
                fastRecordHistoryAsrOperator.checkAsrResultForScene(new Function0<Unit>() {
                    public final void invoke() {
