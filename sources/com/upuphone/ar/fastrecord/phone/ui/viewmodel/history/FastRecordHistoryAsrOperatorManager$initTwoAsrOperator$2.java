...
public final class FastRecordHistoryAsrOperatorManager$initTwoAsrOperator$2 extends Lambda implements Function2<Long, String, Unit> {
    public static final FastRecordHistoryAsrOperatorManager$initTwoAsrOperator$2 INSTANCE = new FastRecordHistoryAsrOperatorManager$initTwoAsrOperator$2();

    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "com.upuphone.ar.fastrecord.phone.ui.viewmodel.history.FastRecordHistoryAsrOperatorManager$initTwoAsrOperator$2$1", f = "FastRecordHistoryAsrOperatorManager.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.upuphone.ar.fastrecord.phone.ui.viewmodel.history.FastRecordHistoryAsrOperatorManager$initTwoAsrOperator$2$1  reason: invalid class name */
    ...
    public FastRecordHistoryAsrOperatorManager$initTwoAsrOperator$2() {
        super(2);
    }
    ...
    public final void invoke(final long j, @NotNull final String str) {
        ...
        LogExt.logW("initTwoAsrOperator setFailCallBack record id = " + j, "FastRecordHistoryAsrOperatorManager");
