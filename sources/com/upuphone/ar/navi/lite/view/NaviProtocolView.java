...
public class NaviProtocolView extends LinearLayout implements View.OnClickListener {
    ...
    public final class CWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
            ...
            if (str.contains("file:///android_asset/privacy_compliance.html")) {
                NaviProtocolView.this.c.setVisibility(0);
            } else {
                NaviProtocolView.this.c.setVisibility(8);
            }
        }
    }
    ...
    public NaviProtocolView(Context context) {
        super(context);
        this.f5832a = context;
        b(context);
        c();
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.disagree_privacy) {
            CSharedPreferences.p(this.f5832a, "show_privacy_compliance", false);
            ...
            CSharedPreferences.p(this.f5832a, "show_privacy_compliance", true);
    ...
    public NaviProtocolView(Context context, @Nullable AttributeSet attributeSet) {
