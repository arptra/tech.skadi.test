...
public final class DialogueTranslationFragment$initViewModels$1 extends Lambda implements Function1<TranslationLanguage, Unit> {
    final /* synthetic */ DialogueTranslationFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DialogueTranslationFragment$initViewModels$1(DialogueTranslationFragment dialogueTranslationFragment) {
        super(1);
    ...
    public final void invoke(TranslationLanguage translationLanguage) {
        ...
        dialogueTranslationFragment.M1(translationLanguage);
    }
}
