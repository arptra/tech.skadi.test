...
public final class ToDoFragment$onResume$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ ToDoFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ToDoFragment$onResume$1(ToDoFragment toDoFragment) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (o0 != null) {
            ...
            if (!StringsKt.isBlank(o0.getAccountId()) && !StringsKt.isBlank(o0.getRecognizeId())) {
                LogExt.j("onResume 从无权限切换到有权限再次从数据库加载数据", "ToDoFragment");
