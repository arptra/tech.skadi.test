...
public final class ToDoFragment$initViews$1 extends Lambda implements Function2<Integer, IntelExtnTodo, Unit> {
    final /* synthetic */ ToDoFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ToDoFragment$initViews$1(ToDoFragment toDoFragment) {
        super(2);
    ...
    public final void invoke(int i, @NotNull IntelExtnTodo intelExtnTodo) {
        ...
        LogExt.j("disableEdit position=" + i + ", extnTodo=" + intelExtnTodo, "ToDoFragment");
        ...
        if (n02 != null && (data = n02.getData()) != null) {
            this.this$0.V0(data);
        }
    }
}
