...
public final class DialogueTranslationFragment$showLanguageDialog$1$1 extends Lambda implements Function2<LanguageBean, LanguageBean, Unit> {
    final /* synthetic */ DialogueTranslationFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DialogueTranslationFragment$showLanguageDialog$1$1(DialogueTranslationFragment dialogueTranslationFragment) {
        super(2);
    ...
    public final void invoke(@NotNull LanguageBean languageBean, @NotNull LanguageBean languageBean2) {
        ...
        this.this$0.c1().l0(languageBean, languageBean2);
    }
