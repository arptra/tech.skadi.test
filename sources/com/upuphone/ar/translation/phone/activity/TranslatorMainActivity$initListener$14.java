...
public final class TranslatorMainActivity$initListener$14 extends Lambda implements Function1<OnBackPressedCallback, Unit> {
    final /* synthetic */ TranslatorMainActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TranslatorMainActivity$initListener$14(TranslatorMainActivity translatorMainActivity) {
        super(1);
    ...
    public final void invoke(@NotNull OnBackPressedCallback onBackPressedCallback) {
        ...
        if (Intrinsics.areEqual(this.this$0.getMRecordShareVm().j().getValue(), (Object) Boolean.TRUE)) {
            this.this$0.getMRecordShareVm().n(false);
            return;
        }
