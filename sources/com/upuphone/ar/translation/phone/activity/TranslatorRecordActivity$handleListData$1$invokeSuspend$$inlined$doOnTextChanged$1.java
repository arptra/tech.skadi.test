...
public final class TranslatorRecordActivity$handleListData$1$invokeSuspend$$inlined$doOnTextChanged$1 implements TextWatcher {
    final /* synthetic */ TranslatorRecordActivity this$0;

    public TranslatorRecordActivity$handleListData$1$invokeSuspend$$inlined$doOnTextChanged$1(TranslatorRecordActivity translatorRecordActivity) {
    ...
    public void onTextChanged(@Nullable CharSequence charSequence, int i, int i2, int i3) {
        ...
        transTitleBar.setTextMenuEnabled((str != null && !StringsKt.isBlank(str) && !Intrinsics.areEqual((Object) str, (Object) this.this$0.mOriginalRecordTitle)) || (this.this$0.isListRecordUpdated() && str != null && !StringsKt.isBlank(str)));
    }
}
