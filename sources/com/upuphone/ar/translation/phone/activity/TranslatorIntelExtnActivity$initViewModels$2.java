...
public final class TranslatorIntelExtnActivity$initViewModels$2 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ TranslatorIntelExtnActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TranslatorIntelExtnActivity$initViewModels$2(TranslatorIntelExtnActivity translatorIntelExtnActivity) {
        super(1);
    ...
    public final void invoke(String str) {
        String str2 = (String) this.this$0.getMIntelExtnShareVm().l().getValue();
