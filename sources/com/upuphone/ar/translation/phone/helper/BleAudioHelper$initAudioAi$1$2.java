...
public final class BleAudioHelper$initAudioAi$1$2 extends Lambda implements Function2<byte[], byte[], Unit> {
    public static final BleAudioHelper$initAudioAi$1$2 INSTANCE = new BleAudioHelper$initAudioAi$1$2();

    public BleAudioHelper$initAudioAi$1$2() {
        super(2);
    }
    ...
    public final void invoke(@NotNull byte[] bArr, @NotNull byte[] bArr2) {
        ...
        BleAudioHelper.f6295a.p(bArr, bArr2);
    }
}
