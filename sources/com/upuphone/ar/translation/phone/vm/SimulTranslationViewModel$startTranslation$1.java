...
public final class SimulTranslationViewModel$startTranslation$1 extends Lambda implements Function1<Boolean, Unit> {
    final /* synthetic */ String $langDst;
    final /* synthetic */ String $langSrc;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SimulTranslationViewModel$startTranslation$1(String str, String str2) {
        super(1);
        this.$langSrc = str;
        this.$langDst = str2;
    }
    ...
    public final void invoke(boolean z) {
        ...
        InterConnectHelper.c.a().z(2, this.$langSrc, this.$langDst);
