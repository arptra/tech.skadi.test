...
@DebugMetadata(c = "com.upuphone.ar.translation.phone.vm.TranslatorRecordViewModel$updateTextRecordData$1", f = "TranslatorRecordViewModel.kt", i = {}, l = {371}, m = "invokeSuspend", n = {}, s = {})
public final class TranslatorRecordViewModel$updateTextRecordData$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "com.upuphone.ar.translation.phone.vm.TranslatorRecordViewModel$updateTextRecordData$1$1", f = "TranslatorRecordViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.upuphone.ar.translation.phone.vm.TranslatorRecordViewModel$updateTextRecordData$1$1  reason: invalid class name */
    ...
    public TranslatorRecordViewModel$updateTextRecordData$1(NoteBean noteBean, boolean z, boolean z2, Continuation<? super TranslatorRecordViewModel$updateTextRecordData$1> continuation) {
    ...
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new TranslatorRecordViewModel$updateTextRecordData$1(this.$noteBean, this.$isTitleUpdated, this.$isRecordUpdated, continuation);
    }
    ...
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((TranslatorRecordViewModel$updateTextRecordData$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
