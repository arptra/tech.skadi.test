...
final class AudioAiManager$callbackReductionNoiseData$4 extends Lambda implements Function2<byte[], byte[], Unit> {
    public static final AudioAiManager$callbackReductionNoiseData$4 INSTANCE = new AudioAiManager$callbackReductionNoiseData$4();

    public AudioAiManager$callbackReductionNoiseData$4() {
        super(2);
    }
