...
@DebugMetadata(c = "com.upuphone.ar.translation.audio.AudioAiManager$init$1", f = "AudioAiManager.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
public final class AudioAiManager$init$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            companion.getInstance().init(this.$context);
            AudioAiManager audioAiManager = this.this$0;
            VoiceManager instance = companion.getInstance();
            Context applicationContext = this.$context.getApplicationContext();
            Intrinsics.checkNotNullExpressionValue(applicationContext, "getApplicationContext(...)");
            audioAiManager.g = VoiceManager.spkRecogInit$default(instance, applicationContext, SpeakerVerificationType.SV_SSP_EXTRACT, false, 4, (Object) null);
