...
final class AudioAiManager$callbackReductionNoiseData$1 extends Lambda implements Function2<byte[], byte[], Unit> {
    public static final AudioAiManager$callbackReductionNoiseData$1 INSTANCE = new AudioAiManager$callbackReductionNoiseData$1();

    public AudioAiManager$callbackReductionNoiseData$1() {
        super(2);
    }
