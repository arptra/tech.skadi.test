...
public final class XunFeiChannelHandler$openAsrChannel$1 extends Lambda implements Function1<Boolean, Unit> {
    final /* synthetic */ XunFeiChannelHandler this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public XunFeiChannelHandler$openAsrChannel$1(XunFeiChannelHandler xunFeiChannelHandler) {
        super(1);
    ...
    public final void invoke(boolean z) {
        if (!z) {
            LogExt.j("openAsrChannel 当前网络异常不能翻译", "XunFeiChannelHandler");
            this.this$0.f6354a.j();
            return;
        }
        StartTrans g = this.this$0.c;
        LogExt.j("openAsrChannel mStartTrans=" + g, "XunFeiChannelHandler");
        if (this.this$0.c == null) {
            this.this$0.c = AsrServerChannelUtils.f6352a.b();
            StartTrans g2 = this.this$0.c;
            LogExt.j("openAsrChannel createConfigInfo mStartTrans=" + g2, "XunFeiChannelHandler");
        }
        StartTrans g3 = this.this$0.c;
        if (g3 != null) {
            XunFeiChannelHandler xunFeiChannelHandler = this.this$0;
            if (TranslatorConstants.isMicroSoftAsr()) {
                XunFeiChannelHandler.G(xunFeiChannelHandler, g3, false, 2, (Object) null);
            } else {
                xunFeiChannelHandler.B(g3);
            }
            xunFeiChannelHandler.f6354a.u();
            InterConnectHelper.c.a().B(g3.getTransType(), g3.getSrc(), g3.getDst());
            LogExt.a();
        }
    }
}
