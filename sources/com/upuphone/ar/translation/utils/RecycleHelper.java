...
public class RecycleHelper<T> {
    ...
    public final RefreshLoadListener f6370a;
    ...
    public RecycleHelper(RefreshLoadListener refreshLoadListener, RefreshLayout refreshLayout) {
        this.f6370a = refreshLoadListener;
        if (refreshLayout != null) {
            this.b = refreshLayout;
            refreshLayout.c(new b(this));
        }
    }
    ...
    public void g() {
        ...
        this.f++;
        j(true);
        this.f6370a.onLoadMoreData(this.d, this.f, this.e);
    }
