...
public final class TiciHistoryActivity$initViewModels$2 extends Lambda implements Function1<TiciEntity, Unit> {
    final /* synthetic */ TiciHistoryActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TiciHistoryActivity$initViewModels$2(TiciHistoryActivity ticiHistoryActivity) {
        super(1);
    ...
    public final void invoke(@Nullable TiciEntity ticiEntity) {
        this.this$0.Y0().setLoadingTiciId(ticiEntity != null ? Long.valueOf(ticiEntity.getId()) : null);
    }
}
