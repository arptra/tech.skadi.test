...
@DebugMetadata(c = "com.upuphone.ar.transcribe.phone.network.NetworkConnectManager$isNetworkConnected$1", f = "NetworkConnectManager.kt", i = {}, l = {290}, m = "invokeSuspend", n = {}, s = {})
public final class NetworkConnectManager$isNetworkConnected$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            LogExt.g("isNetworkConnected 网络连接=" + hasCapability + ", 网络可用=" + hasCapability2, "NetworkConnectManager");
            if (!hasCapability) {
                z = false;
            ...
            LogExt.g("isNetworkConnected isAccessible=" + z, "NetworkConnectManager");
        ...
        LogExt.g("isNetworkConnected 互联网联网=" + z, "NetworkConnectManager");
        LogExt.g("isNetworkConnected isAccessible=" + z, "NetworkConnectManager");
        this.$callback.invoke(Boxing.boxBoolean(z));
        return Unit.INSTANCE;
    }
