...
public final class TranscribeStartActivity$initListener$12 extends Lambda implements Function1<OnBackPressedCallback, Unit> {
    final /* synthetic */ TranscribeStartActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TranscribeStartActivity$initListener$12(TranscribeStartActivity transcribeStartActivity) {
        super(1);
    ...
    public final void invoke(@NotNull OnBackPressedCallback onBackPressedCallback) {
        ...
        if (this.this$0.getEditViewModel().r()) {
            this.this$0.getEditViewModel().h(false);
        } else {
            this.this$0.finish();
        }
    }
