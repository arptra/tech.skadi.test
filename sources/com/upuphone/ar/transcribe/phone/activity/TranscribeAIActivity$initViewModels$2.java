...
public final class TranscribeAIActivity$initViewModels$2 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ TranscribeAIActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TranscribeAIActivity$initViewModels$2(TranscribeAIActivity transcribeAIActivity) {
        super(1);
    ...
    public final void invoke(String str) {
        String str2 = (String) this.this$0.getAiShareViewModel().j().getValue();
