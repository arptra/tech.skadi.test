...
public final class TranscribeAIActivity$initListener$2 extends Lambda implements Function1<OnBackPressedCallback, Unit> {
    final /* synthetic */ TranscribeAIActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TranscribeAIActivity$initListener$2(TranscribeAIActivity transcribeAIActivity) {
        super(1);
    ...
    public final void invoke(@NotNull OnBackPressedCallback onBackPressedCallback) {
        ...
        this.this$0.getAiShareViewModel().m(true);
        this.this$0.finish();
    }
}
