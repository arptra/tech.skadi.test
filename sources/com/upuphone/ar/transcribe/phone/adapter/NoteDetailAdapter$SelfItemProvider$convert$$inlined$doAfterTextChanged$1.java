...
public final class NoteDetailAdapter$SelfItemProvider$convert$$inlined$doAfterTextChanged$1 implements TextWatcher {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ NoteDetailAdapter.SelfItemProvider f6077a;
    public final /* synthetic */ int b;
    public final /* synthetic */ NoteDetailBean c;
    public final /* synthetic */ ClipboardEditText d;

    public NoteDetailAdapter$SelfItemProvider$convert$$inlined$doAfterTextChanged$1(NoteDetailAdapter.SelfItemProvider selfItemProvider, int i, NoteDetailBean noteDetailBean, ClipboardEditText clipboardEditText) {
        this.f6077a = selfItemProvider;
        this.b = i;
    ...
    public void afterTextChanged(Editable editable) {
        this.f6077a.u().onTextChange(this.b, this.c, String.valueOf(editable), this.d);
    }
