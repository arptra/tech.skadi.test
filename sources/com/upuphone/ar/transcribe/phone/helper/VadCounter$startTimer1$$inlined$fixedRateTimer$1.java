...
public final class VadCounter$startTimer1$$inlined$fixedRateTimer$1 extends TimerTask {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ VadCounter f6116a;

    public void run() {
        LogExt.d("mute for proximal", "VadCounter");
        XJAsrManager.e.a().h();
        VoiceListenerAdapter a2 = this.f6116a.f6114a;
        if (a2 != null) {
            a2.onData(1, (byte[]) null, 0, 1, 0.0f);
        }
    }
}
