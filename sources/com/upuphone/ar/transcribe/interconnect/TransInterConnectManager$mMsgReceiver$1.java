...
@Metadata(d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H\u0016¨\u0006\u0006"}, d2 = {"com/upuphone/ar/transcribe/interconnect/TransInterConnectManager$mMsgReceiver$1", "Lcom/upuphone/xr/interconnect/listener/MessageReceiver;", "onMessageReceive", "", "msg", "Lcom/upuphone/xr/interconnect/entity/StarryNetMessage;", "ar-transcribe_intlRelease"}, k = 1, mv = {1, 9, 0}, xi = 48)
public final class TransInterConnectManager$mMsgReceiver$1 extends MessageReceiver {
    ...
    public void onMessageReceive(@Nullable StarryNetMessage starryNetMessage) {
        ...
        if (starryNetMessage == null) {
            LogExt.g("mMsgReceiver:: 互联互通消息为空！", "TranscribeConnectManager");
            return;
        }
        try {
            if (Intrinsics.areEqual((Object) starryNetMessage.getSenderPkg(), (Object) "System")) {
                OnInterConnectMsgListener f = this.this$0.k;
                if (f != null) {
                    f.onRemoteDie();
                    return;
                }
            ...
            if (unit == null) {
                LogExt.g("onMessageReceive-> mConnectMsgReceiver为空，不能处理消息", "TranscribeConnectManager");
            }
        } catch (Exception e) {
            String message2 = starryNetMessage.getMessage();
            String stackTraceToString = ExceptionsKt.stackTraceToString(e);
            LogExt.e("mMsgReceiver:: 消息解析失败！StarryNetMessage = " + message2 + ", \nerrorMsg=" + stackTraceToString, "TranscribeConnectManager");
        }
    }
}
