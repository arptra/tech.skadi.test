...
@DebugMetadata(c = "com.upuphone.ar.transcribe.interconnect.TransInterConnectManager$startLocation$1", f = "TransInterConnectManager.kt", i = {}, l = {583}, m = "invokeSuspend", n = {}, s = {})
public final class TransInterConnectManager$startLocation$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0 || i == 1) {
            ...
            while (this.this$0.q) {
                NaviAbilityOperator c = this.this$0.e;
                if (c != null) {
                    c.startLocation(this.this$0.x);
                }
                this.label = 1;
