...
public class StateMachine {
    ...
    public static class LogRec {
        ...
        public String toString() {
            ...
            sb.append(str);
            sb.append(" what=");
            StateMachine stateMachine = this.f6157a;
    ...
    public static final class LogRecords {
        ...
        public synchronized void a(StateMachine stateMachine, Message message, String str, IState iState, IState iState2, IState iState3) {
            try {
                this.d++;
                if (this.f6158a.size() < this.b) {
                    this.f6158a.add(new LogRec(stateMachine, message, str, iState, iState2, iState3));
                } else {
                    LogRec logRec = (LogRec) this.f6158a.get(this.c);
                    int i = this.c + 1;
                    this.c = i;
                    if (i >= this.b) {
                        this.c = 0;
    ...
    public static final class SmHandler extends Handler {
        ...
        public static class StateInfo {
            ...
            public String toString() {
                StringBuilder sb = new StringBuilder();
                sb.append("state=");
                sb.append(this.f6161a.getName());
                sb.append(",active=");
                sb.append(this.c);
                sb.append(",parent=");
                StateInfo stateInfo = this.b;
                sb.append(stateInfo == null ? "null" : stateInfo.f6161a.getName());
                return sb.toString();
            }
        ...
        public final void n(int i2) {
            while (i2 <= this.g) {
                if (this.b) {
                    StateMachine stateMachine = this.l;
                    stateMachine.k("invokeEnterMethods: " + this.f[i2].f6161a.getName());
                }
                this.f[i2].f6161a.a();
                this.f[i2].c = true;
                i2++;
        ...
        public final int s() {
            ...
            this.g = i3 - 1;
            if (this.b) {
                this.l.k("moveTempStackToStateStack: X mStateStackTop=" + this.g + ",startingIndex=" + i2 + ",Top=" + this.f[this.g].f6161a.getName());
            }
            return i2;
        }
        ...
        public final void t(State state, Message message) {
            ...
            if (state2 == this.k) {
                ULog.d("TrcB-StateMachine", "state machine cleanupAfterQuitting...");
                this.l.r();
                k();
        ...
        public final void u(State state, Message message) {
            State state2 = this.f[this.g].f6161a;
        ...
        public final State w(Message message) {
            ...
            if (this.b) {
                StateMachine stateMachine = this.l;
                stateMachine.k("processMsg: " + stateInfo.f6161a.getName());
            }
            if (p(message)) {
                ULog.i("TrcB-StateMachine", "state machine do quit...");
                B(this.k);
            } else {
                while (true) {
                    if (stateInfo.f6161a.c(message)) {
                        break;
                    }
                    stateInfo = stateInfo.b;
                    if (stateInfo == null) {
                        ...
                        StateMachine stateMachine2 = this.l;
                        stateMachine2.k("processMsg: " + stateInfo.f6161a.getName());
                    }
                }
            }
            if (stateInfo != null) {
                return stateInfo.f6161a;
            }
            return null;
        }
    ...
    public final IState e() {
        ...
        ULog.d("TrcB-StateMachine", "getCurrentStateCode:smh == null");
        return null;
    }
    ...
    public void k(String str) {
        ULog.i("TrcB-StateMachine" + this.f6156a, str);
    }

    public void l(String str) {
        Log.e(this.f6156a, str);
    }
