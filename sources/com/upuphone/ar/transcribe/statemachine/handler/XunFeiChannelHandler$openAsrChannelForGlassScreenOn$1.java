...
public final class XunFeiChannelHandler$openAsrChannelForGlassScreenOn$1 extends Lambda implements Function1<Boolean, Unit> {
    ...
    public final void invoke(boolean z) {
        if (!z) {
            LogExt.g("openAsrChannelForGlassScreenOn: 当前网络异常不能翻译", "XunFeiChannelHandler");
            this.this$0.f6165a.o();
            return;
        }
        StartTrans c = this.this$0.d;
        LogExt.g("openAsrChannelForGlassScreenOn mStartTrans:: " + c, "XunFeiChannelHandler");
        if (this.this$0.d == null) {
            this.this$0.j();
            StartTrans c2 = this.this$0.d;
            LogExt.g("openAsrChannelForGlassScreenOn mStartTrans createConfigInfo:: " + c2, "XunFeiChannelHandler");
        }
        StartTrans c3 = this.this$0.d;
        if (c3 != null) {
            c3.setNewSession(false);
