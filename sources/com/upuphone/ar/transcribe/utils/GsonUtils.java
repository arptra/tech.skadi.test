...
public final class GsonUtils {
    ...
    public static final List b(String str, Class cls) {
        ...
        while (it.hasNext()) {
            arrayList.add(f6185a.c().fromJson(it.next(), cls));
        }
        return arrayList;
    }
