...
public final class RemoteService$onSpeakError$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ String $caller;
    final /* synthetic */ int $code;
    final /* synthetic */ String $id;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public RemoteService$onSpeakError$1(String str, String str2, int i) {
        super(0);
        this.$caller = str;
        this.$id = str2;
        this.$code = i;
