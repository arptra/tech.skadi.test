...
final class TextComposer$matchBest$2 extends Lambda implements Function1<MatchResult, Boolean> {
    public static final TextComposer$matchBest$2 INSTANCE = new TextComposer$matchBest$2();

    public TextComposer$matchBest$2() {
        super(1);
    }
