...
public final class TextSplitter$findOptimal$9 extends Lambda implements Function1<TextSplitter.SymbolString, Boolean> {
    public static final TextSplitter$findOptimal$9 INSTANCE = new TextSplitter$findOptimal$9();

    public TextSplitter$findOptimal$9() {
        super(1);
    }
    ...
    public final Boolean invoke(@NotNull TextSplitter.SymbolString symbolString) {
        ...
        return Boolean.valueOf(Intrinsics.areEqual((Object) symbolString.b(), (Object) MzContactsContract.MzGroups.GROUP_SPLIT_MARK_EXTRA));
    }
}
