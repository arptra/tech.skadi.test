...
public final class TextSplitter$findOptimal$7 extends Lambda implements Function1<TextSplitter.SymbolString, Boolean> {
    public static final TextSplitter$findOptimal$7 INSTANCE = new TextSplitter$findOptimal$7();

    public TextSplitter$findOptimal$7() {
        super(1);
    }
