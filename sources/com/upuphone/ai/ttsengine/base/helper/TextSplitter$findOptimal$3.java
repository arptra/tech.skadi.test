...
public final class TextSplitter$findOptimal$3 extends Lambda implements Function1<TextSplitter.SymbolString, Boolean> {
    public static final TextSplitter$findOptimal$3 INSTANCE = new TextSplitter$findOptimal$3();

    public TextSplitter$findOptimal$3() {
        super(1);
    }
