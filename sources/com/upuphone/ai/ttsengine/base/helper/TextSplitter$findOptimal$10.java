...
public final class TextSplitter$findOptimal$10 extends Lambda implements Function1<TextSplitter.SymbolString, Boolean> {
    public static final TextSplitter$findOptimal$10 INSTANCE = new TextSplitter$findOptimal$10();

    public TextSplitter$findOptimal$10() {
        super(1);
    }
    ...
    public final Boolean invoke(@NotNull TextSplitter.SymbolString symbolString) {
        ...
        return Boolean.valueOf(Intrinsics.areEqual((Object) symbolString.b(), (Object) MzContactsContract.MzGroups.GROUP_SPLIT_MARK_VCARD));
    }
}
