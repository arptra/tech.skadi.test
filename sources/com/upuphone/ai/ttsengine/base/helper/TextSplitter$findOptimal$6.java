...
public final class TextSplitter$findOptimal$6 extends Lambda implements Function1<TextSplitter.SymbolString, Boolean> {
    public static final TextSplitter$findOptimal$6 INSTANCE = new TextSplitter$findOptimal$6();

    public TextSplitter$findOptimal$6() {
        super(1);
    }
