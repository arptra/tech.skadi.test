...
final class TextComposer$matchBest$5 extends Lambda implements Function1<MatchResult, Boolean> {
    public static final TextComposer$matchBest$5 INSTANCE = new TextComposer$matchBest$5();

    public TextComposer$matchBest$5() {
        super(1);
    }
