...
public final class TextSplitter$findOptimal$4 extends Lambda implements Function1<TextSplitter.SymbolString, Boolean> {
    public static final TextSplitter$findOptimal$4 INSTANCE = new TextSplitter$findOptimal$4();

    public TextSplitter$findOptimal$4() {
        super(1);
    }
