...
final class TextComposer$matchBest$6 extends Lambda implements Function1<MatchResult, Boolean> {
    public static final TextComposer$matchBest$6 INSTANCE = new TextComposer$matchBest$6();

    public TextComposer$matchBest$6() {
        super(1);
    }
