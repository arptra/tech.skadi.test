...
final class TextComposer$matchBest$index$1 extends Lambda implements Function1<MatchResult, Boolean> {
    public static final TextComposer$matchBest$index$1 INSTANCE = new TextComposer$matchBest$index$1();

    public TextComposer$matchBest$index$1() {
        super(1);
    }
