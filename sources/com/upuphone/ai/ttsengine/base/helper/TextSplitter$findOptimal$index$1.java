...
public final class TextSplitter$findOptimal$index$1 extends Lambda implements Function1<TextSplitter.SymbolString, Boolean> {
    public static final TextSplitter$findOptimal$index$1 INSTANCE = new TextSplitter$findOptimal$index$1();

    public TextSplitter$findOptimal$index$1() {
        super(1);
    }
    ...
    public final Boolean invoke(@NotNull TextSplitter.SymbolString symbolString) {
        ...
        return Boolean.valueOf(Intrinsics.areEqual((Object) symbolString.b(), (Object) StringUtils.LF));
    }
}
