...
final class TextComposer$matchBest$4 extends Lambda implements Function1<MatchResult, Boolean> {
    public static final TextComposer$matchBest$4 INSTANCE = new TextComposer$matchBest$4();

    public TextComposer$matchBest$4() {
        super(1);
    }
