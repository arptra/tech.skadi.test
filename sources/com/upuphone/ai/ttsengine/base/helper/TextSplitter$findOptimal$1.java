...
public final class TextSplitter$findOptimal$1 extends Lambda implements Function1<TextSplitter.SymbolString, Boolean> {
    public static final TextSplitter$findOptimal$1 INSTANCE = new TextSplitter$findOptimal$1();

    public TextSplitter$findOptimal$1() {
        super(1);
    }
