...
final class TextComposer$matchBest$3 extends Lambda implements Function1<MatchResult, Boolean> {
    public static final TextComposer$matchBest$3 INSTANCE = new TextComposer$matchBest$3();

    public TextComposer$matchBest$3() {
        super(1);
    }
