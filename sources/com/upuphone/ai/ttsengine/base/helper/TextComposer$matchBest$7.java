...
final class TextComposer$matchBest$7 extends Lambda implements Function1<MatchResult, Boolean> {
    public static final TextComposer$matchBest$7 INSTANCE = new TextComposer$matchBest$7();

    public TextComposer$matchBest$7() {
        super(1);
    }
