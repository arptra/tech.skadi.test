...
public final class TextSplitter$findOptimal$8 extends Lambda implements Function1<TextSplitter.SymbolString, Boolean> {
    public static final TextSplitter$findOptimal$8 INSTANCE = new TextSplitter$findOptimal$8();

    public TextSplitter$findOptimal$8() {
        super(1);
    }
