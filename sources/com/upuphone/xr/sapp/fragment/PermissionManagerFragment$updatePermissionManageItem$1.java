...
final class PermissionManagerFragment$updatePermissionManageItem$1 extends Lambda implements Function1<PermissionManageItem, Boolean> {
    final /* synthetic */ Permission $permission;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public PermissionManagerFragment$updatePermissionManageItem$1(Permission permission) {
        super(1);
