...
public final class CommonSettingFragment$addObserve$1 extends Lambda implements Function1<NetDevice, Unit> {
    final /* synthetic */ CommonSettingFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CommonSettingFragment$addObserve$1(CommonSettingFragment commonSettingFragment) {
        super(1);
    ...
    public final void invoke(NetDevice netDevice) {
        this.this$0.M0(netDevice.getState() == ConnectState.CONNECTED);
    }
}
