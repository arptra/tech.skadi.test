...
public final class WiseNotifyFragment$initView$3 extends Lambda implements Function2<Switch, Boolean, Unit> {
    public static final WiseNotifyFragment$initView$3 INSTANCE = new WiseNotifyFragment$initView$3();

    public WiseNotifyFragment$initView$3() {
        super(2);
    }
    ...
    public final void invoke(@NotNull Switch switchR, boolean z) {
        ...
        SuperNotificationManager.f7749a.M(z);
    }
}
