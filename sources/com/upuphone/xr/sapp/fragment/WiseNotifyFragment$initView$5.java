...
public final class WiseNotifyFragment$initView$5 extends Lambda implements Function2<Switch, Boolean, Unit> {
    public static final WiseNotifyFragment$initView$5 INSTANCE = new WiseNotifyFragment$initView$5();

    public WiseNotifyFragment$initView$5() {
        super(2);
    }
    ...
    public final void invoke(@NotNull Switch switchR, boolean z) {
        ...
        SuperNotificationManager.f7749a.e(ReminderType.MSG_TYPE_REMINDER, z);
        if (z) {
