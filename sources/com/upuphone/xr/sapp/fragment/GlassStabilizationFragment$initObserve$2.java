...
public final class GlassStabilizationFragment$initObserve$2 extends Lambda implements Function1<NetDevice, Unit> {
    final /* synthetic */ GlassStabilizationFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public GlassStabilizationFragment$initObserve$2(GlassStabilizationFragment glassStabilizationFragment) {
        super(1);
    ...
    public final void invoke(NetDevice netDevice) {
        this.this$0.H0(netDevice.getState() == ConnectState.CONNECTED);
    }
}
