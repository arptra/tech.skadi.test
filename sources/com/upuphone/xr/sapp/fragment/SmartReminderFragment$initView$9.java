...
public final class SmartReminderFragment$initView$9 extends Lambda implements Function2<Switch, Boolean, Unit> {
    public static final SmartReminderFragment$initView$9 INSTANCE = new SmartReminderFragment$initView$9();

    public SmartReminderFragment$initView$9() {
        super(2);
    }
    ...
    public final void invoke(@NotNull Switch switchR, boolean z) {
        ...
        SuperNotificationManager.f7749a.I(z);
    }
}
