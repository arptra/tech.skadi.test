...
public final class ControlFragment$addObserve$3 extends Lambda implements Function1<Boolean, Unit> {
    final /* synthetic */ ControlFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ControlFragment$addObserve$3(ControlFragment controlFragment) {
        super(1);
