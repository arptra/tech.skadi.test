...
public final class SmartReminderFragment$initView$11 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ SmartReminderFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SmartReminderFragment$initView$11(SmartReminderFragment smartReminderFragment) {
        super(1);
    ...
    public final void invoke(@NotNull View view) {
        ...
        switchR.setChecked(!E02.H.isChecked());
        ...
        superNotificationManager.O(fragmentSmartReminderBinding.H.isChecked());
    }
}
