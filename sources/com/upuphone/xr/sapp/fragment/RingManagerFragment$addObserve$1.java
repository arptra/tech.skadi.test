...
public final class RingManagerFragment$addObserve$1 extends Lambda implements Function1<NetDevice, Unit> {
    final /* synthetic */ RingManagerFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public RingManagerFragment$addObserve$1(RingManagerFragment ringManagerFragment) {
        super(1);
    ...
    public final void invoke(NetDevice netDevice) {
        this.this$0.m = netDevice.getState() == ConnectState.CONNECTED;
        RingManagerFragment ringManagerFragment = this.this$0;
        ringManagerFragment.K0(ringManagerFragment.m);
    }
}
