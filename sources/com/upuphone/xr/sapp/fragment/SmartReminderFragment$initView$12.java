...
public final class SmartReminderFragment$initView$12 extends Lambda implements Function2<Switch, Boolean, Unit> {
    public static final SmartReminderFragment$initView$12 INSTANCE = new SmartReminderFragment$initView$12();

    public SmartReminderFragment$initView$12() {
        super(2);
    }
    ...
    public final void invoke(@NotNull Switch switchR, boolean z) {
        ...
        SuperNotificationManager.f7749a.O(z);
    }
}
