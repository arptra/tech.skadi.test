...
public final class ControlFragment$addObserve$4 extends Lambda implements Function1<Integer, Unit> {
    final /* synthetic */ ControlFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ControlFragment$addObserve$4(ControlFragment controlFragment) {
        super(1);
    ...
    public final void invoke(Integer num) {
        ...
        CardItemView cardItemView = K0.c;
