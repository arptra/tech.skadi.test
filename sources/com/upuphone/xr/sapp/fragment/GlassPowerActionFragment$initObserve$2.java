...
public final class GlassPowerActionFragment$initObserve$2 extends Lambda implements Function1<NetDevice, Unit> {
    final /* synthetic */ GlassPowerActionFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public GlassPowerActionFragment$initObserve$2(GlassPowerActionFragment glassPowerActionFragment) {
        super(1);
    ...
    public final void invoke(NetDevice netDevice) {
        this.this$0.J0(netDevice.getState() == ConnectState.CONNECTED);
    }
}
