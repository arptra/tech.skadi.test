...
public final class GlassManagerFragment$addObserve$8 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ GlassManagerFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public GlassManagerFragment$addObserve$8(GlassManagerFragment glassManagerFragment) {
        super(1);
    ...
    public final void invoke(String str) {
        ...
        CardItemView cardItemView = W0.i;
        DynamicOperateUtil dynamicOperateUtil = DynamicOperateUtil.f7880a;
        Intrinsics.checkNotNull(str);
        cardItemView.setCardSubTitle(dynamicOperateUtil.q(str));
    }
}
