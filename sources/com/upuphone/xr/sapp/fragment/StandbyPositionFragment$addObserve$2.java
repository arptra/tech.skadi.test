...
public final class StandbyPositionFragment$addObserve$2 extends Lambda implements Function1<NetDevice, Unit> {
    final /* synthetic */ StandbyPositionFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public StandbyPositionFragment$addObserve$2(StandbyPositionFragment standbyPositionFragment) {
        super(1);
    ...
    public final void invoke(NetDevice netDevice) {
        ...
        delegate.a("StandbyPositionFragment", "viewModel.connectDevice = " + netDevice);
        this.this$0.i1(netDevice.getState() == ConnectState.CONNECTED);
    }
}
