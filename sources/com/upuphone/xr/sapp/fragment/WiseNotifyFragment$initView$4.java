...
public final class WiseNotifyFragment$initView$4 extends Lambda implements Function2<Switch, Boolean, Unit> {
    public static final WiseNotifyFragment$initView$4 INSTANCE = new WiseNotifyFragment$initView$4();

    public WiseNotifyFragment$initView$4() {
        super(2);
    }
    ...
    public final void invoke(@NotNull Switch switchR, boolean z) {
        ...
        superNotificationManager.e("MSG_TYPE_FLIGHT", z);
        superNotificationManager.p().setValue(Boolean.valueOf(z));
        SdkContext.f6675a.d().reportEvent(ReminderDataTrackEvent.APP_SMART_FLIGHT, MapsKt.hashMapOf(TuplesKt.to("status", z ? "1" : "0")));
    }
}
