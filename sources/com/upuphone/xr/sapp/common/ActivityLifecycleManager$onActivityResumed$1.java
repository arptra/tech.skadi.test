...
public final class ActivityLifecycleManager$onActivityResumed$1 extends Lambda implements Function1<Application.ActivityLifecycleCallbacks, Unit> {
    final /* synthetic */ Activity $activity;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ActivityLifecycleManager$onActivityResumed$1(Activity activity) {
        super(1);
