...
public final class ActivityLifecycleManager$onActivityCreated$1 extends Lambda implements Function1<Application.ActivityLifecycleCallbacks, Unit> {
    final /* synthetic */ Activity $activity;
    final /* synthetic */ Bundle $savedInstanceState;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ActivityLifecycleManager$onActivityCreated$1(Activity activity, Bundle bundle) {
        super(1);
    ...
    public final void invoke(@NotNull Application.ActivityLifecycleCallbacks activityLifecycleCallbacks) {
        ...
        activityLifecycleCallbacks.onActivityCreated(this.$activity, this.$savedInstanceState);
    }
}
