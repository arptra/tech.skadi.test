...
public final class ActivityLifecycleManager$onActivityStopped$1 extends Lambda implements Function1<ApplicationVisibilityCallback, Unit> {
    public static final ActivityLifecycleManager$onActivityStopped$1 INSTANCE = new ActivityLifecycleManager$onActivityStopped$1();

    public ActivityLifecycleManager$onActivityStopped$1() {
        super(1);
    }
    ...
    public final void invoke(@NotNull ApplicationVisibilityCallback applicationVisibilityCallback) {
        ...
        applicationVisibilityCallback.b();
    }
}
