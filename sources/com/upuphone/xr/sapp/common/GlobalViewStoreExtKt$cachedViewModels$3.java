...
@SourceDebugExtension({"SMAP\nGlobalViewStoreExt.kt\nKotlin\n*S Kotlin\n*F\n+ 1 GlobalViewStoreExt.kt\ncom/upuphone/xr/sapp/common/GlobalViewStoreExtKt$cachedViewModels$3\n*L\n1#1,61:1\n*E\n"})
public final class GlobalViewStoreExtKt$cachedViewModels$3 extends Lambda implements Function0<ViewModelStore> {
    final /* synthetic */ String $tag;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public GlobalViewStoreExtKt$cachedViewModels$3(String str) {
        super(0);
        this.$tag = str;
    }
