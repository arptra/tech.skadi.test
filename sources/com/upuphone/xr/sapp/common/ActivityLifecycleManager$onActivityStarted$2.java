...
public final class ActivityLifecycleManager$onActivityStarted$2 extends Lambda implements Function1<Application.ActivityLifecycleCallbacks, Unit> {
    final /* synthetic */ Activity $activity;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ActivityLifecycleManager$onActivityStarted$2(Activity activity) {
        super(1);
    ...
    public final void invoke(@NotNull Application.ActivityLifecycleCallbacks activityLifecycleCallbacks) {
        ...
        activityLifecycleCallbacks.onActivityStarted(this.$activity);
    }
}
