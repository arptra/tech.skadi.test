...
public final class BluetoothHelper$broadcastReceiver$1$onReceive$2 extends Lambda implements Function1<BluetoothListener, Unit> {
    final /* synthetic */ int $newState;
    final /* synthetic */ int $oldState;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BluetoothHelper$broadcastReceiver$1$onReceive$2(int i, int i2) {
        super(1);
        this.$oldState = i;
        this.$newState = i2;
    }
    ...
    public final void invoke(@NotNull BluetoothListener bluetoothListener) {
        ...
        bluetoothListener.b(this.$oldState, this.$newState);
    }
}
