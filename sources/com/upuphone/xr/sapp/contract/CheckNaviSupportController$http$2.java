...
public final class CheckNaviSupportController$http$2 extends Lambda implements Function0<HttpInstance> {
    public static final CheckNaviSupportController$http$2 INSTANCE = new CheckNaviSupportController$http$2();

    public CheckNaviSupportController$http$2() {
        super(0);
    }
