...
public final class AirHelper$special$$inlined$addTwinActionResultListener$1 implements TwinActionMessageListener {
    public void a(String str, String str2, String str3) {
        ...
        Type type = new TypeToken<AirGlassUpdateResult>() {
        }.getType();
        ...
        if (obj != null) {
            AirGlassUpdateResult airGlassUpdateResult = (AirGlassUpdateResult) obj;
            for (Function1 invoke : AirHelper.d) {
                invoke.invoke(airGlassUpdateResult);
            }
        }
    }
}
