...
@SourceDebugExtension({"SMAP\nAirHelper.kt\nKotlin\n*S Kotlin\n*F\n+ 1 AirHelper.kt\ncom/upuphone/xr/sapp/air/AirHelper$sendShowUpdateDialogCmd$2\n+ 2 GlassMessageHelper.kt\ncom/upuphone/xr/sapp/glass/GlassMessageHelper\n+ 3 CancellableContinuation.kt\nkotlinx/coroutines/CancellableContinuationKt\n+ 4 JsonUtils.kt\ncom/upuphone/xr/sapp/utils/JsonUtils\n*L\n1#1,576:1\n293#2,2:577\n186#2:579\n187#2,11:589\n209#2,11:600\n314#3,9:580\n323#3,2:611\n29#4,5:613\n*S KotlinDebug\n*F\n+ 1 AirHelper.kt\ncom/upuphone/xr/sapp/air/AirHelper$sendShowUpdateDialogCmd$2\n*L\n244#1:577,2\n244#1:579\n244#1:589,11\n244#1:600,11\n244#1:580,9\n244#1:611,2\n244#1:613,5\n*E\n"})
@Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u0004\u0018\u00010\u0001*\u00020\u0002H@"}, d2 = {"<anonymous>", "Lcom/upuphone/xr/sapp/entity/BasicGlassResponse;", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = 48)
@DebugMetadata(c = "com.upuphone.xr.sapp.air.AirHelper$sendShowUpdateDialogCmd$2", f = "AirHelper.kt", i = {0, 0, 0, 0}, l = {580}, m = "invokeSuspend", n = {"action$iv", "subAction$iv", "message$iv", "needSendMessageCallback$iv"}, s = {"L$0", "L$1", "L$2", "I$0"})
public final class AirHelper$sendShowUpdateDialogCmd$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super BasicGlassResponse>, Object> {
    int I$0;
    Object L$0;
    Object L$1;
    Object L$2;
    ...
    public AirHelper$sendShowUpdateDialogCmd$2(Continuation<? super AirHelper$sendShowUpdateDialogCmd$2> continuation) {
        super(2, continuation);
    }

    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new AirHelper$sendShowUpdateDialogCmd$2(continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            this.L$0 = "air_ota";
            this.L$1 = "show_air_glass_update_dialog";
            this.L$2 = "";
            this.L$3 = jsonUtils2;
            this.I$0 = 0;
            this.label = 1;
            ...
            glassMessageHelper2.c("air_ota", "show_air_glass_update_dialog", glassMessageHelper$sendMessageAndWait$2$messageListener$1);
            BaseActionData d = glassMessageHelper2.d("air_ota", "show_air_glass_update_dialog", "");
            cancellableContinuationImpl.E(new GlassMessageHelper$sendMessageAndWait$2$1(glassMessageHelper2.i(jsonUtils2.d(d), (byte[]) null, new GlassMessageHelper$sendMessageAndWait$2$listener$1("air_ota", "show_air_glass_update_dialog", glassMessageHelper$sendMessageAndWait$2$messageListener$1, cancellableContinuationImpl), false), "air_ota", "show_air_glass_update_dialog", glassMessageHelper$sendMessageAndWait$2$messageListener$1));
        ...
        Type type = new AirHelper$sendShowUpdateDialogCmd$2$invokeSuspend$$inlined$sendMessageAndWaitResult$1().getType();
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super BasicGlassResponse> continuation) {
        return ((AirHelper$sendShowUpdateDialogCmd$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
