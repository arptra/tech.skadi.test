...
@SourceDebugExtension({"SMAP\nAirHelper.kt\nKotlin\n*S Kotlin\n*F\n+ 1 AirHelper.kt\ncom/upuphone/xr/sapp/air/AirHelper$sendAirSilentSendFileResponse$2\n+ 2 GlassMessageHelper.kt\ncom/upuphone/xr/sapp/glass/GlassMessageHelper\n+ 3 CancellableContinuation.kt\nkotlinx/coroutines/CancellableContinuationKt\n*L\n1#1,576:1\n317#2:577\n318#2,2:587\n332#2,10:589\n314#3,9:578\n323#3,2:599\n*S KotlinDebug\n*F\n+ 1 AirHelper.kt\ncom/upuphone/xr/sapp/air/AirHelper$sendAirSilentSendFileResponse$2\n*L\n534#1:577\n534#1:587,2\n534#1:589,10\n534#1:578,9\n534#1:599,2\n*E\n"})
@Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = 48)
@DebugMetadata(c = "com.upuphone.xr.sapp.air.AirHelper$sendAirSilentSendFileResponse$2", f = "AirHelper.kt", i = {0, 0, 0, 0}, l = {578}, m = "invokeSuspend", n = {"action$iv", "subAction$iv", "message$iv", "bytes$iv"}, s = {"L$0", "L$1", "L$2", "L$3"})
public final class AirHelper$sendAirSilentSendFileResponse$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public AirHelper$sendAirSilentSendFileResponse$2(AirSilentSendFileResponse airSilentSendFileResponse, byte[] bArr, Continuation<? super AirHelper$sendAirSilentSendFileResponse$2> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new AirHelper$sendAirSilentSendFileResponse$2(this.$response, this.$bytes, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            this.L$1 = "request_send_air_update_file";
            this.L$2 = d;
            this.L$3 = bArr;
            this.label = 1;
            ...
            BaseActionData d2 = glassMessageHelper2.d("air_ota_silence", "request_send_air_update_file", d);
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((AirHelper$sendAirSilentSendFileResponse$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
