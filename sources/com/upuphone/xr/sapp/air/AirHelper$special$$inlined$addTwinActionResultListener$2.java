...
public final class AirHelper$special$$inlined$addTwinActionResultListener$2 implements TwinActionMessageListener {
    public void a(String str, String str2, String str3) {
        ...
        Type type = new TypeToken<GlassUpdateDialogResult>() {
        }.getType();
        ...
        if (obj != null) {
            GlassUpdateDialogResult glassUpdateDialogResult = (GlassUpdateDialogResult) obj;
            GlassMessageHelper.f7054a.h("air_ota", "sync_air_glass_update_dialog_result", jsonUtils.d(BasicGlassResponse.Companion.success()));
            for (Function1 invoke : AirHelper.e) {
                invoke.invoke(glassUpdateDialogResult);
            }
        }
    }
}
