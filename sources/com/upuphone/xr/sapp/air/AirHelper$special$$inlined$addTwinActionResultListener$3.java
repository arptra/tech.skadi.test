...
public final class AirHelper$special$$inlined$addTwinActionResultListener$3 implements TwinActionMessageListener {
    public void a(String str, String str2, String str3) {
        ...
        Type type = new TypeToken<RequestSendAirUpdateFile>() {
        }.getType();
        ...
        if (obj != null) {
            RequestSendAirUpdateFile requestSendAirUpdateFile = (RequestSendAirUpdateFile) obj;
            for (Function1 invoke : AirHelper.f) {
                invoke.invoke(requestSendAirUpdateFile);
            }
        }
    }
}
