...
@SourceDebugExtension({"SMAP\nUnicronHelper.kt\nKotlin\n*S Kotlin\n*F\n+ 1 UnicronHelper.kt\ncom/upuphone/xr/sapp/unicron/UnicronHelper$syncUnicronUpdateInfo$2\n+ 2 GlassMessageHelper.kt\ncom/upuphone/xr/sapp/glass/GlassMessageHelper\n+ 3 CancellableContinuation.kt\nkotlinx/coroutines/CancellableContinuationKt\n+ 4 JsonUtils.kt\ncom/upuphone/xr/sapp/utils/JsonUtils\n*L\n1#1,185:1\n287#2,8:186\n186#2:194\n187#2,11:204\n209#2,11:215\n314#3,9:195\n323#3,2:226\n29#4,5:228\n*S KotlinDebug\n*F\n+ 1 UnicronHelper.kt\ncom/upuphone/xr/sapp/unicron/UnicronHelper$syncUnicronUpdateInfo$2\n*L\n132#1:186,8\n132#1:194\n132#1:204,11\n132#1:215,11\n132#1:195,9\n132#1:226,2\n132#1:228,5\n*E\n"})
@Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u0004\u0018\u00010\u0001*\u00020\u0002H@"}, d2 = {"<anonymous>", "Lcom/upuphone/xr/sapp/entity/BasicGlassResponse;", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = 48)
@DebugMetadata(c = "com.upuphone.xr.sapp.unicron.UnicronHelper$syncUnicronUpdateInfo$2", f = "UnicronHelper.kt", i = {0, 0, 0, 0}, l = {195}, m = "invokeSuspend", n = {"action$iv", "subAction$iv", "message$iv", "needSendMessageCallback$iv"}, s = {"L$0", "L$1", "L$2", "I$0"})
public final class UnicronHelper$syncUnicronUpdateInfo$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super BasicGlassResponse>, Object> {
    final /* synthetic */ UnicronUpdateInfo $unicronUpdateInfo;
    int I$0;
    Object L$0;
    Object L$1;
    Object L$2;
    ...
    public UnicronHelper$syncUnicronUpdateInfo$2(UnicronUpdateInfo unicronUpdateInfo, Continuation<? super UnicronHelper$syncUnicronUpdateInfo$2> continuation) {
        super(2, continuation);
        this.$unicronUpdateInfo = unicronUpdateInfo;
    }

    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new UnicronHelper$syncUnicronUpdateInfo$2(this.$unicronUpdateInfo, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            String d = jsonUtils2.d(this.$unicronUpdateInfo);
            this.L$0 = "unicron_ota";
            this.L$1 = "sync_unicron_update_info";
            this.L$2 = d;
            this.L$3 = jsonUtils2;
            this.I$0 = 1;
            this.label = 1;
            ...
            glassMessageHelper2.c("unicron_ota", "sync_unicron_update_info", glassMessageHelper$sendMessageAndWait$2$messageListener$1);
            BaseActionData d2 = glassMessageHelper2.d("unicron_ota", "sync_unicron_update_info", d);
            cancellableContinuationImpl.E(new GlassMessageHelper$sendMessageAndWait$2$1(glassMessageHelper2.i(jsonUtils2.d(d2), (byte[]) null, new GlassMessageHelper$sendMessageAndWait$2$listener$1("unicron_ota", "sync_unicron_update_info", glassMessageHelper$sendMessageAndWait$2$messageListener$1, cancellableContinuationImpl), true), "unicron_ota", "sync_unicron_update_info", glassMessageHelper$sendMessageAndWait$2$messageListener$1));
        ...
        Type type = new UnicronHelper$syncUnicronUpdateInfo$2$invokeSuspend$$inlined$sendMessageAndWaitResult$default$1().getType();
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super BasicGlassResponse> continuation) {
        return ((UnicronHelper$syncUnicronUpdateInfo$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
