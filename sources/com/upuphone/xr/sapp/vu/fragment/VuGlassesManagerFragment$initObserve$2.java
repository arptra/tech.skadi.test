...
public final class VuGlassesManagerFragment$initObserve$2 extends Lambda implements Function1<Integer, Unit> {
    final /* synthetic */ VuGlassesManagerFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public VuGlassesManagerFragment$initObserve$2(VuGlassesManagerFragment vuGlassesManagerFragment) {
        super(1);
    ...
    public final void invoke(Integer num) {
        ...
        CardItemView cardItemView = M0.g;
        VuGlassesPreferenceModel N0 = this.this$0.U0();
        Intrinsics.checkNotNull(num);
        cardItemView.setCardSubTitle(N0.h(num.intValue()));
    }
}
