...
public final class NetworkUtils$innerNetworkCallback$1$onLost$1 extends Lambda implements Function1<ConnectivityManager.NetworkCallback, Unit> {
    final /* synthetic */ Network $network;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NetworkUtils$innerNetworkCallback$1$onLost$1(Network network) {
        super(1);
    ...
    public final void invoke(@NotNull ConnectivityManager.NetworkCallback networkCallback) {
        ...
        networkCallback.onLost(this.$network);
    }
}
