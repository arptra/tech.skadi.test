...
public final class NetworkUtils$innerNetworkCallback$1$onCapabilitiesChanged$1 extends Lambda implements Function1<ConnectivityManager.NetworkCallback, Unit> {
    final /* synthetic */ Network $network;
    final /* synthetic */ NetworkCapabilities $networkCapabilities;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NetworkUtils$innerNetworkCallback$1$onCapabilitiesChanged$1(Network network, NetworkCapabilities networkCapabilities) {
        super(1);
    ...
    public final void invoke(@NotNull ConnectivityManager.NetworkCallback networkCallback) {
        ...
        networkCallback.onCapabilitiesChanged(this.$network, this.$networkCapabilities);
    }
}
