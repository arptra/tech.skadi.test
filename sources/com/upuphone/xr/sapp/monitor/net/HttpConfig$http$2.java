...
public final class HttpConfig$http$2 extends Lambda implements Function0<HttpInstance> {
    public static final HttpConfig$http$2 INSTANCE = new HttpConfig$http$2();

    public HttpConfig$http$2() {
        super(0);
    }
