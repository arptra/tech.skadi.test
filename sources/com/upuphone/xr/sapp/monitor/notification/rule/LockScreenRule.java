...
public final class LockScreenRule extends Rule<AiSdkResult> {
    ...
    public boolean c(AiSdkResult aiSdkResult) {
        ...
        boolean w = superNotificationManager.w();
        NotificationHelper notificationHelper = NotificationHelper.f7775a;
        boolean g = notificationHelper.g();
        delegate.c(b, "State:" + w + " Locked:" + g);
        return !superNotificationManager.w() || notificationHelper.g();
    }
}
