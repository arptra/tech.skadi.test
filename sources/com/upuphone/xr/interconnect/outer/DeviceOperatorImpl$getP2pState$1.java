...
public final class DeviceOperatorImpl$getP2pState$1 extends Lambda implements Function1<IDeviceManager, Integer> {
    public static final DeviceOperatorImpl$getP2pState$1 INSTANCE = new DeviceOperatorImpl$getP2pState$1();

    public DeviceOperatorImpl$getP2pState$1() {
        super(1);
    }
    ...
    public final Integer invoke(@NotNull IDeviceManager iDeviceManager) {
        ...
        return Integer.valueOf(iDeviceManager.getP2pState());
    }
}
