...
public final class TaskOperatorImpl$removeRunning$1 extends Lambda implements Function1<SuperServiceProvider, ITaskManager> {
    public static final TaskOperatorImpl$removeRunning$1 INSTANCE = new TaskOperatorImpl$removeRunning$1();

    public TaskOperatorImpl$removeRunning$1() {
        super(1);
    }
