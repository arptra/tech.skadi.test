...
public final class DataBinderOperatorImpl$unset$2 extends Lambda implements Function1<IDataBinderServer, Unit> {
    final /* synthetic */ String $name;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DataBinderOperatorImpl$unset$2(String str) {
        super(1);
        this.$name = str;
    }
    ...
    public final void invoke(@NotNull IDataBinderServer iDataBinderServer) {
        ...
        iDataBinderServer.unset(this.$name);
    }
}
