...
public final class TaskOperatorImpl$performAction$2 extends Lambda implements Function1<ITaskManager, Unit> {
    final /* synthetic */ String $action;
    final /* synthetic */ String $deviceId;
    final /* synthetic */ int $taskId;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TaskOperatorImpl$performAction$2(String str, int i, String str2) {
        super(1);
        this.$deviceId = str;
        this.$taskId = i;
        this.$action = str2;
    ...
    public final void invoke(ITaskManager iTaskManager) {
        iTaskManager.performAction(this.$deviceId, this.$taskId, this.$action);
    }
}
