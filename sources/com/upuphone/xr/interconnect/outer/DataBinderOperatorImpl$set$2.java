...
public final class DataBinderOperatorImpl$set$2 extends Lambda implements Function1<IDataBinderServer, Unit> {
    final /* synthetic */ String $name;
    final /* synthetic */ DataBinderValue<?> $value;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DataBinderOperatorImpl$set$2(String str, DataBinderValue<?> dataBinderValue) {
        super(1);
        this.$name = str;
    ...
    public final void invoke(@NotNull IDataBinderServer iDataBinderServer) {
        ...
        iDataBinderServer.set(this.$name, this.$value);
    }
}
