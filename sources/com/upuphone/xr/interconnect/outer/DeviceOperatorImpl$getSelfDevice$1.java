...
public final class DeviceOperatorImpl$getSelfDevice$1 extends Lambda implements Function1<IDeviceManager, StarryNetDevice> {
    public static final DeviceOperatorImpl$getSelfDevice$1 INSTANCE = new DeviceOperatorImpl$getSelfDevice$1();

    public DeviceOperatorImpl$getSelfDevice$1() {
        super(1);
    }
    ...
    public final StarryNetDevice invoke(@NotNull IDeviceManager iDeviceManager) {
        ...
        return iDeviceManager.getSelfDevice();
    }
}
