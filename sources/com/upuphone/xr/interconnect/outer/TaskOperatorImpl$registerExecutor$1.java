...
public final class TaskOperatorImpl$registerExecutor$1 extends Lambda implements Function1<SuperServiceProvider, ITaskManager> {
    public static final TaskOperatorImpl$registerExecutor$1 INSTANCE = new TaskOperatorImpl$registerExecutor$1();

    public TaskOperatorImpl$registerExecutor$1() {
        super(1);
    }
