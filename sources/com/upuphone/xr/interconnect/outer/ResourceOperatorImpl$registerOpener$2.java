...
public final class ResourceOperatorImpl$registerOpener$2 extends Lambda implements Function1<IResourceManager, Unit> {
    final /* synthetic */ String $taskExecutorName;
    final /* synthetic */ byte $type;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ResourceOperatorImpl$registerOpener$2(byte b, String str) {
        super(1);
        this.$type = b;
    ...
    public final void invoke(IResourceManager iResourceManager) {
        iResourceManager.registerOpener(this.$type, this.$taskExecutorName);
    }
}
