...
public final class TaskOperatorImpl$performAction$1 extends Lambda implements Function1<SuperServiceProvider, ITaskManager> {
    public static final TaskOperatorImpl$performAction$1 INSTANCE = new TaskOperatorImpl$performAction$1();

    public TaskOperatorImpl$performAction$1() {
        super(1);
    }
