...
public final class ConnectMessageOuterClass {

    /* renamed from: com.upuphone.xr.interconnect.entity.ConnectMessageOuterClass$1  reason: invalid class name */
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.upuphone.xr.interconnect.entity.ConnectMessageOuterClass.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public static final class ConnectMessage extends GeneratedMessageLite<ConnectMessage, Builder> implements ConnectMessageOrBuilder {
        ...
        public static final ConnectMessage DEFAULT_INSTANCE;
        private static volatile Parser<ConnectMessage> PARSER = null;
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<ConnectMessage, Builder> implements ConnectMessageOrBuilder {
            public Builder clearVersion() {
                copyOnWrite();
                ((ConnectMessage) this.instance).clearVersion();
                return this;
            }

            public int getVersion() {
                return ((ConnectMessage) this.instance).getVersion();
            }

            public Builder setVersion(int i) {
                copyOnWrite();
                ((ConnectMessage) this.instance).setVersion(i);
                return this;
            }
        ...
        static {
            ...
            DEFAULT_INSTANCE = connectMessage;
            GeneratedMessageLite.registerDefaultInstance(ConnectMessage.class, connectMessage);
        }
        ...
        public static ConnectMessage parseDelimitedFrom(InputStream inputStream) throws IOException {
            return (ConnectMessage) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
        }

        public static ConnectMessage parseFrom(ByteBuffer byteBuffer) throws InvalidProtocolBufferException {
            return (ConnectMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
                ...
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
                    Parser<ConnectMessage> parser = PARSER;
                    if (parser == null) {
        ...
        public static Builder newBuilder(ConnectMessage connectMessage) {
            return (Builder) DEFAULT_INSTANCE.createBuilder(connectMessage);
        }
        ...
        public static ConnectMessage parseDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
            return (ConnectMessage) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, extensionRegistryLite);
        }

        public static ConnectMessage parseFrom(ByteBuffer byteBuffer, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            return (ConnectMessage) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, extensionRegistryLite);
        }
    ...
    private ConnectMessageOuterClass() {
    }
