...
public final class ConnectMsg extends GeneratedMessageLite<ConnectMsg, Builder> implements ConnectMsgOrBuilder {
    public static final int DATA_FIELD_NUMBER = 2;
    /* access modifiers changed from: private */
    public static final ConnectMsg DEFAULT_INSTANCE;
    private static volatile Parser<ConnectMsg> PARSER;
    private ByteString data_ = ByteString.EMPTY;

    /* renamed from: com.upuphone.xr.interconnect.entity.ConnectMsg$1  reason: invalid class name */
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.upuphone.xr.interconnect.entity.ConnectMsg.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<ConnectMsg, Builder> implements ConnectMsgOrBuilder {
        public Builder clearData() {
            copyOnWrite();
            ((ConnectMsg) this.instance).clearData();
            return this;
        }

        public ByteString getData() {
            return ((ConnectMsg) this.instance).getData();
        }

        public Builder setData(ByteString byteString) {
            copyOnWrite();
            ((ConnectMsg) this.instance).setData(byteString);
            return this;
        }
    ...
    public static Builder newBuilder(ConnectMsg connectMsg) {
        return (Builder) DEFAULT_INSTANCE.createBuilder(connectMsg);
    }
