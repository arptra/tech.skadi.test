...
public final class InnerSuperAppServiceManager$request$1$1$1 extends Lambda implements Function1<OperatorManagerCreateCallback, Unit> {
    final /* synthetic */ OperatorManager $it;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public InnerSuperAppServiceManager$request$1$1$1(OperatorManager operatorManager) {
        super(1);
        this.$it = operatorManager;
    }
    ...
    public final void invoke(@NotNull OperatorManagerCreateCallback operatorManagerCreateCallback) {
        ...
        OperatorManager operatorManager = this.$it;
        Intrinsics.checkNotNullExpressionValue(operatorManager, "it");
