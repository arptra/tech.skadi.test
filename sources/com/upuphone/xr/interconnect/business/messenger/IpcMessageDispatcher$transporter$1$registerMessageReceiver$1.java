...
public final class IpcMessageDispatcher$transporter$1$registerMessageReceiver$1 extends Lambda implements Function0<Unit> {
    ...
    public IpcMessageDispatcher$transporter$1$registerMessageReceiver$1(IpcMessageDispatcher ipcMessageDispatcher, int i, String str, String str2, IMessageReceiver iMessageReceiver) {
        super(0);
    ...
    public final void invoke() {
        ...
        ILog.d(access$getTag, "Adding " + i + " receiver " + str + " #" + str2 + ".");
        if (this.this$0.receiverIds.contains(this.$binderId)) {
            String access$getTag2 = this.this$0.getTag();
            String str3 = this.$binderId;
            ILog.d(access$getTag2, "#" + str3 + " has already been added.");
            return;
        }
        this.this$0.receiverIds.add(this.$binderId);
        this.this$0.receiverBuckets.set(Integer.valueOf(this.$callingPid), this.$receiver);
