...
public final class IpcMessageDispatcher$dispatch$2$1$1$1 extends Lambda implements Function1<IMessageReceiver, Unit> {
    final /* synthetic */ StarryNetMessage $message;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public IpcMessageDispatcher$dispatch$2$1$1$1(StarryNetMessage starryNetMessage) {
        super(1);
