...
public final class MessageTxProcessor$2$result$1$1$onSuccess$1 extends Lambda implements Function1<IMessageSendListener, Unit> {
    final /* synthetic */ int $identifier;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MessageTxProcessor$2$result$1$1$onSuccess$1(int i) {
        super(1);
        this.$identifier = i;
    }
    ...
    public final void invoke(@NotNull IMessageSendListener iMessageSendListener) {
        ...
        iMessageSendListener.onSuccess(String.valueOf(this.$identifier));
    }
}
