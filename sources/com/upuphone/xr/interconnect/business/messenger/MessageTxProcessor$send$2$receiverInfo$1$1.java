...
public final class MessageTxProcessor$send$2$receiverInfo$1$1 extends Lambda implements Function1<IMessageSendListener, Unit> {
    final /* synthetic */ int $messageId;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MessageTxProcessor$send$2$receiverInfo$1$1(int i) {
        super(1);
        this.$messageId = i;
    }
    ...
    public final void invoke(@NotNull IMessageSendListener iMessageSendListener) {
        ...
        iMessageSendListener.onFail(String.valueOf(this.$messageId), -1);
    }
}
