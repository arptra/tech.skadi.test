...
@SourceDebugExtension({"SMAP\nDataBinderManager.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DataBinderManager.kt\ncom/upuphone/xr/interconnect/business/databinder/DataBinderManager$subscribe$2\n+ 2 Semaphore.kt\nkotlinx/coroutines/sync/SemaphoreKt\n*L\n1#1,252:1\n81#2,9:253\n*S KotlinDebug\n*F\n+ 1 DataBinderManager.kt\ncom/upuphone/xr/interconnect/business/databinder/DataBinderManager$subscribe$2\n*L\n201#1:253,9\n*E\n"})
@Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = 48)
@DebugMetadata(c = "com.upuphone.xr.interconnect.business.databinder.DataBinderManager$subscribe$2", f = "DataBinderManager.kt", i = {0}, l = {257}, m = "invokeSuspend", n = {"$this$withPermit$iv"}, s = {"L$0"})
public final class DataBinderManager$subscribe$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public DataBinderManager$subscribe$2(DataBinderManager dataBinderManager, String str, String str2, IDataBinderItemUpdateListener iDataBinderItemUpdateListener, Continuation<? super DataBinderManager$subscribe$2> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new DataBinderManager$subscribe$2(this.this$0, this.$deviceId, this.$name, this.$listener, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            FlowExtKt.emitOrErr(dataBinderManager.eventFlow, new DataBinderDeviceEvent.SubscribeInner(str, str2, iDataBinderItemUpdateListener));
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((DataBinderManager$subscribe$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
