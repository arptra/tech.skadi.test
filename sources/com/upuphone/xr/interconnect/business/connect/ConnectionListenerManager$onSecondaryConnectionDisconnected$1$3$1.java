...
public final class ConnectionListenerManager$onSecondaryConnectionDisconnected$1$3$1 extends Lambda implements Function1<IDeviceConnectionListener, Unit> {
    final /* synthetic */ StarryNetDevice $device;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$onSecondaryConnectionDisconnected$1$3$1(StarryNetDevice starryNetDevice) {
        super(1);
