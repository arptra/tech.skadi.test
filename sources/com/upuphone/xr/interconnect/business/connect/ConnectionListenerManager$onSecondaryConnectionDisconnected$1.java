...
@SourceDebugExtension({"SMAP\nConnectionListenerManager.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ConnectionListenerManager.kt\ncom/upuphone/xr/interconnect/business/connect/ConnectionListenerManager$onSecondaryConnectionDisconnected$1\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,492:1\n1855#2,2:493\n1855#2,2:495\n1855#2,2:497\n1855#2,2:499\n*S KotlinDebug\n*F\n+ 1 ConnectionListenerManager.kt\ncom/upuphone/xr/interconnect/business/connect/ConnectionListenerManager$onSecondaryConnectionDisconnected$1\n*L\n435#1:493,2\n438#1:495,2\n439#1:497,2\n442#1:499,2\n*E\n"})
@Metadata(d1 = {"\u0000\b\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"}, d2 = {"<anonymous>", "", "invoke"}, k = 3, mv = {1, 9, 0}, xi = 48)
public final class ConnectionListenerManager$onSecondaryConnectionDisconnected$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ StarryNetDevice $device;
    final /* synthetic */ ConnectionListenerManager this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$onSecondaryConnectionDisconnected$1(ConnectionListenerManager connectionListenerManager, StarryNetDevice starryNetDevice) {
        super(0);
    ...
    public final void invoke() {
        ...
        ILog.d(access$getTag, "Dispatching #" + deviceId + "(secondary) disconnected event to " + size + " conn, " + size2 + " stat listeners.");
        ...
        ILog.d(access$getTag2, "Dispatching #" + deviceId2 + "(secondary) disconnected event to " + size3 + " Priority conn stat listeners.");
        ...
        for (IDeviceConnectionListener access$safeCallRemoteListener : access$getDeviceConnectionPriorityListeners$p) {
            connectionListenerManager.safeCallRemoteListener(access$safeCallRemoteListener, new ConnectionListenerManager$onSecondaryConnectionDisconnected$1$1$1(starryNetDevice));
        }
        ...
        for (ConnectionListener access$safeCallRemoteListener2 : access$getConnectionListeners$p) {
            connectionListenerManager2.safeCallRemoteListener(access$safeCallRemoteListener2, new ConnectionListenerManager$onSecondaryConnectionDisconnected$1$2$1(starryNetDevice2));
        }
        ...
        for (IDeviceConnectionListener access$safeCallRemoteListener3 : access$getDeviceConnectionListeners$p) {
            connectionListenerManager3.safeCallRemoteListener(access$safeCallRemoteListener3, new ConnectionListenerManager$onSecondaryConnectionDisconnected$1$3$1(starryNetDevice3));
        }
        ...
        for (StarryNetDeviceStateChangeListener access$safeCallRemoteListener4 : access$getDeviceStateChangeListeners$p) {
            connectionListenerManager4.safeCallRemoteListener(access$safeCallRemoteListener4, new ConnectionListenerManager$onSecondaryConnectionDisconnected$1$4$1(starryNetDevice4));
        }
    }
}
