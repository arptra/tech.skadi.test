...
public final class ConnectionListenerManager$registerDeviceConnectionListener$1$1$1 extends Lambda implements Function1<IDeviceConnectionListener, Unit> {
    final /* synthetic */ DeviceWrapper $it;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$registerDeviceConnectionListener$1$1$1(DeviceWrapper deviceWrapper) {
        super(1);
