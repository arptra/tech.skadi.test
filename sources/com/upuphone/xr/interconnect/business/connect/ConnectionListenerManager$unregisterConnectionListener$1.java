...
public final class ConnectionListenerManager$unregisterConnectionListener$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ ConnectionListener $listener;
    final /* synthetic */ ConnectionListenerManager this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$unregisterConnectionListener$1(ConnectionListenerManager connectionListenerManager, ConnectionListener connectionListener) {
        super(0);
    ...
    public final void invoke() {
        ...
        this.this$0.connectionListeners.remove(this.$listener);
    }
}
