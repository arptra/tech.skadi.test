...
@SourceDebugExtension({"SMAP\nConnectionListenerManager.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ConnectionListenerManager.kt\ncom/upuphone/xr/interconnect/business/connect/ConnectionListenerManager$onConnectionUnbound$1\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,492:1\n1855#2,2:493\n1855#2,2:495\n*S KotlinDebug\n*F\n+ 1 ConnectionListenerManager.kt\ncom/upuphone/xr/interconnect/business/connect/ConnectionListenerManager$onConnectionUnbound$1\n*L\n243#1:493,2\n246#1:495,2\n*E\n"})
@Metadata(d1 = {"\u0000\b\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001H\n¢\u0006\u0002\b\u0002"}, d2 = {"<anonymous>", "", "invoke"}, k = 3, mv = {1, 9, 0}, xi = 48)
public final class ConnectionListenerManager$onConnectionUnbound$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ StarryNetDevice $device;
    final /* synthetic */ ConnectionListenerManager this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$onConnectionUnbound$1(ConnectionListenerManager connectionListenerManager, StarryNetDevice starryNetDevice) {
        super(0);
    ...
    public final void invoke() {
        ...
        ILog.d(access$getTag, "Dispatching #" + deviceId + " unbound event to " + size + " stat, " + size2 + " bond listeners.");
        ...
        for (StarryNetDeviceStateChangeListener access$safeCallRemoteListener : access$getDeviceStateChangeListeners$p) {
            connectionListenerManager.safeCallRemoteListener(access$safeCallRemoteListener, new ConnectionListenerManager$onConnectionUnbound$1$1$1(starryNetDevice));
        }
        ...
        for (IDeviceBondStateListener access$safeCallRemoteListener2 : access$getDeviceBondStateListeners$p) {
            connectionListenerManager2.safeCallRemoteListener(access$safeCallRemoteListener2, new ConnectionListenerManager$onConnectionUnbound$1$2$1(starryNetDevice2));
        }
    }
}
