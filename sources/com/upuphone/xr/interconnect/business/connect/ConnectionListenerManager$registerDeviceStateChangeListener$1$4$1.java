...
public final class ConnectionListenerManager$registerDeviceStateChangeListener$1$4$1 extends Lambda implements Function1<StarryNetDeviceStateChangeListener, Unit> {
    final /* synthetic */ StarryNetDevice $ringDevice;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$registerDeviceStateChangeListener$1$4$1(StarryNetDevice starryNetDevice) {
        super(1);
        this.$ringDevice = starryNetDevice;
    }
    ...
    public final void invoke(@NotNull StarryNetDeviceStateChangeListener starryNetDeviceStateChangeListener) {
        ...
        starryNetDeviceStateChangeListener.onConnectStateChanged(this.$ringDevice, 2);
    }
}
