...
public final class ConnectionStateManagerImpl$onGlassBrConnected$1 extends Lambda implements Function0<Unit> {
    ...
    public ConnectionStateManagerImpl$onGlassBrConnected$1(StarryDevice starryDevice, ConnectionStateManagerImpl connectionStateManagerImpl, String str, boolean z) {
        super(0);
    ...
    public final void invoke() {
        ...
        ILog.d(access$getTag, "#" + str + " overseas of type " + terminalType + " has connected via br.");
        ...
        } else if (terminalType != 4 && terminalType != 6 && this.$isBleConnected) {
