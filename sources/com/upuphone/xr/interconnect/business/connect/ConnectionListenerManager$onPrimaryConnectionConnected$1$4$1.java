...
public final class ConnectionListenerManager$onPrimaryConnectionConnected$1$4$1 extends Lambda implements Function1<StarryNetDeviceStateChangeListener, Unit> {
    final /* synthetic */ StarryNetDevice $device;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$onPrimaryConnectionConnected$1$4$1(StarryNetDevice starryNetDevice) {
        super(1);
