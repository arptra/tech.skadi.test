...
public final class ConnectionListenerManager$onPeerNegotiated$1$1$2$1 extends Lambda implements Function1<IDeviceConnectionListener, Unit> {
    final /* synthetic */ StarryNetDevice $device;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$onPeerNegotiated$1$1$2$1(StarryNetDevice starryNetDevice) {
        super(1);
