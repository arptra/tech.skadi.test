...
public final class ConnectionListenerManager$onConnectionBinding$1$1$1 extends Lambda implements Function1<StarryNetDeviceStateChangeListener, Unit> {
    final /* synthetic */ StarryNetDevice $device;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$onConnectionBinding$1$1$1(StarryNetDevice starryNetDevice) {
        super(1);
    ...
    public final void invoke(@NotNull StarryNetDeviceStateChangeListener starryNetDeviceStateChangeListener) {
        ...
        starryNetDeviceStateChangeListener.onBondStateChanged(this.$device, 1);
    }
}
