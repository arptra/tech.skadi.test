...
public final class ConnectionListenerManager$onSecondaryConnectionConnected$1$3$1 extends Lambda implements Function1<IDeviceConnectionListener, Unit> {
    final /* synthetic */ StarryNetDevice $device;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$onSecondaryConnectionConnected$1$3$1(StarryNetDevice starryNetDevice) {
        super(1);
    ...
    public final void invoke(@NotNull IDeviceConnectionListener iDeviceConnectionListener) {
        ...
        iDeviceConnectionListener.onDeviceConnected(this.$device);
    }
}
