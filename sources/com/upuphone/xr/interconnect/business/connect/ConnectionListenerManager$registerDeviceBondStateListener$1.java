...
public final class ConnectionListenerManager$registerDeviceBondStateListener$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ IDeviceBondStateListener $listener;
    final /* synthetic */ ConnectionListenerManager this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$registerDeviceBondStateListener$1(ConnectionListenerManager connectionListenerManager, IDeviceBondStateListener iDeviceBondStateListener) {
        super(0);
    ...
    public final void invoke() {
        ...
        ILog.d(access$getTag, "Adding to " + size + " bond listeners: " + stringify + ".");
        this.this$0.deviceBondStateListeners.add(this.$listener);
    }
}
