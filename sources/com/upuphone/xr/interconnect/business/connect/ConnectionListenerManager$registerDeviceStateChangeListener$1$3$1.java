...
public final class ConnectionListenerManager$registerDeviceStateChangeListener$1$3$1 extends Lambda implements Function1<StarryNetDeviceStateChangeListener, Unit> {
    final /* synthetic */ DeviceWrapper $it;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$registerDeviceStateChangeListener$1$3$1(DeviceWrapper deviceWrapper) {
        super(1);
        this.$it = deviceWrapper;
    }
    ...
    public final void invoke(@NotNull StarryNetDeviceStateChangeListener starryNetDeviceStateChangeListener) {
        ...
        starryNetDeviceStateChangeListener.onConnectStateChanged(this.$it.getDevice(), 2);
    }
}
