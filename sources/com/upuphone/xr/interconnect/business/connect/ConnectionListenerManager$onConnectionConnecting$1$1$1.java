...
public final class ConnectionListenerManager$onConnectionConnecting$1$1$1 extends Lambda implements Function1<StarryNetDeviceStateChangeListener, Unit> {
    final /* synthetic */ StarryNetDevice $wrappedDevice;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$onConnectionConnecting$1$1$1(StarryNetDevice starryNetDevice) {
        super(1);
        this.$wrappedDevice = starryNetDevice;
    }
    ...
    public final void invoke(@NotNull StarryNetDeviceStateChangeListener starryNetDeviceStateChangeListener) {
        ...
        starryNetDeviceStateChangeListener.onConnectStateChanged(this.$wrappedDevice, 1);
    }
}
