...
public final class ConnectionListenerManager$onPrimaryConnectionDisconnected$1$5$1 extends Lambda implements Function1<StarryNetDeviceStateChangeListener, Unit> {
    final /* synthetic */ StarryNetDevice $device;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$onPrimaryConnectionDisconnected$1$5$1(StarryNetDevice starryNetDevice) {
        super(1);
