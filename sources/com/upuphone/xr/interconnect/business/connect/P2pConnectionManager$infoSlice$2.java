...
public final class P2pConnectionManager$infoSlice$2 extends Lambda implements Function0<DataBinderSlice> {
    public static final P2pConnectionManager$infoSlice$2 INSTANCE = new P2pConnectionManager$infoSlice$2();

    public P2pConnectionManager$infoSlice$2() {
        super(0);
    }
