...
public final class ConnectionListenerManager$registerConnectionListener$1$1$1 extends Lambda implements Function1<ConnectionListener, Unit> {
    final /* synthetic */ DeviceWrapper $it;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$registerConnectionListener$1$1$1(DeviceWrapper deviceWrapper) {
        super(1);
    ...
    public final void invoke(@NotNull ConnectionListener connectionListener) {
        ...
        StarryNetDevice device = this.$it.getDevice();
        Intrinsics.checkNotNullExpressionValue(device, "getDevice(...)");
        connectionListener.onConnectionUp(device);
    }
}
