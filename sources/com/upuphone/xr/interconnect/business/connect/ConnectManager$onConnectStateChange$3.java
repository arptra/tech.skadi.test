...
public final class ConnectManager$onConnectStateChange$3 extends Lambda implements Function0<Unit> {
    final /* synthetic */ StarryDevice $device;
    final /* synthetic */ int $newState;
    final /* synthetic */ ConnectManager this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectManager$onConnectStateChange$3(ConnectManager connectManager, StarryDevice starryDevice, int i) {
        super(0);
    ...
    public final void invoke() {
        ...
        this.this$0.handleRingConnectStateChange(this.$device, this.$newState);
    }
}
