...
public final class ConnectionListenerManager$registerDeviceConnectionPriorityListener$1$1 extends Lambda implements Function1<IDeviceConnectionListener, Unit> {
    final /* synthetic */ DeviceWrapper $it;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ConnectionListenerManager$registerDeviceConnectionPriorityListener$1$1(DeviceWrapper deviceWrapper) {
        super(1);
    ...
    public final void invoke(@NotNull IDeviceConnectionListener iDeviceConnectionListener) {
        ...
        iDeviceConnectionListener.onDeviceConnected(this.$it.getDevice());
    }
}
