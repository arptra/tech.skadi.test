...
public interface IDataBinderServer extends IInterface {
    public static final String DESCRIPTOR = "com.upuphone.xr.interconnect.common.IDataBinderServer";

    public static class Default implements IDataBinderServer {
        ...
        public void register(IDataBinderClient iDataBinderClient) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IDataBinderServer {
        ...
        public static class Proxy implements IDataBinderServer {
            ...
            public DataBinderValue get(String str, String str2) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(IDataBinderServer.DESCRIPTOR);
            ...
            public String getInterfaceDescriptor() {
                return IDataBinderServer.DESCRIPTOR;
            }
            ...
            public void register(IDataBinderClient iDataBinderClient) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(IDataBinderServer.DESCRIPTOR);
                    obtain.writeStrongInterface(iDataBinderClient);
        ...
        public Stub() {
            attachInterface(this, IDataBinderServer.DESCRIPTOR);
        }

        public static IDataBinderServer asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(IDataBinderServer.DESCRIPTOR);
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IDataBinderServer)) ? new Proxy(iBinder) : (IDataBinderServer) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(IDataBinderServer.DESCRIPTOR);
            }
            if (i != 1598968902) {
                switch (i) {
                    case 1:
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        register(IDataBinderClient.Stub.asInterface(parcel.readStrongBinder()));
                        parcel2.writeNoException();
                        break;
                    default:
            ...
            parcel2.writeString(IDataBinderServer.DESCRIPTOR);
            return true;
        }
    }
    ...
    void register(IDataBinderClient iDataBinderClient) throws RemoteException;
