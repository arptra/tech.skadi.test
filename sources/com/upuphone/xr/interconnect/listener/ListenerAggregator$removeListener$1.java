...
public final class ListenerAggregator$removeListener$1 extends Lambda implements Function0<Unit> {
    ...
    public ListenerAggregator$removeListener$1(ListenerAggregator<L, R> listenerAggregator, String str, L l) {
        super(0);
    ...
    public final void invoke() {
        ...
        Log.d(access$getLogTag$p, "removing " + this.this$0.name + " listener: " + this.$listenerName + '.');
        if (this.this$0.listeners.remove(this.$listener)) {
            String access$getLogTag$p2 = this.this$0.logTag;
            Log.i(access$getLogTag$p2, "Removed " + this.$listener + '.');
        }
        ...
        Log.v(access$getLogTag$p3, "listener count: " + this.this$0.listeners.size() + '.');
    }
}
