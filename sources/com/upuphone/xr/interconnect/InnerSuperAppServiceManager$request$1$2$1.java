...
public final class InnerSuperAppServiceManager$request$1$2$1 extends Lambda implements Function1<OperatorManagerCreateCallback, Unit> {
    final /* synthetic */ OperatorManager $instance;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public InnerSuperAppServiceManager$request$1$2$1(OperatorManager operatorManager) {
        super(1);
