...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.on((char) StringUtil.COMMA).trimResults();
    ...
    public static class KeyStrengthParser implements ValueParser {
        ...
        public void parse(CacheBuilderSpec cacheBuilderSpec, String str, @NullableDecl String str2) {
            ...
            Preconditions.checkArgument(z, "%s was already set to %s", (Object) str, (Object) strength2);
    ...
    public static class MaximumSizeParser extends LongParser {
        public void parseLong(CacheBuilderSpec cacheBuilderSpec, long j) {
            ...
            boolean z = false;
            Preconditions.checkArgument(l == null, "maximum size was already set to ", (Object) l);
            Long l2 = cacheBuilderSpec.maximumWeight;
            if (l2 == null) {
                z = true;
            }
            Preconditions.checkArgument(z, "maximum weight was already set to ", (Object) l2);
    ...
    public static class MaximumWeightParser extends LongParser {
        public void parseLong(CacheBuilderSpec cacheBuilderSpec, long j) {
            ...
            boolean z = false;
            Preconditions.checkArgument(l == null, "maximum weight was already set to ", (Object) l);
            Long l2 = cacheBuilderSpec.maximumSize;
            if (l2 == null) {
                z = true;
            }
            Preconditions.checkArgument(z, "maximum size was already set to ", (Object) l2);
