...
final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    public static long charToThreeUtf8Bytes(char c) {
        return (long) ((((c & '?') | 128) << 16) | (((c >>> 12) | OdnpConfigStatic.UPLOAD_LOW_PRIORITY_DURATION_MINUTES) & 255) | ((((c >>> 6) & 63) | 128) << 8));
    }

    /* access modifiers changed from: private */
    public static long charToTwoUtf8Bytes(char c) {
        return (long) ((((c & '?') | 128) << 8) | (((c >>> 6) | OdnpConfigStatic.UPLOAD_MEDIUM_PRIORITY_DURATION_MINUTES) & 255));
    }
