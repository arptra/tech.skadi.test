    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            if (i8 == i4) {
                ...
                jArr[0] = j5;
                jArr2[0] = jArr2[0] + j5;
                long rotateRight4 = (Long.rotateRight(((rotateRight3 + load642) + jArr[0]) + LittleEndianByteArray.load64(bArr2, i6 - 55), 37) * j3) ^ (jArr2[1] * 9);
                long rotateRight5 = (Long.rotateRight(load642 + jArr[1] + LittleEndianByteArray.load64(bArr2, i6 - 15), 42) * j3) + (jArr[0] * 9) + LittleEndianByteArray.load64(bArr2, i6 - 23);
                ...
                weakHashLength32WithSeeds(bArr3, i6 - 31, rotateRight6 + jArr2[1], LittleEndianByteArray.load64(bArr2, i6 - 47) + rotateRight5, jArr2);
                long j6 = j3;
