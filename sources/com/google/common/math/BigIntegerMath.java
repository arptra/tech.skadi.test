...
public final class BigIntegerMath {
    ...
    public static BigInteger factorial(int i) {
        int i2 = i;
        MathPreconditions.checkNonNegative(n.f2968a, i2);
    ...
    public static int log10(BigInteger bigInteger, RoundingMode roundingMode) {
        int i;
        MathPreconditions.checkPositive(x.f, bigInteger);
    ...
    public static int log2(BigInteger bigInteger, RoundingMode roundingMode) {
        MathPreconditions.checkPositive(x.f, (BigInteger) Preconditions.checkNotNull(bigInteger));
    ...
    public static BigInteger sqrt(BigInteger bigInteger, RoundingMode roundingMode) {
        MathPreconditions.checkNonNegative(x.f, bigInteger);
        if (fitsInLong(bigInteger)) {
