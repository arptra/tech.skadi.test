    ...
    public static final class ScaleAndIndexes {
        ...
        public Map<Integer, Double> computeInPlace(double... dArr) {
            ...
            while (true) {
                ...
                int i7 = iArr4[i];
                if (i7 == 0) {
                    linkedHashMap2.put(Integer.valueOf(iArr7[i]), Double.valueOf(dArr2[i6]));
                } else {
                    linkedHashMap2.put(Integer.valueOf(iArr7[i]), Double.valueOf(Quantiles.interpolate(dArr2[i6], dArr2[i6 + 1], (double) i7, (double) this.scale)));
                }
                i++;
            }
        }
