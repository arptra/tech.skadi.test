...
public final class LongMath {
    ...
    static final int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, MlKitException.CODE_SCANNER_PIPELINE_INFERENCE_ERROR, Opcodes.RET, 143, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    @VisibleForTesting
    static final int[] biggestSimpleBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, 684, 419, 287, 214, Opcodes.RET, 139, CmdCode.CODE_RESET_VAD_STATUS, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    ...
    public static long binomial(int i, int i2) {
        MathPreconditions.checkNonNegative(n.f2968a, i);
    ...
    public static long ceilingPowerOfTwo(long j) {
        MathPreconditions.checkPositive(x.f, j);
    ...
    public static long gcd(long j, long j2) {
        MathPreconditions.checkNonNegative(a.f3359a, j);
    ...
    public static boolean isPrime(long j) {
        if (j < 2) {
            MathPreconditions.checkNonNegative(n.f2968a, j);
            return false;
        } else if (j < 66) {
    ...
    public static double roundToDouble(long j, RoundingMode roundingMode) {
        ...
        double d2 = (double) j3;
        long j4 = (long) d2;
        int compare = j4 == LongCompanionObject.MAX_VALUE ? -1 : Longs.compare(j3, j4);
        ...
        switch (iArr[roundingMode.ordinal()]) {
            case 1:
                ...
                return d2;
            case 2:
                return j3 >= 0 ? compare >= 0 ? d2 : DoubleUtils.nextDown(d2) : compare <= 0 ? d2 : Math.nextUp(d2);
            case 3:
                return compare >= 0 ? d2 : DoubleUtils.nextDown(d2);
            case 4:
                return j3 >= 0 ? compare <= 0 ? d2 : Math.nextUp(d2) : compare >= 0 ? d2 : DoubleUtils.nextDown(d2);
            case 5:
    ...
    public static long sqrt(long j, RoundingMode roundingMode) {
        MathPreconditions.checkNonNegative(x.f, j);
        if (fitsInInt(j)) {
