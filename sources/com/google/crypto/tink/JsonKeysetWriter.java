...
public final class JsonKeysetWriter implements KeysetWriter {
    ...
    private JsonObject toJson(Keyset keyset) {
        ...
        jsonObject.add(IntentKey.ACTIVITY.ACTION_KEY, jsonArray);
        return jsonObject;
    }
    ...
    private JsonObject toJson(KeyData keyData) {
        ...
        jsonObject.addProperty(AccountConstantKt.RESPONSE_VALUE, Base64.encode(keyData.getValue().toByteArray()));
    ...
    private JsonObject toJson(KeysetInfo.KeyInfo keyInfo) {
        ...
        jsonObject.addProperty("keyId", (Number) Integer.valueOf(keyInfo.getKeyId()));
