...
final class ManifestSchemaFactory implements SchemaFactory {
    ...
    private static MessageInfoFactory getDescriptorMessageInfoFactory() {
        Class<DescriptorMessageInfoFactory> cls = DescriptorMessageInfoFactory.class;
        try {
            int i = DescriptorMessageInfoFactory.f9703a;
            return (MessageInfoFactory) cls.getDeclaredMethod("getInstance", (Class[]) null).invoke((Object) null, (Object[]) null);
