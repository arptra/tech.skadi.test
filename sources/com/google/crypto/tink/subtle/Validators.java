...
public final class Validators {
    ...
    public static void validateRsaModulusSize(int i) throws GeneralSecurityException {
        ...
        } else if (TinkFips.useOnlyFips() && i != 3072) {
            throw new GeneralSecurityException(String.format("Modulus size is %d; only modulus size 3072-bit is supported in FIPS mode", new Object[]{Integer.valueOf(i)}));
        }
    }
