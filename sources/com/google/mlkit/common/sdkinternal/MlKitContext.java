...
public class MlKitContext {
    ...
    public static MlKitContext initialize(@NonNull Context context, @NonNull List<ComponentRegistrar> list) {
        ...
        synchronized (zza) {
            try {
                ...
                ComponentRuntime componentRuntime = new ComponentRuntime(TaskExecutors.MAIN_THREAD, (Iterable<ComponentRegistrar>) new ArrayList(hashMap.values()), (Component<?>[]) new Component[]{Component.of(zzc2, Context.class, new Class[0]), Component.of(mlKitContext2, MlKitContext.class, new Class[0])});
    ...
    public static MlKitContext zzb(@NonNull Context context, @NonNull Executor executor) {
        ...
        synchronized (zza) {
            ...
            zzb = mlKitContext2;
            Context zzc2 = zzc(context);
            ComponentRuntime build = ComponentRuntime.builder(executor).addLazyComponentRegistrars(ComponentDiscovery.forContext(zzc2, MlKitComponentDiscoveryService.class).discoverLazy()).addComponent(Component.of(zzc2, Context.class, new Class[0])).addComponent(Component.of(mlKitContext2, MlKitContext.class, new Class[0])).build();
