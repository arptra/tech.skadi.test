...
public class ModelLoader {
    ...
    private final String zza() {
        ...
        return String.format("Local model path: %s. Remote model name: %s. ", new Object[]{str, remoteModelLoader2 == null ? "unspecified" : remoteModelLoader2.getRemoteModel().getUniqueModelNameForPersist()});
    }
