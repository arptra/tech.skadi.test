...
public class SharedPrefManager {
    @NonNull
    @KeepForSdk
    public static final Component<?> COMPONENT = Component.builder(SharedPrefManager.class).add(Dependency.required(MlKitContext.class)).add(Dependency.required(Context.class)).factory(new zzs()).build();
    @NonNull
    @KeepForSdk
    ...
    public synchronized void clearDownloadingModelInfo(@NonNull RemoteModel remoteModel) {
        zza().edit().remove(String.format("downloading_model_id_%s", new Object[]{remoteModel.getUniqueModelNameForPersist()})).remove(String.format("downloading_model_hash_%s", new Object[]{remoteModel.getUniqueModelNameForPersist()})).remove(String.format("downloading_model_type_%s", new Object[]{getDownloadingModelHash(remoteModel)})).remove(String.format("downloading_begin_time_%s", new Object[]{remoteModel.getUniqueModelNameForPersist()})).remove(String.format("model_first_use_time_%s", new Object[]{remoteModel.getUniqueModelNameForPersist()})).apply();
    }
