...
public class ModelUtils {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:7:0x002b, code lost:
        if (new java.io.File(r5).exists() == false) goto L_0x002d;
     */
    @com.google.android.gms.common.annotation.KeepForSdk
    @androidx.annotation.Nullable
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static com.google.mlkit.common.internal.model.ModelUtils.AutoMLManifest parseManifestFile(@androidx.annotation.NonNull java.lang.String r5, boolean r6, @androidx.annotation.NonNull android.content.Context r7) {
        /*
            ...
            r0 = 0
            if (r6 == 0) goto L_0x0022
            android.content.res.AssetManager r3 = r7.getAssets()     // Catch:{ IOException -> 0x002d }
            java.io.InputStream r3 = r3.open(r5)     // Catch:{ IOException -> 0x002d }
        ...
        L_0x002d:
            ...
            return r0
        L_0x0035:
            boolean r3 = r5.isEmpty()     // Catch:{ IOException | JSONException -> 0x003f }
            r4 = 0
            if (r3 == 0) goto L_0x0041
            byte[] r5 = new byte[r4]     // Catch:{ IOException | JSONException -> 0x003f }
            goto L_0x0064
        L_0x003f:
            r5 = move-exception
            goto L_0x00a8
        L_0x0041:
            ...
            android.content.res.AssetManager r6 = r7.getAssets()     // Catch:{ IOException | JSONException -> 0x003f }
            java.io.InputStream r5 = r6.open(r5)     // Catch:{ IOException | JSONException -> 0x003f }
            goto L_0x0057
        L_0x004c:
            java.io.FileInputStream r6 = new java.io.FileInputStream     // Catch:{ IOException | JSONException -> 0x003f }
            java.io.File r7 = new java.io.File     // Catch:{ IOException | JSONException -> 0x003f }
            r7.<init>(r5)     // Catch:{ IOException | JSONException -> 0x003f }
            r6.<init>(r7)     // Catch:{ IOException | JSONException -> 0x003f }
            r5 = r6
        L_0x0057:
            int r6 = r5.available()     // Catch:{ all -> 0x009c }
            byte[] r7 = new byte[r6]     // Catch:{ all -> 0x009c }
            r5.read(r7, r4, r6)     // Catch:{ all -> 0x009c }
            r5.close()     // Catch:{ IOException | JSONException -> 0x003f }
            r5 = r7
        L_0x0064:
            java.lang.String r6 = new java.lang.String     // Catch:{ IOException | JSONException -> 0x003f }
            java.lang.String r7 = "UTF-8"
            r6.<init>(r5, r7)     // Catch:{ IOException | JSONException -> 0x003f }
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ IOException | JSONException -> 0x003f }
            r5.<init>()     // Catch:{ IOException | JSONException -> 0x003f }
            java.lang.String r7 = "Json string from the manifest file: "
            r5.append(r7)     // Catch:{ IOException | JSONException -> 0x003f }
            r5.append(r6)     // Catch:{ IOException | JSONException -> 0x003f }
            java.lang.String r5 = r5.toString()     // Catch:{ IOException | JSONException -> 0x003f }
            r1.d(r2, r5)     // Catch:{ IOException | JSONException -> 0x003f }
            org.json.JSONObject r5 = new org.json.JSONObject     // Catch:{ IOException | JSONException -> 0x003f }
            r5.<init>(r6)     // Catch:{ IOException | JSONException -> 0x003f }
            java.lang.String r6 = "modelType"
            java.lang.String r6 = r5.getString(r6)     // Catch:{ IOException | JSONException -> 0x003f }
            java.lang.String r7 = "modelFile"
            java.lang.String r7 = r5.getString(r7)     // Catch:{ IOException | JSONException -> 0x003f }
            java.lang.String r1 = "labelsFile"
            java.lang.String r5 = r5.getString(r1)     // Catch:{ IOException | JSONException -> 0x003f }
            com.google.mlkit.common.internal.model.AutoValue_ModelUtils_AutoMLManifest r1 = new com.google.mlkit.common.internal.model.AutoValue_ModelUtils_AutoMLManifest     // Catch:{ IOException | JSONException -> 0x003f }
            r1.<init>(r6, r7, r5)     // Catch:{ IOException | JSONException -> 0x003f }
            return r1
        L_0x009c:
            r6 = move-exception
        ...
        L_0x00a3:
            r5 = move-exception
            r6.addSuppressed(r5)     // Catch:{ IOException | JSONException -> 0x003f }
        L_0x00a7:
            throw r6     // Catch:{ IOException | JSONException -> 0x003f }
        L_0x00a8:
