...
public final class Enum extends GeneratedMessageV3 implements EnumOrBuilder {
    ...
    public static /* synthetic */ int access$976(Enum enumR, int i) {
        int i2 = i | enumR.bitField0_;
        enumR.bitField0_ = i2;
        return i2;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getName().equals(enumR.getName()) && getEnumvalueList().equals(enumR.getEnumvalueList()) && getOptionsList().equals(enumR.getOptionsList()) && hasSourceContext() == enumR.hasSourceContext()) {
            return (!hasSourceContext() || getSourceContext().equals(enumR.getSourceContext())) && this.syntax_ == enumR.syntax_ && getEdition().equals(enumR.getEdition()) && getUnknownFields().equals(enumR.getUnknownFields());
        }
        return false;
    }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements EnumOrBuilder {
        ...
        private void buildPartial0(Enum enumR) {
            int i;
            ...
            if ((i2 & 8) != 0) {
                ...
                SourceContext unused2 = enumR.sourceContext_ = singleFieldBuilderV3 == null ? this.sourceContext_ : singleFieldBuilderV3.build();
                i = 1;
            } else {
                i = 0;
            }
            if ((i2 & 16) != 0) {
                int unused3 = enumR.syntax_ = this.syntax_;
            }
            if ((i2 & 32) != 0) {
                Object unused4 = enumR.edition_ = this.edition_;
            }
            Enum.access$976(enumR, i);
        }

        private void buildPartialRepeatedFields(Enum enumR) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ...
                List unused = enumR.enumvalue_ = this.enumvalue_;
            } else {
                List unused2 = enumR.enumvalue_ = repeatedFieldBuilderV3.build();
            }
            ...
            if (repeatedFieldBuilderV32 == null) {
                ...
                List unused3 = enumR.options_ = this.options_;
                return;
            }
            List unused4 = enumR.options_ = repeatedFieldBuilderV32.build();
        }
        ...
        public Enum buildPartial() {
            ...
            buildPartialRepeatedFields(enumR);
        ...
        public Builder mergeFrom(Enum enumR) {
            ...
            if (!enumR.getEdition().isEmpty()) {
                this.edition_ = enumR.edition_;
                this.bitField0_ |= 32;
                onChanged();
            }
            mergeUnknownFields(enumR.getUnknownFields());
            onChanged();
            return this;
        }
