...
public final class Api extends GeneratedMessageV3 implements ApiOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements ApiOrBuilder {
        ...
        private void buildPartial0(Api api) {
            ...
            if ((i2 & 8) != 0) {
                Object unused2 = api.version_ = this.version_;
            }
            if ((i2 & 16) != 0) {
                ...
                SourceContext unused3 = api.sourceContext_ = singleFieldBuilderV3 == null ? this.sourceContext_ : singleFieldBuilderV3.build();
                i = 1;
            } else {
                i = 0;
            }
            if ((i2 & 64) != 0) {
                int unused4 = api.syntax_ = this.syntax_;
            }
        ...
        private void buildPartialRepeatedFields(Api api) {
            ...
            if (repeatedFieldBuilderV3 == null) {
                ...
                List unused = api.methods_ = this.methods_;
            } else {
                List unused2 = api.methods_ = repeatedFieldBuilderV3.build();
            }
            ...
            if (repeatedFieldBuilderV32 == null) {
                ...
                List unused3 = api.options_ = this.options_;
            } else {
                List unused4 = api.options_ = repeatedFieldBuilderV32.build();
            }
            ...
            if (repeatedFieldBuilderV33 == null) {
                ...
                List unused5 = api.mixins_ = this.mixins_;
                return;
            }
            List unused6 = api.mixins_ = repeatedFieldBuilderV33.build();
        }
