...
public final class WrappersProto {
    ...
    static {
        ...
        internal_static_google_protobuf_DoubleValue_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{BleConstants.EXTRA_MESSAGE2});
        Descriptors.Descriptor descriptor3 = getDescriptor().getMessageTypes().get(1);
        internal_static_google_protobuf_FloatValue_descriptor = descriptor3;
        internal_static_google_protobuf_FloatValue_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor3, new String[]{BleConstants.EXTRA_MESSAGE2});
        Descriptors.Descriptor descriptor4 = getDescriptor().getMessageTypes().get(2);
        internal_static_google_protobuf_Int64Value_descriptor = descriptor4;
        internal_static_google_protobuf_Int64Value_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor4, new String[]{BleConstants.EXTRA_MESSAGE2});
        Descriptors.Descriptor descriptor5 = getDescriptor().getMessageTypes().get(3);
        internal_static_google_protobuf_UInt64Value_descriptor = descriptor5;
        internal_static_google_protobuf_UInt64Value_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor5, new String[]{BleConstants.EXTRA_MESSAGE2});
        Descriptors.Descriptor descriptor6 = getDescriptor().getMessageTypes().get(4);
        internal_static_google_protobuf_Int32Value_descriptor = descriptor6;
        internal_static_google_protobuf_Int32Value_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor6, new String[]{BleConstants.EXTRA_MESSAGE2});
        Descriptors.Descriptor descriptor7 = getDescriptor().getMessageTypes().get(5);
        internal_static_google_protobuf_UInt32Value_descriptor = descriptor7;
        internal_static_google_protobuf_UInt32Value_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor7, new String[]{BleConstants.EXTRA_MESSAGE2});
        Descriptors.Descriptor descriptor8 = getDescriptor().getMessageTypes().get(6);
        internal_static_google_protobuf_BoolValue_descriptor = descriptor8;
        internal_static_google_protobuf_BoolValue_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor8, new String[]{BleConstants.EXTRA_MESSAGE2});
        Descriptors.Descriptor descriptor9 = getDescriptor().getMessageTypes().get(7);
        internal_static_google_protobuf_StringValue_descriptor = descriptor9;
        internal_static_google_protobuf_StringValue_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor9, new String[]{BleConstants.EXTRA_MESSAGE2});
        Descriptors.Descriptor descriptor10 = getDescriptor().getMessageTypes().get(8);
        internal_static_google_protobuf_BytesValue_descriptor = descriptor10;
        internal_static_google_protobuf_BytesValue_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor10, new String[]{BleConstants.EXTRA_MESSAGE2});
    }
