...
public class AsYouTypeFormatter {
    ...
    private void getAvailableFormats(String str) {
        for (Phonemetadata.NumberFormat next : (!this.isCompleteNumber || this.extractedNationalPrefix.length() != 0 || this.currentMetadata.getIntlNumberFormatCount() <= 0) ? this.currentMetadata.getNumberFormatList() : this.currentMetadata.getIntlNumberFormatList()) {
