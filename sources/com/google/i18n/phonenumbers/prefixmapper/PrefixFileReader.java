...
public class PrefixFileReader {
    ...
    private void loadMappingFileProvider() {
        MetadataLoader metadataLoader2 = this.metadataLoader;
        InputStream loadMetadata = metadataLoader2.loadMetadata(this.phonePrefixDataDirectory + "config");
        ObjectInputStream objectInputStream = null;
        try {
            ObjectInputStream objectInputStream2 = new ObjectInputStream(loadMetadata);
            try {
    ...
    private void loadPhonePrefixMapFromFile(String str) {
        MetadataLoader metadataLoader2 = this.metadataLoader;
        InputStream loadMetadata = metadataLoader2.loadMetadata(this.phonePrefixDataDirectory + str);
        ObjectInputStream objectInputStream = null;
        try {
            ObjectInputStream objectInputStream2 = new ObjectInputStream(loadMetadata);
            try {
