...
public class CountryCodeToRegionCodeMap {
    public static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList39.add(Constants.CHINA_COUNTRY);
        ...
        arrayList47.add("SS");
        hashMap.put(Integer.valueOf(TrackerEvent.RadioMapOnDemandOutdoor), arrayList47);
        ...
        arrayList53.add("SN");
        hashMap.put(Integer.valueOf(TrackerEvent.RadioMapManualOutdoor), arrayList53);
        ...
        arrayList72.add("GQ");
        hashMap.put(Integer.valueOf(CircularProgressButton.MorphingAnimation.DURATION_NORMAL), arrayList72);
        ...
        arrayList86.add("KE");
        hashMap.put(Integer.valueOf(DnsRecord.CLASS_NONE), arrayList86);
        ...
        arrayList91.add("ZM");
        hashMap.put(Integer.valueOf(AnimationUtils.ANIMATION_DURATION_TRANSLATION), arrayList91);
        ...
        arrayList134.add("SK");
        hashMap.put(Integer.valueOf(StatusLine.HTTP_MISDIRECTED_REQUEST), arrayList134);
        ...
        arrayList137.add("BZ");
        hashMap.put(Integer.valueOf(OpenRemoteStarryNetAppCode.CODE_NO_DEVICE), arrayList137);
        ArrayList arrayList138 = new ArrayList(1);
        arrayList138.add("GT");
        hashMap.put(Integer.valueOf(OpenRemoteStarryNetAppCode.CODE_STARRY_SDK_NOT_AVAILABLE), arrayList138);
        ArrayList arrayList139 = new ArrayList(1);
        arrayList139.add("SV");
        hashMap.put(Integer.valueOf(OpenRemoteStarryNetAppCode.CODE_PULL_MAIN_APP_FAIL), arrayList139);
        ArrayList arrayList140 = new ArrayList(1);
        arrayList140.add("HN");
        hashMap.put(Integer.valueOf(OpenRemoteStarryNetAppCode.CODE_SEND_MESSAGE_FAIL), arrayList140);
        ...
        hashMap.put(Integer.valueOf(Constants.ANIMATION_DURATION), arrayList177);
        ...
        arrayList190.add(Constants.TW_COUNTRY);
        ...
        arrayList192.add("MV");
        hashMap.put(Integer.valueOf(OdnpConfigStatic.UPLOAD_MEDIUM_PRIORITY_DURATION_MINUTES), arrayList192);
