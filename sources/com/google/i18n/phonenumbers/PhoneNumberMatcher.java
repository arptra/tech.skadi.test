...
final class PhoneNumberMatcher implements Iterator<PhoneNumberMatch> {
    ...
    public PhoneNumberMatcher(PhoneNumberUtil phoneNumberUtil, String str, String str2, PhoneNumberUtil.Leniency leniency2, long j) {
    ...
    private static String limit(int i, int i2) {
        ...
        return "{" + i + MzContactsContract.MzGroups.GROUP_SPLIT_MARK_EXTRA + i2 + "}";
    }
    ...
    private static String[] getNationalNumberGroups(PhoneNumberUtil phoneNumberUtil, Phonenumber.PhoneNumber phoneNumber, Phonemetadata.NumberFormat numberFormat) {
        return phoneNumberUtil.formatNsnUsingPattern(phoneNumberUtil.getNationalSignificantNumber(phoneNumber), numberFormat, PhoneNumberUtil.PhoneNumberFormat.RFC3966).split(LunarCalendar.DATE_SEPARATOR);
    }
}
