...
class EventBus implements Subscriber, Publisher {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0010, code lost:
        r2 = getHandlers(r3).iterator();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x001c, code lost:
        if (r2.hasNext() == false) goto L_0x0032;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x001e, code lost:
        r0 = r2.next();
        ((java.util.concurrent.Executor) r0.getValue()).execute(com.google.firebase.components.EventBus$$Lambda$1.lambdaFactory$(r0, r3));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0032, code lost:
        return;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void publish(com.google.firebase.events.Event<?> r3) {
        /*
            r2 = this;
            com.google.firebase.components.Preconditions.checkNotNull(r3)
            monitor-enter(r2)
            java.util.Queue<com.google.firebase.events.Event<?>> r0 = r2.pendingEvents     // Catch:{ all -> 0x000d }
            if (r0 == 0) goto L_0x000f
            r0.add(r3)     // Catch:{ all -> 0x000d }
        ...
        L_0x000f:
            monitor-exit(r2)     // Catch:{ all -> 0x000d }
            java.util.Set r2 = r2.getHandlers(r3)
        ...
        L_0x0018:
            ...
            java.lang.Runnable r0 = com.google.firebase.components.EventBus$$Lambda$1.lambdaFactory$(r0, r3)
            r1.execute(r0)
            goto L_0x0018
        L_0x0032:
            return
