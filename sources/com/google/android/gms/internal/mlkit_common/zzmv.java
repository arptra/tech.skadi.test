...
public enum zzmv implements zzba {
    ...
    ON_DEVICE_IMAGE_LABEL_LOAD(AdvPackConstants.ADV_MODE_ACTIVE_NO_WINDOW),
    ...
    CLOUD_WEB_SEARCH_CREATE(TrackerEvent.PositioningOfflineOutdoor),
    ...
    ACCELERATION_ANALYTICS(AnimationUtils.ANIMATION_DURATION_TRANSLATION),
    ...
    AGGREGATED_ON_DEVICE_SEGMENTATION(AdvPackConstants.ADV_MODE_REQUEST_CONNECT),
    AGGREGATED_CUSTOM_OBJECT_INFERENCE(209),
    AGGREGATED_CUSTOM_IMAGE_LABEL_DETECTION(210),
    AGGREGATED_ON_DEVICE_EXPLICIT_CONTENT_DETECTION(TrackerEvent.RadioMapOnDemandOutdoor),
    ...
    OPTIONAL_MODULE_LANGUAGE_ID(CmdCode.CODE_WAKEUP_AUDIO_STATE),
    OPTIONAL_MODULE_LANGUAGE_ID_CREATE(CmdCode.CODE_WAKEUP_AUDIO),
    ...
    ON_DEVICE_EXPLICIT_CONTENT_CREATE(OpenRemoteStarryNetAppCode.CODE_NO_DEVICE),
    ON_DEVICE_EXPLICIT_CONTENT_LOAD(OpenRemoteStarryNetAppCode.CODE_STARRY_SDK_NOT_AVAILABLE),
    ON_DEVICE_EXPLICIT_CONTENT_DETECT(OpenRemoteStarryNetAppCode.CODE_PULL_MAIN_APP_FAIL),
    ON_DEVICE_EXPLICIT_CONTENT_CLOSE(OpenRemoteStarryNetAppCode.CODE_SEND_MESSAGE_FAIL),
    ...
    ON_DEVICE_IMAGE_QUALITY_ANALYSIS_CLOSE(Utils.PULSE_ANIMATOR_DURATION),
    ...
    ON_DEVICE_IMAGE_CAPTIONING_CREATE(OpenRemoteStarryNetAppCode.CODE_STARRY_NET_APP_ID_ERROR),
    ON_DEVICE_IMAGE_CAPTIONING_LOAD(OpenRemoteStarryNetAppCode.CODE_NO_STARRY_NET_APP_ID_ERROR),
