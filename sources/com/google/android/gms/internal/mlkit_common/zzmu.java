...
public enum zzmu implements zzba {
    ...
    CODE_SCANNER_UNAVAILABLE(CmdCode.CODE_WAKEUP_RECORDING),
    CODE_SCANNER_CANCELLED(CmdCode.CODE_WAKEUP_AUDIO_STATE),
    CODE_SCANNER_CAMERA_PERMISSION_NOT_GRANTED(CmdCode.CODE_WAKEUP_AUDIO),
    ...
    LOW_LIGHT_IMAGE_CAPTURE_PROCESSING_FAILURE(OpenRemoteStarryNetAppCode.CODE_NO_DEVICE),
    PERMISSION_DENIED(600),
    CANCELLED(OpenRemoteStarryNetAppCode.CODE_STARRY_NET_APP_ID_ERROR),
    GOOGLE_PLAY_SERVICES_VERSION_TOO_OLD(OpenRemoteStarryNetAppCode.CODE_NO_STARRY_NET_APP_ID_ERROR),
    LOW_MEMORY(603),
    UNKNOWN_ERROR(9999);
