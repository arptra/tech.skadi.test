...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    public static zzd zzc(FragmentActivity fragmentActivity) {
        ...
        try {
            zzd zzd3 = (zzd) fragmentActivity.getSupportFragmentManager().p0("SupportLifecycleFragmentImpl");
            if (zzd3 == null || zzd3.isRemoving()) {
                zzd3 = new zzd();
                fragmentActivity.getSupportFragmentManager().s().e(zzd3, "SupportLifecycleFragmentImpl").k();
            }
