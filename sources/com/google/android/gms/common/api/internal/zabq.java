...
public final class zabq implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    public final void zaI(int i) {
        ...
        googleApiManager2.zar.sendMessageDelayed(Message.obtain(googleApiManager2.zar, 11, apiKey2), OdnpConfigStatic.OEM_MAX_HIGH_POWER_INTERVAL);
        this.zaa.zak.zac();
    ...
    private final boolean zaM(zai zai2) {
        ...
        googleApiManager3.zar.sendMessageDelayed(Message.obtain(googleApiManager3.zar, 16, zabs), OdnpConfigStatic.OEM_MAX_HIGH_POWER_INTERVAL);
