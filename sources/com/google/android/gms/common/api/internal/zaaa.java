...
final class zaaa implements zaca {
    ...
    private final PendingIntent zaz() {
        ...
        return PendingIntent.getActivity(this.zaa, System.identityHashCode(this.zab), client.getSignInIntent(), zap.zaa | CaptureType.CAPTURE_VIRTUAL_DISPLAY_ENABLE_MAGIC_WINDOW);
    }
    ...
    public final void zas(String str, @Nullable FileDescriptor fileDescriptor, PrintWriter printWriter, @Nullable String[] strArr) {
        printWriter.append(str).append("authClient").println(AccountConstantKt.CODE_SEPARTOR);
        this.zae.zas(String.valueOf(str).concat(FastRecordHistoryDetailActivity.TAG_SPLIT), fileDescriptor, printWriter, strArr);
        printWriter.append(str).append("anonClient").println(AccountConstantKt.CODE_SEPARTOR);
        this.zad.zas(String.valueOf(str).concat(FastRecordHistoryDetailActivity.TAG_SPLIT), fileDescriptor, printWriter, strArr);
    }
