...
public final class zay extends GoogleApi implements ModuleInstallClient {
    ...
    public final Task<ModuleInstallResponse> installModules(ModuleInstallRequest moduleInstallRequest) {
        ...
        ListenerHolder registerListener = listenerExecutor == null ? registerListener(listener, cls.getSimpleName()) : ListenerHolders.createListenerHolder(listener, listenerExecutor, cls.getSimpleName());
