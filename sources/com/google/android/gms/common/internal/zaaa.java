...
public final class zaaa extends Button {
    ...
    public final void zaa(Resources resources, int i, int i2) {
        ...
        Drawable r = DrawableCompat.r(resources.getDrawable(zab));
        DrawableCompat.o(r, resources.getColorStateList(R.color.common_google_signin_btn_tint));
        DrawableCompat.p(r, PorterDuff.Mode.SRC_ATOP);
