...
public class DynamicColors {
    ...
    static {
        ...
        hashMap.put("lge", r0);
        hashMap.put(MDevice.MANUFACTURERS_MEIZU, r0);
        hashMap.put("motorola", r0);
        hashMap.put("nothing", r0);
        hashMap.put("oneplus", r0);
        hashMap.put(MDevice.MANUFACTURERS_OPPO, r0);
        ...
        hashMap.put(MDevice.MANUFACTURERS_VIVO, r0);
        hashMap.put("wingtech", r0);
        hashMap.put(MDevice.MANUFACTURERS_XIAOMI, r0);
