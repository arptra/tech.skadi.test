...
import com.honey.account.i1.a;
import com.honey.account.i1.b;
...
public final class DynamicColor {
    ...
    public DynamicColor(@NonNull String str, @NonNull Function<DynamicScheme, TonalPalette> function, @NonNull Function<DynamicScheme, Double> function2, boolean z, @Nullable Function<DynamicScheme, DynamicColor> function3, @Nullable Function<DynamicScheme, DynamicColor> function4, @Nullable ContrastCurve contrastCurve2, @Nullable Function<DynamicScheme, ToneDeltaPair> function5) {
        this.name = str;
    ...
    public static DynamicColor fromArgb(@NonNull String str, int i) {
        return fromPalette(str, new a(TonalPalette.fromInt(i)), new b(Hct.fromInt(i)));
    }
    ...
    public DynamicColor(@NonNull String str, @NonNull Function<DynamicScheme, TonalPalette> function, @NonNull Function<DynamicScheme, Double> function2, boolean z, @Nullable Function<DynamicScheme, DynamicColor> function3, @Nullable Function<DynamicScheme, DynamicColor> function4, @Nullable ContrastCurve contrastCurve2, @Nullable Function<DynamicScheme, ToneDeltaPair> function5, @Nullable Function<DynamicScheme, Double> function6) {
        this.name = str;
        this.palette = function;
        this.tone = function2;
        this.isBackground = z;
