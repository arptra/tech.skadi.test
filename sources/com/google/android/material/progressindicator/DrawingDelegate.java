...
abstract class DrawingDelegate<S extends BaseProgressIndicatorSpec> {
    ...
    public abstract void adjustCanvas(@NonNull Canvas canvas, @NonNull Rect rect, @FloatRange float f);
    ...
    public void validateSpecAndAdjustCanvas(@NonNull Canvas canvas, @NonNull Rect rect, @FloatRange float f) {
