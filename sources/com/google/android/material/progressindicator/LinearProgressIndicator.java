...
public class LinearProgressIndicator extends BaseProgressIndicator<LinearProgressIndicatorSpec> {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        boolean z2 = true;
        if (!(((LinearProgressIndicatorSpec) s).indicatorDirection == 1 || ((ViewCompat.z(this) == 1 && ((LinearProgressIndicatorSpec) this.spec).indicatorDirection == 2) || (ViewCompat.z(this) == 0 && ((LinearProgressIndicatorSpec) this.spec).indicatorDirection == 3)))) {
            z2 = false;
        }
    ...
    public void setIndicatorDirection(int i) {
        ...
        LinearProgressIndicatorSpec linearProgressIndicatorSpec = (LinearProgressIndicatorSpec) s;
        boolean z = true;
        if (!(i == 1 || ((ViewCompat.z(this) == 1 && ((LinearProgressIndicatorSpec) this.spec).indicatorDirection == 2) || (ViewCompat.z(this) == 0 && i == 3)))) {
            z = false;
        }
