...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    private void adjustChildMarginsAndUpdateLayout() {
        ...
        if (firstVisibleChildIndex != -1) {
            for (int i = firstVisibleChildIndex + 1; i < getChildCount(); i++) {
                ...
                if (getOrientation() == 0) {
                    MarginLayoutParamsCompat.c(buildLayoutParams, 0);
                    MarginLayoutParamsCompat.d(buildLayoutParams, -min);
                    buildLayoutParams.topMargin = 0;
                } else {
                    buildLayoutParams.bottomMargin = 0;
                    buildLayoutParams.topMargin = -min;
                    MarginLayoutParamsCompat.d(buildLayoutParams, 0);
                }
    ...
    private void setGeneratedIdIfNeeded(@NonNull MaterialButton materialButton) {
        if (materialButton.getId() == -1) {
            materialButton.setId(ViewCompat.j());
        }
    }
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        ViewCompat.u0(materialButton, new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View view, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                accessibilityNodeInfoCompat.k0(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.a(0, 1, MaterialButtonToggleGroup.this.getIndexWithinVisibleButtons(view), 1, false, ((MaterialButton) view).isChecked()));
            }
        });
    }
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        AccessibilityNodeInfoCompat.P0(accessibilityNodeInfo).j0(AccessibilityNodeInfoCompat.CollectionInfoCompat.b(1, getVisibleButtonCount(), false, isSingleSelection() ? 1 : 2));
    }
    ...
    public MaterialButtonToggleGroup(@androidx.annotation.NonNull android.content.Context r7, @androidx.annotation.Nullable android.util.AttributeSet r8, int r9) {
        /*
            ...
            r6.setEnabled(r9)
            r8.recycle()
            androidx.core.view.ViewCompat.G0(r6, r7)
            return
        */
