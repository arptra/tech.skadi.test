...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    private void resetIconDrawable() {
        if (isIconStart()) {
            TextViewCompat.i(this, this.icon, (Drawable) null, (Drawable) null, (Drawable) null);
        } else if (isIconEnd()) {
            TextViewCompat.i(this, (Drawable) null, (Drawable) null, this.icon, (Drawable) null);
        } else if (isIconTop()) {
            TextViewCompat.i(this, (Drawable) null, this.icon, (Drawable) null, (Drawable) null);
        }
    }
    ...
    private void updateIconPosition(int i, int i2) {
        if (this.icon != null && getLayout() != null) {
            if (isIconStart() || isIconEnd()) {
                ...
                int textLayoutWidth = ((((i - getTextLayoutWidth()) - ViewCompat.E(this)) - i4) - this.iconPadding) - ViewCompat.F(this);
