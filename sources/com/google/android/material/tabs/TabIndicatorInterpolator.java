...
class TabIndicatorInterpolator {
    ...
    public static RectF calculateTabViewContentBounds(@NonNull TabLayout.TabView tabView, @Dimension int i) {
    ...
    public void updateIndicatorForOffset(TabLayout tabLayout, View view, View view2, @FloatRange float f, @NonNull Drawable drawable) {
        RectF calculateIndicatorWidthForTab = calculateIndicatorWidthForTab(tabLayout, view);
