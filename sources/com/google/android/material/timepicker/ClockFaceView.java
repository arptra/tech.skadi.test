...
class ClockFaceView extends RadialViewGroup implements ClockHandView.OnRotateListener {
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        AccessibilityNodeInfoCompat.P0(accessibilityNodeInfo).j0(AccessibilityNodeInfoCompat.CollectionInfoCompat.b(1, this.values.length, false, 1));
    }
    ...
    public ClockFaceView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.valueAccessibilityDelegate = new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View view, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (intValue > 0) {
                    accessibilityNodeInfoCompat.M0((View) ClockFaceView.this.textViewPool.get(intValue - 1));
                }
