...
final class IndicatorViewController {
    ...
    public IndicatorViewController(@NonNull TextInputLayout textInputLayout) {
        ...
        this.captionFadeOutAnimationDuration = MotionUtils.resolveThemeDuration(context2, R.attr.motionDurationShort4, 167);
        ...
        this.captionFadeInAnimationInterpolator = MotionUtils.resolveThemeInterpolator(context2, i, timeInterpolator);
    ...
    private ObjectAnimator createCaptionOpacityAnimator(TextView textView, boolean z) {
        ...
        ofFloat.setDuration((long) (z ? this.captionFadeInAnimationDuration : this.captionFadeOutAnimationDuration));
    ...
    private boolean shouldAnimateCaptionView(@Nullable TextView textView, @NonNull CharSequence charSequence) {
        return ViewCompat.W(this.textInputView) && this.textInputView.isEnabled() && (this.captionToShow != this.captionDisplayed || textView == null || !TextUtils.equals(textView.getText(), charSequence));
    }
    ...
    public void adjustIndicatorPadding() {
        if (canAdjustIndicatorPadding()) {
            ...
            ViewCompat.N0(this.indicatorArea, getIndicatorPadding(isFontScaleAtLeast1_3, R.dimen.material_helper_text_font_1_3_padding_horizontal, ViewCompat.F(editText)), getIndicatorPadding(isFontScaleAtLeast1_3, R.dimen.material_helper_text_font_1_3_padding_top, this.context.getResources().getDimensionPixelSize(R.dimen.material_helper_text_default_padding_top)), getIndicatorPadding(isFontScaleAtLeast1_3, R.dimen.material_helper_text_font_1_3_padding_horizontal, ViewCompat.E(editText)), 0);
        }
    }
