...
class EndCompoundLayout extends LinearLayout {
    ...
    public static class EndIconDelegates {
        ...
        public EndIconDelegates(EndCompoundLayout endCompoundLayout, TintTypedArray tintTypedArray) {
            ...
            this.customEndIconDrawableId = tintTypedArray.n(R.styleable.TextInputLayout_endIconDrawable, 0);
            this.passwordIconDrawableId = tintTypedArray.n(R.styleable.TextInputLayout_passwordToggleDrawable, 0);
        }
    ...
    public void addTouchExplorationStateChangeListenerIfNeeded() {
        if (this.touchExplorationStateChangeListener != null && this.accessibilityManager != null && ViewCompat.V(this)) {
    ...
    private void initEndIconView(TintTypedArray tintTypedArray) {
        if (!tintTypedArray.s(R.styleable.TextInputLayout_passwordToggleEnabled)) {
            ...
            if (tintTypedArray.s(R.styleable.TextInputLayout_endIconTintMode)) {
                this.endIconTintMode = ViewUtils.parseTintMode(tintTypedArray.k(R.styleable.TextInputLayout_endIconTintMode, -1), (PorterDuff.Mode) null);
            }
        }
        if (tintTypedArray.s(R.styleable.TextInputLayout_endIconMode)) {
            setEndIconMode(tintTypedArray.k(R.styleable.TextInputLayout_endIconMode, 0));
            if (tintTypedArray.s(R.styleable.TextInputLayout_endIconContentDescription)) {
                setEndIconContentDescription(tintTypedArray.p(R.styleable.TextInputLayout_endIconContentDescription));
            }
            ...
            if (tintTypedArray.s(R.styleable.TextInputLayout_passwordToggleTintMode)) {
                this.endIconTintMode = ViewUtils.parseTintMode(tintTypedArray.k(R.styleable.TextInputLayout_passwordToggleTintMode, -1), (PorterDuff.Mode) null);
            }
            setEndIconMode(tintTypedArray.a(R.styleable.TextInputLayout_passwordToggleEnabled, false) ? 1 : 0);
            setEndIconContentDescription(tintTypedArray.p(R.styleable.TextInputLayout_passwordToggleContentDescription));
        }
        setEndIconMinSize(tintTypedArray.f(R.styleable.TextInputLayout_endIconMinSize, getResources().getDimensionPixelSize(R.dimen.mtrl_min_touch_target_size)));
        if (tintTypedArray.s(R.styleable.TextInputLayout_endIconScaleType)) {
            setEndIconScaleType(IconHelper.convertScaleType(tintTypedArray.k(R.styleable.TextInputLayout_endIconScaleType, -1)));
        }
    }
    ...
    private void initErrorIconView(TintTypedArray tintTypedArray) {
        ...
        if (tintTypedArray.s(R.styleable.TextInputLayout_errorIconTintMode)) {
            this.errorIconTintMode = ViewUtils.parseTintMode(tintTypedArray.k(R.styleable.TextInputLayout_errorIconTintMode, -1), (PorterDuff.Mode) null);
        }
        if (tintTypedArray.s(R.styleable.TextInputLayout_errorIconDrawable)) {
            setErrorIconDrawable(tintTypedArray.g(R.styleable.TextInputLayout_errorIconDrawable));
        }
        this.errorIconView.setContentDescription(getResources().getText(R.string.error_icon_content_description));
        ViewCompat.G0(this.errorIconView, 2);
    ...
    private void initSuffixTextView(TintTypedArray tintTypedArray) {
        ...
        setSuffixTextAppearance(tintTypedArray.n(R.styleable.TextInputLayout_suffixTextAppearance, 0));
        if (tintTypedArray.s(R.styleable.TextInputLayout_suffixTextColor)) {
            setSuffixTextColor(tintTypedArray.c(R.styleable.TextInputLayout_suffixTextColor));
        }
        setSuffixText(tintTypedArray.p(R.styleable.TextInputLayout_suffixText));
    }
    ...
    public void removeTouchExplorationStateChangeListenerIfNeeded() {
        ...
        if (touchExplorationStateChangeListener2 != null && (accessibilityManager2 = this.accessibilityManager) != null) {
            AccessibilityManagerCompat.b(accessibilityManager2, touchExplorationStateChangeListener2);
        }
    }
    ...
    public int getSuffixTextEndOffset() {
        return ViewCompat.E(this) + ViewCompat.E(this.suffixTextView) + ((isEndIconVisible() || isErrorIconVisible()) ? this.endIconView.getMeasuredWidth() + MarginLayoutParamsCompat.b((ViewGroup.MarginLayoutParams) this.endIconView.getLayoutParams()) : 0);
    }
    ...
    public void setSuffixTextAppearance(@StyleRes int i) {
        TextViewCompat.n(this.suffixTextView, i);
    }
    ...
    public void updateSuffixTextViewPadding() {
        if (this.textInputLayout.editText != null) {
            ViewCompat.N0(this.suffixTextView, getContext().getResources().getDimensionPixelSize(R.dimen.material_input_text_to_prefix_suffix_padding), this.textInputLayout.editText.getPaddingTop(), (isEndIconVisible() || isErrorIconVisible()) ? 0 : ViewCompat.E(this.textInputLayout.editText), this.textInputLayout.editText.getPaddingBottom());
        }
    }
