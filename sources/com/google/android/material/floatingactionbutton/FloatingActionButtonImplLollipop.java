...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    public BorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        BorderDrawable borderDrawable = new BorderDrawable((ShapeAppearanceModel) Preconditions.h(this.shapeAppearance));
    ...
    public MaterialShapeDrawable createShapeDrawable() {
        return new AlwaysStatefulMaterialShapeDrawable((ShapeAppearanceModel) Preconditions.h(this.shapeAppearance));
    }
    ...
    public void initializeBackgroundDrawable(ColorStateList colorStateList, @Nullable PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        if (i > 0) {
            ...
            drawable = new LayerDrawable(new Drawable[]{(Drawable) Preconditions.h(this.borderDrawable), (Drawable) Preconditions.h(this.shapeDrawable)});
        } else {
