...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    public static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        private void offsetIfNeeded(@NonNull CoordinatorLayout coordinatorLayout, @NonNull FloatingActionButton floatingActionButton) {
            ...
            if (rect != null && rect.centerX() > 0 && rect.centerY() > 0) {
                ...
                if (i != 0) {
                    ViewCompat.e0(floatingActionButton, i);
                }
                if (i2 != 0) {
                    ViewCompat.d0(floatingActionButton, i2);
                }
            }
        }

        private boolean shouldUpdateVisibility(@NonNull View view, @NonNull FloatingActionButton floatingActionButton) {
            return this.autoHideEnabled && ((CoordinatorLayout.LayoutParams) floatingActionButton.getLayoutParams()).e() == view.getId() && floatingActionButton.getUserSetVisibility() == 0;
        }
    ...
    public ShapeAppearanceModel getShapeAppearanceModel() {
        return (ShapeAppearanceModel) Preconditions.h(getImpl().getShapeAppearance());
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.expandableWidgetHelper.onRestoreInstanceState((Bundle) Preconditions.h((Bundle) extendableSavedState.extendableStates.get(EXPANDABLE_WIDGET_HELPER_KEY)));
    }
