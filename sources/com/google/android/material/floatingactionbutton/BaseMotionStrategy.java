...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public final MotionSpec getCurrentMotionSpec() {
        ...
        return (MotionSpec) Preconditions.h(this.defaultMotionSpec);
    }
    ...
    public AnimatorSet createAnimator(@NonNull MotionSpec motionSpec2) {
        ...
        if (motionSpec2.hasPropertyValues(MonthView.VIEW_PARAMS_WIDTH)) {
            arrayList.add(motionSpec2.getAnimator(MonthView.VIEW_PARAMS_WIDTH, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec2.hasPropertyValues(MonthView.VIEW_PARAMS_HEIGHT)) {
            arrayList.add(motionSpec2.getAnimator(MonthView.VIEW_PARAMS_HEIGHT, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
