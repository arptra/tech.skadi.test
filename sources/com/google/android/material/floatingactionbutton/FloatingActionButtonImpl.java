...
class FloatingActionButtonImpl {
    ...
    private boolean shouldAnimateVisibilityChange() {
        return ViewCompat.W(this.view) && !this.view.isInEditMode();
    }
    ...
    public MaterialShapeDrawable createShapeDrawable() {
        return new MaterialShapeDrawable((ShapeAppearanceModel) Preconditions.h(this.shapeAppearance));
    }
    ...
    public void getPadding(@NonNull Rect rect) {
        ...
        float elevation2 = this.shadowPaddingEnabled ? getElevation() + this.pressedTranslationZ : HIDE_OPACITY;
    ...
    public void initializeBackgroundDrawable(ColorStateList colorStateList, @Nullable PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        this.contentBackground = new LayerDrawable(new Drawable[]{(Drawable) Preconditions.h(this.shapeDrawable), rippleDrawableCompat});
    }
    ...
    public void onPaddingUpdated(@NonNull Rect rect) {
        Preconditions.i(this.contentBackground, "Didn't initialize content background");
        if (shouldAddPadding()) {
