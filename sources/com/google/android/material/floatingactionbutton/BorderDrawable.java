...
class BorderDrawable extends Drawable {
    ...
    private Shader createGradientShader() {
        ...
        return new LinearGradient(0.0f, (float) rect2.top, 0.0f, (float) rect2.bottom, new int[]{ColorUtils.g(this.topOuterStrokeColor, this.currentBorderTintColor), ColorUtils.g(this.topInnerStrokeColor, this.currentBorderTintColor), ColorUtils.g(ColorUtils.k(this.topInnerStrokeColor, 0), this.currentBorderTintColor), ColorUtils.g(ColorUtils.k(this.bottomInnerStrokeColor, 0), this.currentBorderTintColor), ColorUtils.g(this.bottomInnerStrokeColor, this.currentBorderTintColor), ColorUtils.g(this.bottomOuterStrokeColor, this.currentBorderTintColor)}, new float[]{0.0f, height, 0.5f, 0.5f, 1.0f - height, 1.0f}, Shader.TileMode.CLAMP);
    }
