...
public final class MaterialContainerTransform extends Transition {
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            float f6 = f4;
            float f7 = f5;
            FitModeResult evaluate = this.fitModeEvaluator.evaluate(f, ((Float) Preconditions.h(Float.valueOf(this.progressThresholds.scale.start))).floatValue(), ((Float) Preconditions.h(Float.valueOf(this.progressThresholds.scale.end))).floatValue(), this.startBounds.width(), this.startBounds.height(), this.endBounds.width(), this.endBounds.height());
            ...
            float floatValue = ((Float) Preconditions.h(Float.valueOf(this.progressThresholds.scaleMask.start))).floatValue();
            float floatValue2 = ((Float) Preconditions.h(Float.valueOf(this.progressThresholds.scaleMask.end))).floatValue();
            ...
            this.fadeModeResult = this.fadeModeEvaluator.evaluate(f, ((Float) Preconditions.h(Float.valueOf(this.progressThresholds.fade.start))).floatValue(), ((Float) Preconditions.h(Float.valueOf(this.progressThresholds.fade.end))).floatValue(), 0.35f);
    ...
    private static void captureValues(@NonNull TransitionValues transitionValues, @Nullable View view, @IdRes int i, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        if (i != -1) {
            transitionValues.b = TransitionUtils.findDescendantOrAncestorById(transitionValues.b, i);
        } else if (view != null) {
            transitionValues.b = view;
        } else if (transitionValues.b.getTag(R.id.mtrl_motion_snapshot_view) instanceof View) {
            transitionValues.b.setTag(R.id.mtrl_motion_snapshot_view, (Object) null);
            transitionValues.b = (View) transitionValues.b.getTag(R.id.mtrl_motion_snapshot_view);
        }
        View view2 = transitionValues.b;
        if (ViewCompat.W(view2) || view2.getWidth() != 0 || view2.getHeight() != 0) {
            ...
            transitionValues.f1876a.put(PROP_BOUNDS, relativeBounds);
            transitionValues.f1876a.put(PROP_SHAPE_APPEARANCE, captureShapeAppearance(view2, relativeBounds, shapeAppearanceModel));
        }
    }

    private static float getElevationOrDefault(float f, View view) {
        return f != ELEVATION_NOT_SET ? f : ViewCompat.u(view);
    }
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (!(transitionValues3 == null || transitionValues4 == null)) {
            RectF rectF = (RectF) transitionValues3.f1876a.get(PROP_BOUNDS);
            ShapeAppearanceModel shapeAppearanceModel = (ShapeAppearanceModel) transitionValues3.f1876a.get(PROP_SHAPE_APPEARANCE);
            if (rectF == null || shapeAppearanceModel == null) {
                Log.w(TAG, "Skipping due to null start bounds. Ensure start view is laid out and measured.");
            } else {
                RectF rectF2 = (RectF) transitionValues4.f1876a.get(PROP_BOUNDS);
                ShapeAppearanceModel shapeAppearanceModel2 = (ShapeAppearanceModel) transitionValues4.f1876a.get(PROP_SHAPE_APPEARANCE);
                if (rectF2 == null || shapeAppearanceModel2 == null) {
                    Log.w(TAG, "Skipping due to null end bounds. Ensure end view is laid out and measured.");
                    return null;
                }
                final View view3 = transitionValues3.b;
                final View view4 = transitionValues4.b;
