...
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public final int getOverlapPixelsForOffset(View view) {
        ...
        return MathUtils.b((int) (overlapRatioForOffset * ((float) i)), 0, i);
    }
    ...
    public void layoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, int i) {
        ...
        if (findFirstDependency != null) {
            ...
            GravityCompat.a(resolveGravity(layoutParams.c), view.getMeasuredWidth(), view.getMeasuredHeight(), rect, rect2, i);
    ...
    public boolean onMeasureChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, int i, int i2, int i3, int i4) {
        ...
        } else if (ViewCompat.w(findFirstDependency) && (lastWindowInsets = coordinatorLayout.getLastWindowInsets()) != null) {
