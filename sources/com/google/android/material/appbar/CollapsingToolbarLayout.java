...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i) {
            ...
            if (collapsingToolbarLayout2.statusBarScrim != null && l > 0) {
                ViewCompat.k0(collapsingToolbarLayout2);
            }
            int height = CollapsingToolbarLayout.this.getHeight();
            int B = (height - ViewCompat.B(CollapsingToolbarLayout.this)) - l;
            float f = (float) B;
            ...
            collapsingToolbarLayout3.collapsingTextHelper.setCurrentOffsetY(collapsingToolbarLayout3.currentOffset + B);
    ...
    private void updateCollapsedBounds(boolean z) {
        ...
        collapsingTextHelper2.setCollapsedBounds(i5, i6, i7 - i3, (rect.bottom + maxOffsetForPinChild) - i4);
    }
    ...
    private void updateTextBounds(int i, int i2, int i3, int i4, boolean z) {
        ...
        if (this.collapsingTitleEnabled && (view = this.dummyView) != null) {
            boolean z2 = false;
            boolean z3 = ViewCompat.V(view) && this.dummyView.getVisibility() == 0;
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (this.statusBarScrim != null && this.scrimAlpha > 0) {
            ...
            int l = windowInsetsCompat != null ? windowInsetsCompat.l() : 0;
            if (l > 0) {
                this.statusBarScrim.setBounds(0, -this.currentOffset, getWidth(), l - this.currentOffset);
    ...
    public void onAttachedToWindow() {
        ...
        if (parent instanceof AppBarLayout) {
            ...
            ViewCompat.E0(this, ViewCompat.w(appBarLayout));
    ...
    public void onMeasure(int i, int i2) {
        ...
        WindowInsetsCompat windowInsetsCompat = this.lastInsets;
        int l = windowInsetsCompat != null ? windowInsetsCompat.l() : 0;
        if ((mode == 0 || this.forceApplySystemWindowInsetTop) && l > 0) {
            this.topInsetApplied = l;
    ...
    public void setStatusBarScrim(@Nullable Drawable drawable) {
        ...
        if (drawable2 != drawable) {
            ...
            if (drawable3 != null) {
                ...
                DrawableCompat.m(this.statusBarScrim, ViewCompat.z(this));
    ...
    public CollapsingToolbarLayout(@androidx.annotation.NonNull android.content.Context r11, @androidx.annotation.Nullable android.util.AttributeSet r12, int r13) {
        ...
        L_0x0148:
            ...
            r11.<init>()
            androidx.core.view.ViewCompat.M0(r10, r11)
            return
        */
