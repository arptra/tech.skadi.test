...
import com.honey.account.c1.a;
import com.honey.account.c1.b;
...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private boolean addAccessibilityScrollActions(CoordinatorLayout coordinatorLayout, @NonNull T t, @NonNull View view) {
            ...
            if (getTopBottomOffsetForScrollingSibling() != (-t.getTotalScrollRange())) {
                addActionToExpand(coordinatorLayout, t, AccessibilityNodeInfoCompat.AccessibilityActionCompat.q, false);
                z = true;
            }
            if (getTopBottomOffsetForScrollingSibling() != 0) {
                if (view.canScrollVertically(-1)) {
                    ...
                    if (i != 0) {
                        ...
                        ViewCompat.p0(coordinatorLayout, AccessibilityNodeInfoCompat.AccessibilityActionCompat.r, (CharSequence) null, new AccessibilityViewCommand() {
                    ...
                    addActionToExpand(coordinatorLayout, t, AccessibilityNodeInfoCompat.AccessibilityActionCompat.r, true);
                    return true;
                }
            }
            return z;
        ...
        private void addActionToExpand(CoordinatorLayout coordinatorLayout, @NonNull final T t, @NonNull AccessibilityNodeInfoCompat.AccessibilityActionCompat accessibilityActionCompat, final boolean z) {
            ViewCompat.p0(coordinatorLayout, accessibilityActionCompat, (CharSequence) null, new AccessibilityViewCommand() {
                public boolean perform(@NonNull View view, @Nullable AccessibilityViewCommand.CommandArguments commandArguments) {
                    t.setExpanded(z);
                    return true;
                }
        ...
        private boolean shouldJumpElevationState(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t) {
            ...
            for (int i = 0; i < size; i++) {
                CoordinatorLayout.Behavior f = ((CoordinatorLayout.LayoutParams) dependents.get(i).getLayoutParams()).f();
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, @NonNull T t) {
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    if (childIndexOnOffset == 0 && ViewCompat.w(t) && ViewCompat.w(childAt)) {
                        i -= t.getTopInset();
                    }
                    ...
                    animateOffsetTo(coordinatorLayout, t, MathUtils.b(calculateSnapOffset(topBottomOffsetForScrollingSibling, i2, i) + topInset, -t.getTotalScrollRange(), 0), 0.0f);
                }
            }
        }
        ...
        private void updateAccessibilityActions(CoordinatorLayout coordinatorLayout, @NonNull T t) {
            ...
            ViewCompat.n0(coordinatorLayout, AccessibilityNodeInfoCompat.AccessibilityActionCompat.q.b());
            ViewCompat.n0(coordinatorLayout, AccessibilityNodeInfoCompat.AccessibilityActionCompat.r.b());
            if (t.getTotalScrollRange() != 0 && (childWithScrollingBehavior = getChildWithScrollingBehavior(coordinatorLayout)) != null && childrenHaveScrollFlags(t)) {
                if (!ViewCompat.Q(coordinatorLayout)) {
                    ViewCompat.u0(coordinatorLayout, new AccessibilityDelegateCompat() {
        ...
        private void updateAppBarLayoutDrawableState(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t, int i, int i2, boolean z) {
            ...
            if (appBarChildOnOffset != null) {
                ...
                if ((scrollFlags & 1) != 0) {
                    int B = ViewCompat.B(appBarChildOnOffset);
                    if (i2 <= 0 || (scrollFlags & 12) == 0 ? !((scrollFlags & 2) == 0 || (-i) < (appBarChildOnOffset.getBottom() - B) - t.getTopInset()) : (-i) >= (appBarChildOnOffset.getBottom() - B) - t.getTopInset()) {
                        z2 = true;
                    }
                }
            }
        ...
        public SavedState saveScrollState(@Nullable Parcelable parcelable, @NonNull T t) {
            ...
            while (i < childCount) {
                ...
                if (childAt.getTop() + topAndBottomOffset > 0 || bottom < 0) {
                    ...
                    if (bottom == ViewCompat.B(childAt) + t.getTopInset()) {
                        z = true;
                    }
        ...
        public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t, int i) {
            ...
            if (savedState2 == null || (pendingAction & 8) != 0) {
                ...
                if (this.savedState.firstVisibleChildAtMinimumHeight) {
                    round = ViewCompat.B(childAt) + t.getTopInset();
                } else {
            ...
            setTopAndBottomOffset(MathUtils.b(getTopAndBottomOffset(), -t.getTotalScrollRange(), 0));
        ...
        public int setHeaderTopBottomOffset(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t, int i, int i2, int i3) {
            ...
            if (i2 == 0 || topBottomOffsetForScrollingSibling < i2 || topBottomOffsetForScrollingSibling > i3) {
                ...
                if (topBottomOffsetForScrollingSibling != b) {
                    int interpolateOffset = t.hasChildWithInterpolator() ? interpolateOffset(t, b) : b;
                    boolean topAndBottomOffset = setTopAndBottomOffset(interpolateOffset);
                    int i5 = topBottomOffsetForScrollingSibling - b;
                    this.offsetDelta = b - interpolateOffset;
                    int i6 = 1;
                    ...
                    t.onOffsetChanged(getTopAndBottomOffset());
                    if (b < topBottomOffsetForScrollingSibling) {
                        i6 = -1;
                    }
                    updateAppBarLayoutDrawableState(coordinatorLayout, t, b, i6, false);
                    i4 = i5;
                }
            }
            updateAccessibilityActions(coordinatorLayout, t);
    ...
    public static class CompressChildScrollEffect extends ChildScrollEffect {
        ...
        public void onOffsetChanged(@NonNull AppBarLayout appBarLayout, @NonNull View view, float f) {
            ...
            if (abs <= 0.0f) {
                float a2 = 1.0f - MathUtils.a(Math.abs(abs / ((float) this.relativeRect.height())), 0.0f, 1.0f);
                float height = (-abs) - ((((float) this.relativeRect.height()) * COMPRESS_DISTANCE_FACTOR) * (1.0f - (a2 * a2)));
                view.setTranslationY(height);
                view.getDrawingRect(this.ghostRect);
                this.ghostRect.offset(0, (int) (-height));
                ViewCompat.C0(view, this.ghostRect);
                return;
            }
            ViewCompat.C0(view, (Rect) null);
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        private void offsetChildAsNeeded(@NonNull View view, @NonNull View view2) {
            ...
            if (f instanceof BaseBehavior) {
                ViewCompat.e0(view, (((view2.getBottom() - view.getTop()) + ((BaseBehavior) f).offsetDelta) + getVerticalLayoutGap()) - getOverlapPixelsForOffset(view2));
            }
        }
        ...
        public void onDependentViewRemoved(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, @NonNull View view2) {
            if (view2 instanceof AppBarLayout) {
                ViewCompat.n0(coordinatorLayout, AccessibilityNodeInfoCompat.AccessibilityActionCompat.q.b());
                ViewCompat.n0(coordinatorLayout, AccessibilityNodeInfoCompat.AccessibilityActionCompat.r.b());
                ViewCompat.u0(coordinatorLayout, (AccessibilityDelegateCompat) null);
            }
        }
    ...
    public /* synthetic */ void lambda$initializeLiftOnScrollWithColor$0(ColorStateList colorStateList, ColorStateList colorStateList2, MaterialShapeDrawable materialShapeDrawable, Integer num, ValueAnimator valueAnimator) {
        ...
        if (!(this.statusBarForeground == null || (num2 = this.statusBarForegroundOriginalColor) == null || !num2.equals(num))) {
            DrawableCompat.n(this.statusBarForeground, layer);
        }
        ...
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if ((i4 & 5) == 5) {
                    ...
                    if ((i4 & 8) != 0) {
                        B = ViewCompat.B(childAt);
                    } else if ((i4 & 2) != 0) {
                        B = measuredHeight - ViewCompat.B(childAt);
                    } else {
                        i = i5 + measuredHeight;
    ...
    public final int getMinimumHeightForVisibleOverlappingContent() {
        ...
        if (B == 0) {
            int childCount = getChildCount();
            B = childCount >= 1 ? ViewCompat.B(getChildAt(childCount - 1)) : 0;
            if (B == 0) {
                return getHeight() / 3;
            }
        }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        boolean z2 = true;
        if (ViewCompat.w(this) && shouldOffsetFirstChild()) {
            int topInset = getTopInset();
            for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode != 1073741824 && ViewCompat.w(this) && shouldOffsetFirstChild()) {
    ...
    public void setExpanded(boolean z) {
        setExpanded(z, ViewCompat.W(this));
    }
    ...
    public void setStatusBarForeground(@Nullable Drawable drawable) {
        ...
        if (drawable2 != drawable) {
            ...
            if (drawable4 != null) {
                ...
                DrawableCompat.m(this.statusBarForeground, ViewCompat.z(this));
    ...
    public AppBarLayout(@androidx.annotation.NonNull android.content.Context r10, @androidx.annotation.Nullable android.util.AttributeSet r11, int r12) {
        ...
        L_0x002d:
            ...
            androidx.core.view.ViewCompat.z0(r9, r12)
        ...
        L_0x00cd:
            ...
            r10.<init>()
            androidx.core.view.ViewCompat.M0(r9, r10)
            return
        */
