...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    public class ChipTouchHelper extends ExploreByTouchHelper {
        ...
        public void onPopulateNodeForHost(@NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            accessibilityNodeInfoCompat.f0(Chip.this.isCheckable());
        ...
        public void onPopulateNodeForVirtualView(int i, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (i == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    accessibilityNodeInfoCompat.l0(context.getString(i2, new Object[]{charSequence}).trim());
                }
                ...
                accessibilityNodeInfoCompat.o0(Chip.this.isEnabled());
                return;
            }
    ...
    private void updateAccessibilityDelegate() {
        if (!hasCloseIcon() || !isCloseIconVisible() || this.onCloseIconClickListener == null) {
            ViewCompat.u0(this, (AccessibilityDelegateCompat) null);
    ...
    private void updateFrameworkRippleBackground() {
        ...
        ViewCompat.z0(this, this.ripple);
        updatePaddingInternal();
    }
    ...
    private void updatePaddingInternal() {
        ...
        if (!TextUtils.isEmpty(getText()) && (chipDrawable2 = this.chipDrawable) != null) {
            ...
            ViewCompat.N0(this, chipStartPadding, getPaddingTop(), chipEndPadding, getPaddingBottom());
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (getParent() instanceof ChipGroup) {
            ...
            AccessibilityNodeInfoCompat.P0(accessibilityNodeInfo).k0(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.a(chipGroup.getRowIndex(this), 1, chipGroup.isSingleLine() ? chipGroup.getIndexOfChip(this) : -1, 1, false, isChecked()));
        }
    }
    ...
    public Chip(android.content.Context r7, android.util.AttributeSet r8, int r9) {
        /*
            ...
            float r1 = androidx.core.view.ViewCompat.u(r6)
            r7.setElevation(r1)
        ...
        L_0x0092:
            ...
            com.honey.account.g1.a r7 = new com.honey.account.g1.a
            r7.<init>(r6)
