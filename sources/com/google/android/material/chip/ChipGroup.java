...
public class ChipGroup extends FlowLayout {
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        AccessibilityNodeInfoCompat.P0(accessibilityNodeInfo).j0(AccessibilityNodeInfoCompat.CollectionInfoCompat.b(getRowCount(), isSingleLine() ? getVisibleChipCount() : -1, false, isSingleSelection() ? 1 : 2));
    }
    ...
    public ChipGroup(android.content.Context r9, android.util.AttributeSet r10, int r11) {
        /*
            ...
            r9 = 1
            androidx.core.view.ViewCompat.G0(r8, r9)
            return
        */
