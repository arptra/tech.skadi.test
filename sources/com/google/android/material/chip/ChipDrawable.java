...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private void drawDebug(@NonNull Canvas canvas, @NonNull Rect rect) {
        ...
        if (paint != null) {
            ...
            this.debugPaint.setColor(ColorUtils.k(-65536, 127));
            calculateChipTouchBounds(rect, this.rectF);
            canvas.drawRect(this.rectF, this.debugPaint);
            this.debugPaint.setColor(ColorUtils.k(-16711936, 127));
    ...
    public boolean onLayoutDirectionChanged(int i) {
        ...
        if (showsChipIcon()) {
            onLayoutDirectionChanged |= DrawableCompat.m(this.chipIcon, i);
        }
        if (showsCheckedIcon()) {
            onLayoutDirectionChanged |= DrawableCompat.m(this.checkedIcon, i);
        }
        if (showsCloseIcon()) {
            onLayoutDirectionChanged |= DrawableCompat.m(this.closeIcon, i);
        }
    ...
    public void setCheckedIconResource(@DrawableRes int i) {
        setCheckedIcon(AppCompatResources.b(this.context, i));
    }
    ...
    public void setCheckedIconTintResource(@ColorRes int i) {
        setCheckedIconTint(AppCompatResources.a(this.context, i));
    }
    ...
    public void setChipBackgroundColorResource(@ColorRes int i) {
        setChipBackgroundColor(AppCompatResources.a(this.context, i));
    }
    ...
    public void setChipIcon(@Nullable Drawable drawable) {
        ...
        if (chipIcon2 != drawable) {
            float calculateChipIconWidth = calculateChipIconWidth();
            this.chipIcon = drawable != null ? DrawableCompat.r(drawable).mutate() : null;
            float calculateChipIconWidth2 = calculateChipIconWidth();
    ...
    public void setChipIconResource(@DrawableRes int i) {
        setChipIcon(AppCompatResources.b(this.context, i));
    }
    ...
    public void setChipIconTintResource(@ColorRes int i) {
        setChipIconTint(AppCompatResources.a(this.context, i));
    }
    ...
    public void setChipStrokeColorResource(@ColorRes int i) {
        setChipStrokeColor(AppCompatResources.a(this.context, i));
    }
    ...
    public void setCloseIcon(@Nullable Drawable drawable) {
        ...
        if (closeIcon2 != drawable) {
            ...
            this.closeIcon = drawable != null ? DrawableCompat.r(drawable).mutate() : null;
            if (RippleUtils.USE_FRAMEWORK_RIPPLE) {
    ...
    public void setCloseIconResource(@DrawableRes int i) {
        setCloseIcon(AppCompatResources.b(this.context, i));
    }
    ...
    public void setCloseIconTintResource(@ColorRes int i) {
        setCloseIconTint(AppCompatResources.a(this.context, i));
    }
    ...
    public void setRippleColorResource(@ColorRes int i) {
        setRippleColor(AppCompatResources.a(this.context, i));
    }
