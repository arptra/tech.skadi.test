...
public class SearchBar extends Toolbar {
    ...
    private void initBackground(ShapeAppearanceModel shapeAppearanceModel, @ColorInt int i, float f, float f2, @ColorInt int i2) {
        ...
        ViewCompat.z0(this, new RippleDrawable(valueOf, materialShapeDrawable2, materialShapeDrawable2));
    }
    ...
    private void initTextView(@StyleRes int i, String str, String str2) {
        if (i != -1) {
            TextViewCompat.n(this.textView, i);
        }
    ...
    private Drawable maybeTintNavigationIcon(@Nullable Drawable drawable) {
        ...
        if (num != null) {
            ...
            i = MaterialColors.getColor(this, drawable == this.defaultNavigationIcon ? R.attr.colorOnSurfaceVariant : R.attr.colorOnSurface);
        }
    ...
    public float getCompatElevation() {
        ...
        return materialShapeDrawable != null ? materialShapeDrawable.getElevation() : ViewCompat.u(this);
    }
    ...
    public SearchBar(@androidx.annotation.NonNull android.content.Context r11, @androidx.annotation.Nullable android.util.AttributeSet r12, int r13) {
        /*
            ...
            r11 = -1
            r10.menuResId = r11
            com.honey.account.p1.b r0 = new com.honey.account.p1.b
            r0.<init>(r10)
        ...
        L_0x00b0:
            ...
            r10.textView = r12
            androidx.core.view.ViewCompat.D0(r10, r4)
