...
public class MotionUtils {
    ...
    private static TimeInterpolator getLegacyThemeInterpolator(String str) {
        if (isLegacyEasingType(str, EASING_TYPE_CUBIC_BEZIER)) {
            String[] split = getLegacyEasingContent(str, EASING_TYPE_CUBIC_BEZIER).split(MzContactsContract.MzGroups.GROUP_SPLIT_MARK_EXTRA);
            if (split.length == 4) {
            ...
            return PathInterpolatorCompat.b(PathParser.e(getLegacyEasingContent(str, EASING_TYPE_PATH)));
        } else {
