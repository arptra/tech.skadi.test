...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        if (!this.edgeToEdgeEnabled) {
            ...
            ViewCompat.M0(findViewById, new OnApplyWindowInsetsListener() {
                public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                    int i = windowInsetsCompat.f(WindowInsetsCompat.Type.f()).b;
                    if (i >= 0) {
    ...
    private void initHeaderToggle(Context context) {
        ...
        ViewCompat.u0(this.headerToggleButton, (AccessibilityDelegateCompat) null);
        updateToggleContentDescription(this.headerToggleButton);
        this.headerToggleButton.setOnClickListener(new c(this));
    }
    ...
    private void startPickerFragment() {
        ...
        s.t(R.id.mtrl_calendar_frame, this.pickerFragment);
        s.l();
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        this.background.setElevation(ViewCompat.u(dialog.getWindow().getDecorView()));
        return dialog;
    }
