...
public final class CollapsingTextHelper {
    ...
    @ColorInt
    private static int blendARGB(@ColorInt int i, @ColorInt int i2, @FloatRange float f) {
        float f2 = 1.0f - f;
    ...
    private void calculateBaseOffsets(boolean z) {
        ...
        int b = GravityCompat.b(this.collapsedTextGravity, this.isRtl ? 1 : 0);
        int i = b & 112;
        if (i == 48) {
        ...
        int b2 = GravityCompat.b(this.expandedTextGravity, this.isRtl ? 1 : 0);
        int i3 = b2 & 112;
        if (i3 == 48) {
    ...
    private float getCollapsedTextLeftBound(int i, int i2) {
        return (i2 == 17 || (i2 & 7) == 1) ? (((float) i) / 2.0f) - (this.collapsedTextWidth / 2.0f) : ((i2 & 8388613) == 8388613 || (i2 & 5) == 5) ? this.isRtl ? (float) this.collapsedBounds.left : ((float) this.collapsedBounds.right) - this.collapsedTextWidth : this.isRtl ? ((float) this.collapsedBounds.right) - this.collapsedTextWidth : (float) this.collapsedBounds.left;
    }
    ...
    private Layout.Alignment getMultilineTextLayoutAlignment() {
        int b = GravityCompat.b(this.expandedTextGravity, this.isRtl ? 1 : 0) & 7;
        return b != 1 ? b != 5 ? this.isRtl ? Layout.Alignment.ALIGN_OPPOSITE : Layout.Alignment.ALIGN_NORMAL : this.isRtl ? Layout.Alignment.ALIGN_NORMAL : Layout.Alignment.ALIGN_OPPOSITE : Layout.Alignment.ALIGN_CENTER;
    }
    ...
    private boolean isDefaultIsRtl() {
        return ViewCompat.z(this.view) == 1;
    }
