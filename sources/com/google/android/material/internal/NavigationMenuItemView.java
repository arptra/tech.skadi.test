...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public void initialize(@NonNull MenuItemImpl menuItemImpl, int i) {
        ...
        if (getBackground() == null) {
            ViewCompat.z0(this, createDefaultBackground());
        }
    ...
    public void setIcon(@Nullable Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.emptyDrawable == null) {
                Drawable f = ResourcesCompat.f(getResources(), com.google.android.material.R.drawable.navigation_empty_icon, getContext().getTheme());
                this.emptyDrawable = f;
                if (f != null) {
        ...
        TextViewCompat.i(this.textView, drawable, (Drawable) null, (Drawable) null, (Drawable) null);
    }
    ...
    public NavigationMenuItemView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        ViewCompat.u0(checkedTextView, r5);
    }
