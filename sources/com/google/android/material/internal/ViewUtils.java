...
public class ViewUtils {
    ...
    public static void hideKeyboard(@NonNull View view, boolean z) {
        WindowInsetsControllerCompat N;
        if (!z || (N = ViewCompat.N(view)) == null) {
    ...
    public static class RelativePadding {
        ...
        public void applyToView(View view) {
            ViewCompat.N0(view, this.start, this.f9671top, this.end, this.bottom);
        }

        public RelativePadding(@NonNull RelativePadding relativePadding) {
            this.start = relativePadding.start;
            this.f9671top = relativePadding.f9671top;
    ...
    public static void doOnApplyWindowInsets(@NonNull View view, @NonNull final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        final RelativePadding relativePadding = new RelativePadding(ViewCompat.F(view), view.getPaddingTop(), ViewCompat.E(view), view.getPaddingBottom());
        ViewCompat.M0(view, new androidx.core.view.OnApplyWindowInsetsListener() {
