...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        private void setAccessibilityDelegate(View view, final int i, final boolean z) {
            ViewCompat.u0(view, new AccessibilityDelegateCompat() {
                public void onInitializeAccessibilityNodeInfo(@NonNull View view, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                    ...
                    accessibilityNodeInfoCompat.k0(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.a(NavigationMenuAdapter.this.adjustItemPositionForA11yDelegate(i), 1, 1, 1, z, view.isSelected()));
                }
            });
        }
        ...
        public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                TextViewCompat.n(textView, NavigationMenuPresenter.this.subheaderTextAppearance);
    ...
    public class NavigationMenuViewAccessibilityDelegate extends RecyclerViewAccessibilityDelegate {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            super.onInitializeAccessibilityNodeInfo(view, accessibilityNodeInfoCompat);
            accessibilityNodeInfoCompat.j0(AccessibilityNodeInfoCompat.CollectionInfoCompat.a(NavigationMenuPresenter.this.adapter.getRowCount(), 1, false));
        }
    }
    ...
    public void dispatchApplyWindowInsets(@NonNull WindowInsetsCompat windowInsetsCompat) {
        ...
        if (this.paddingTopDefault != l) {
            this.paddingTopDefault = l;
            updateTopPadding();
        }
        NavigationMenuView navigationMenuView = this.menuView;
        navigationMenuView.setPadding(0, navigationMenuView.getPaddingTop(), 0, windowInsetsCompat.i());
        ViewCompat.g(this.headerLayout, windowInsetsCompat);
    }
