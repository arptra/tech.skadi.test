...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull BottomAppBar bottomAppBar, int i) {
            ...
            if (access$3200 != null && !ViewCompat.W(access$3200)) {
    ...
    private void maybeAnimateModeChange(int i) {
        if (this.fabAlignmentMode != i && ViewCompat.W(this)) {
    ...
    private Drawable maybeTintNavigationIcon(@Nullable Drawable drawable) {
        ...
        DrawableCompat.n(r, this.navigationIconTint.intValue());
        return r;
    }
    ...
    public int getActionMenuViewTranslationX(@NonNull ActionMenuView actionMenuView, int i, boolean z) {
        ...
        for (int i3 = 0; i3 < getChildCount(); i3++) {
            ...
            if ((childAt.getLayoutParams() instanceof Toolbar.LayoutParams) && (((Toolbar.LayoutParams) childAt.getLayoutParams()).f139a & 8388615) == 8388611) {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (z) {
            ...
            View findDependentView = findDependentView();
            if (findDependentView != null && ViewCompat.W(findDependentView)) {
                findDependentView.post(new a(findDependentView));
            }
        }
    ...
    public BottomAppBar(@androidx.annotation.NonNull android.content.Context r13, @androidx.annotation.Nullable android.util.AttributeSet r14, int r15) {
        ...
        L_0x00f4:
            ...
            androidx.core.view.ViewCompat.z0(r12, r13)
