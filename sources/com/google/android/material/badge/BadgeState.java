...
public final class BadgeState {
    ...
    public BadgeState(Context context, @XmlRes int i, @AttrRes int i2, @StyleRes int i3, @Nullable State state) {
        ...
        Boolean unused12 = state2.isVisible = Boolean.valueOf(z);
    ...
    public void setHorizontalOffsetWithText(@Dimension int i) {
    ...
    public void setHorizontalOffsetWithoutText(@Dimension int i) {
    ...
    public void setLargeFontVerticalOffsetAdjustment(@Dimension int i) {
    ...
    public void setVerticalOffsetWithText(@Dimension int i) {
    ...
    public void setVerticalOffsetWithoutText(@Dimension int i) {
