...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        private Drawable createThemedBackground() {
            ...
            if (this.backgroundTint == null) {
                return DrawableCompat.r(access$1900);
            }
            Drawable r = DrawableCompat.r(access$1900);
            DrawableCompat.o(r, this.backgroundTint);
            return r;
        }
        ...
        public void setBackgroundTintList(@Nullable ColorStateList colorStateList) {
            ...
            if (getBackground() != null) {
                ...
                DrawableCompat.p(r, this.backgroundTintMode);
                if (r != getBackground()) {
        ...
        public SnackbarBaseLayout(@NonNull Context context, AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.D0(this, (float) obtainStyledAttributes.getDimensionPixelSize(R.styleable.SnackbarLayout_elevation, 0));
            }
            ...
            setFocusable(true);
            if (getBackground() == null) {
                ViewCompat.z0(this, createThemedBackground());
            }
        }
    }
    ...
    public void startSlideInAnimation() {
        ...
        if (USE_OFFSET_API) {
            ViewCompat.e0(this.view, translationYBottom);
        } else {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(translationYBottom) {
            ...
            public void onAnimationUpdate(@NonNull ValueAnimator valueAnimator) {
                ...
                if (BaseTransientBottomBar.USE_OFFSET_API) {
                    ViewCompat.e0(BaseTransientBottomBar.this.view, intValue - this.previousAnimatedIntValue);
                } else {
    ...
    public BaseTransientBottomBar(@NonNull Context context2, @NonNull ViewGroup viewGroup, @NonNull View view2, @NonNull ContentViewCallback contentViewCallback2) {
        ...
        if (viewGroup == null) {
            ...
            ViewCompat.G0(snackbarBaseLayout, 1);
            ViewCompat.E0(snackbarBaseLayout, true);
            ViewCompat.M0(snackbarBaseLayout, new OnApplyWindowInsetsListener() {
                @NonNull
                public WindowInsetsCompat onApplyWindowInsets(View view, @NonNull WindowInsetsCompat windowInsetsCompat) {
                    int unused = BaseTransientBottomBar.this.extraBottomMarginWindowInset = windowInsetsCompat.i();
                    int unused2 = BaseTransientBottomBar.this.extraLeftMarginWindowInset = windowInsetsCompat.j();
                    int unused3 = BaseTransientBottomBar.this.extraRightMarginWindowInset = windowInsetsCompat.k();
                    BaseTransientBottomBar.this.updateMargins();
                    return windowInsetsCompat;
                }
            });
            ViewCompat.u0(snackbarBaseLayout, new AccessibilityDelegateCompat() {
                public void onInitializeAccessibilityNodeInfo(View view, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                    super.onInitializeAccessibilityNodeInfo(view, accessibilityNodeInfoCompat);
                    accessibilityNodeInfoCompat.a(PositionEstimate.Value.SITUATION);
