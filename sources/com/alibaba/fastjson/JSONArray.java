...
public class JSONArray extends JSON implements List<Object>, Cloneable, RandomAccess, Serializable {
    ...
    public JSONArray getJSONArray(int i) {
        ...
        return obj instanceof JSONArray ? (JSONArray) obj : obj instanceof List ? new JSONArray((List<Object>) (List) obj) : (JSONArray) JSON.toJSON(obj);
    }

    public JSONObject getJSONObject(int i) {
        Object obj = this.list.get(i);
        return obj instanceof JSONObject ? (JSONObject) obj : obj instanceof Map ? new JSONObject((Map<String, Object>) (Map) obj) : (JSONObject) JSON.toJSON(obj);
    }
