...
public class LongCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    public <T> T deserialze(DefaultJSONParser defaultJSONParser, Type type, Object obj) {
        ...
        try {
            ...
            if (i == 2) {
                ...
                T valueOf = Long.valueOf(TypeUtils.longValue(jSONLexer.decimalValue()));
                jSONLexer.nextToken(16);
                t = valueOf;
            } else {
                if (i == 12) {
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i) throws IOException {
        ...
        if (serializeWriter.isEnabled(SerializerFeature.WriteClassName) && longValue <= UpdateOptions.SOURCE_ANY && longValue >= -2147483648L && type != Long.class && type != Long.TYPE) {
