    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i) throws IOException {
        ...
        try {
            ...
            for (Object next : collection) {
                int i3 = i2 + 1;
                if (i2 != 0) {
                    serializeWriter.append((char) StringUtil.COMMA);
                }
                if (next == null) {
                    ...
                    if (cls == Integer.class) {
                        ...
                        if (!SerializerFeature.isEnabled(i, SerializerFeature.WriteClassName) || !(objectWriter instanceof JavaBeanSerializer)) {
                            objectWriter.write(jSONSerializer, next, Integer.valueOf(i2), collectionItemType, i);
                        } else {
                            ((JavaBeanSerializer) objectWriter).writeNoneASM(jSONSerializer, next, Integer.valueOf(i2), collectionItemType, i);
                        }
                    }
                }
                i2 = i3;
