...
public class MiscCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    public <T> T deserialze(DefaultJSONParser defaultJSONParser, Type type, Object obj) {
        ...
        if (type != InetSocketAddress.class) {
            ...
            Class<Currency> cls2 = Currency.class;
            if (obj2 == null) {
                str = null;
            ...
            while (true) {
                ...
                if (stringVal.equals(MzContactsContract.MzContactColumns.ADDRESS)) {
                    defaultJSONParser.accept(17);
                    inetAddress = (InetAddress) defaultJSONParser.parseObject(cls);
                } else if (stringVal.equals(RtspHeaders.Values.PORT)) {
                    defaultJSONParser.accept(17);
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type, int i) throws IOException {
        ...
        if (cls == SimpleDateFormat.class) {
            ...
            if (serializeWriter.isEnabled(SerializerFeature.WriteClassName) && obj.getClass() != type) {
                ...
                serializeWriter.writeFieldValue((char) StringUtil.COMMA, "val", str);
            ...
            serializeWriter.write(123);
            if (address != null) {
                serializeWriter.writeFieldName(MzContactsContract.MzContactColumns.ADDRESS);
                jSONSerializer.write((Object) address);
                serializeWriter.write(44);
            }
            serializeWriter.writeFieldName(RtspHeaders.Values.PORT);
