...
public final class JSR310Module extends SimpleModule {
    ...
    public JSR310Module() {
        ...
        addSerializer(cls3, _zonedWithZoneId());
    ...
    public AnnotatedMethod _findFactory(AnnotatedClass annotatedClass, String str, Class<?>... clsArr) {
        ...
        for (AnnotatedMethod next : annotatedClass.getStaticMethods()) {
        ...
        setupContext.addValueInstantiators(new ValueInstantiators.Base() {
            public ValueInstantiator findValueInstantiator(DeserializationConfig deserializationConfig, BeanDescription beanDescription, ValueInstantiator valueInstantiator) {
                ...
                if (cls.isAssignableFrom(rawClass) && (valueInstantiator instanceof StdValueInstantiator)) {
                    ...
                    AnnotatedClass classInfo = rawClass == cls ? beanDescription.getClassInfo() : AnnotatedClass.construct(deserializationConfig.constructType((Class<?>) cls), deserializationConfig);
