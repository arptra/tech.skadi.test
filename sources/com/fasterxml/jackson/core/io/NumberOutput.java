...
public final class NumberOutput {
    ...
    private static int _outputUptoBillion(int i, char[] cArr, int i2) {
        if (i >= MILLION) {
            ...
            cArr[_leading3 + 1] = (char) ((i6 >> 8) & 127);
            cArr[_leading3 + 2] = (char) (i6 & 127);
            int i7 = iArr[i4];
            cArr[_leading3 + 3] = (char) (i7 >> 16);
            int i8 = _leading3 + 5;
            cArr[_leading3 + 4] = (char) ((i7 >> 8) & 127);
            int i9 = _leading3 + 6;
            cArr[i8] = (char) (i7 & 127);
            return i9;
        } else if (i < 1000) {
            ...
            int i10 = i / 1000;
            return _outputUptoMillion(cArr, i2, i10, i - (i10 * 1000));
        }
    }
    ...
    private static int _outputUptoBillion(int i, byte[] bArr, int i2) {
        if (i >= MILLION) {
            ...
            bArr[_leading3 + 1] = (byte) (i6 >> 8);
            bArr[_leading3 + 2] = (byte) i6;
            int i7 = iArr[i4];
            bArr[_leading3 + 3] = (byte) (i7 >> 16);
            int i8 = _leading3 + 5;
            bArr[_leading3 + 4] = (byte) (i7 >> 8);
            int i9 = _leading3 + 6;
            bArr[i8] = (byte) i7;
            return i9;
        } else if (i < 1000) {
            ...
            int i10 = i / 1000;
            return _outputUptoMillion(bArr, i2, i10, i - (i10 * 1000));
        }
    }
