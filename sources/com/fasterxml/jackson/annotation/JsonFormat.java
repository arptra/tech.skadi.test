...
public @interface JsonFormat {
    ...
    public static class Value implements JacksonAnnotationValue<JsonFormat>, Serializable {
        ...
        public static Value forLeniency(boolean z) {
            return new Value((String) null, (Shape) null, (Locale) null, (String) null, (TimeZone) null, Features.empty(), Boolean.valueOf(z));
        }
        ...
        public static Value forShape(Shape shape) {
            return new Value((String) null, shape, (Locale) null, (String) null, (TimeZone) null, Features.empty(), (Boolean) null);
        }
