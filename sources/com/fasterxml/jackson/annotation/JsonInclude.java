...
public @interface JsonInclude {
    ...
    public static class Value implements JacksonAnnotationValue<JsonInclude>, Serializable {
        ...
        public Value withOverrides(Value value) {
            ...
            return z2 ? z3 ? new Value(include, include2, cls, cls2) : new Value(include, include4, cls, cls2) : z3 ? new Value(include3, include2, cls, cls2) : z ? new Value(include3, include4, cls, cls2) : this;
        }
