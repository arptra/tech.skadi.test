            ...
            if (z2 && annotatedWithParams2.getClass() == annotatedWithParams.getClass()) {
                ...
                if (rawParameterType == rawParameterType2) {
                    ...
                    if (!_isEnumValueOf(annotatedWithParams2)) {
                        throw new IllegalArgumentException(String.format("Conflicting %s creators: already had %s creator %s, encountered another: %s", new Object[]{TYPE_DESCS[i], z ? "explicitly marked" : "implicitly discovered", annotatedWithParams2, annotatedWithParams}));
                    }
