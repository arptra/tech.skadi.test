...
public class DocumentData {
    ...
    public DocumentData(String str, String str2, float f, Justification justification2, int i, float f2, float f3, @ColorInt int i2, @ColorInt int i3, float f4, boolean z, PointF pointF, PointF pointF2) {
    ...
    public void set(String str, String str2, float f, Justification justification2, int i, float f2, float f3, @ColorInt int i2, @ColorInt int i3, float f4, boolean z, PointF pointF, PointF pointF2) {
        this.text = str;
        this.fontName = str2;
        this.size = f;
