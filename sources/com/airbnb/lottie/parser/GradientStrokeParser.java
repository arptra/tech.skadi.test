...
class GradientStrokeParser {
    private static final JsonReader.Options DASH_PATTERN_NAMES = JsonReader.Options.of(n.f2968a, ProtocolVersions.PROTOCOL_KEY_CONNECTION_VERSION);
    private static final JsonReader.Options GRADIENT_NAMES = JsonReader.Options.of("p", "k");
    private static final JsonReader.Options NAMES = JsonReader.Options.of("nm", "g", "o", t.f, s.f, "e", w.f, "lc", "lj", "ml", "hd", "d");
