...
public class ShapeDataParser implements ValueParser<ShapeData> {
    ...
    private static final JsonReader.Options NAMES = JsonReader.Options.of("c", ProtocolVersions.PROTOCOL_KEY_CONNECTION_VERSION, ProtocolVersions.PROTOCOL_KEY_IDENTIFIER, "o");
