...
public class TextKeyframeAnimation extends KeyframeAnimation<DocumentData> {
    ...
    public DocumentData getValue(Keyframe<DocumentData> keyframe, float f) {
        ...
        if (lottieValueCallback != null) {
            ...
            return (DocumentData) lottieValueCallback.getValueInternal(f2, floatValue, documentData, t3 == null ? (DocumentData) t2 : (DocumentData) t3, f, getInterpolatedCurrentKeyframeProgress(), getProgress());
        } else if (f != 1.0f || (t = keyframe.endValue) == null) {
