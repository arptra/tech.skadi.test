...
final class DeviceRequestAssembler$cacheAbility$2 extends Lambda implements Function0<CacheAbility> {
    public static final DeviceRequestAssembler$cacheAbility$2 INSTANCE = new DeviceRequestAssembler$cacheAbility$2();

    public DeviceRequestAssembler$cacheAbility$2() {
        super(0);
    }
