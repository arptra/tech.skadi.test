...
public final class WechatNlpPreprocessor implements NlpPreprocessor {
    ...
    public Object i(NluResponse nluResponse, Continuation continuation) {
        d(nluResponse, R.string.tts_wechat_direct_tip);
        NlpCompact.a();
        return nluResponse;
    }
}
