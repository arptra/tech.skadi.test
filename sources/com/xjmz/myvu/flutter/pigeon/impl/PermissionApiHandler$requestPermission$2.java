...
public final class PermissionApiHandler$requestPermission$2 extends Lambda implements Function1<Boolean, Unit> {
    ...
    public PermissionApiHandler$requestPermission$2(AndroidPermissionApi.Result<AndroidPermissionApi.PermissionResult> result, PermissionApiHandler permissionApiHandler) {
        super(1);
        this.$result = result;
