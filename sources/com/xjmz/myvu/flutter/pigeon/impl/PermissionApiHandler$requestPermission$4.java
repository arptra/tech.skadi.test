...
public final class PermissionApiHandler$requestPermission$4 extends Lambda implements Function1<Boolean, Unit> {
    ...
    public PermissionApiHandler$requestPermission$4(AndroidPermissionApi.Result<AndroidPermissionApi.PermissionResult> result, PermissionApiHandler permissionApiHandler) {
        super(1);
        this.$result = result;
