...
public final class UserLogOutHelper$http$2 extends Lambda implements Function0<HttpInstance> {
    public static final UserLogOutHelper$http$2 INSTANCE = new UserLogOutHelper$http$2();

    public UserLogOutHelper$http$2() {
        super(0);
    }
