...
public final class DebugLoginActivity$http$2 extends Lambda implements Function0<HttpInstance> {
    public static final DebugLoginActivity$http$2 INSTANCE = new DebugLoginActivity$http$2();

    public DebugLoginActivity$http$2() {
        super(0);
    }
