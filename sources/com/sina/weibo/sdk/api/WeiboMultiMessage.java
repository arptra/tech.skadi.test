...
public class WeiboMultiMessage implements Serializable {
    ...
    public String toString() {
        return "WeiboMultiMessage{mediaObject=" + this.mediaObject + ", textObject=" + this.textObject + ", imageObject=" + this.imageObject + ", multiImageObject=" + this.multiImageObject + ", videoSourceObject=" + this.videoSourceObject + ", superGroupObject=" + this.superGroupObject + '}';
    }
    ...
    public Bundle writeToBundle(Bundle bundle) {
        ...
        if (videoSourceObject2 != null) {
            ...
            bundle.putParcelable("_weibo_message_video_source", (Parcelable) null);
        }
        ...
        if (superGroupObject2 != null) {
            ...
            bundle.putParcelable("_weibo_message_supergroup", (Parcelable) null);
        }
        return bundle;
    }
}
