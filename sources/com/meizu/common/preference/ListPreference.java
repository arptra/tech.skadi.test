...
public class ListPreference extends android.preference.ListPreference implements PopupWindow.OnDismissListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public static Method sSetLayoutMode;
    ...
    /* access modifiers changed from: private */
    public int mMaxDropDownHeight;
    private DropdownPopup mPopup;
    /* access modifiers changed from: private */
    public View mPreferenceViewExt;
    ...
    public class DropdownPopup extends ListPopupWindow {
        ...
        public DropdownPopup(Context context) {
            ...
            setOnItemClickListener(new AdapterView.OnItemClickListener(ListPreference.this) {
                public void onItemClick(AdapterView adapterView, View view, int i, long j) {
                    int unused = ListPreference.this.mClickedDialogEntryIndex = i;
        ...
        public void show() {
            ...
            if (ListPreference.this.mDropDownWidth <= 0 || ListPreference.this.mDropDownWidth > (width - paddingLeft) - paddingRight) {
                int unused = ListPreference.this.mDropDownWidth = (width - paddingLeft) - paddingRight;
            }
            setContentWidth(ListPreference.this.mDropDownWidth);
            try {
                if (ListPreference.sSetLayoutMode == null) {
                    Method unused2 = ListPreference.sSetLayoutMode = getClass().getMethod("setLayoutMode", new Class[]{Integer.TYPE});
                }
                ListPreference.sSetLayoutMode.invoke(this, new Object[]{4});
            } catch (Exception e) {
                e.printStackTrace();
            }
            if (ListPreference.this.mMaxDropDownHeight > 0) {
                ...
                if (listAdapter != null && listAdapter.getCount() > 0) {
                    ...
                    int i3 = 0;
                    do {
                        View view = this.mAdapter.getView(i2, (View) null, getListView());
                        if (view != null) {
                            view.measure(0, 0);
            ...
            int unused3 = listPreference.mClickedDialogEntryIndex = listPreference.findIndexOfValue(listPreference.getValue());
    ...
    public void onDropdownPopupClosed() {
    ...
    public void setEnabled(boolean z) {
        ...
        super.setEnabled(z);
        if (!z && (dropdownPopup = this.mPopup) != null && dropdownPopup.isShowing()) {
            this.mPopup.dismiss();
        }
    }
