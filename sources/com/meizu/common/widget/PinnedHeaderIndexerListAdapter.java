...
public abstract class PinnedHeaderIndexerListAdapter extends PinnedHeaderListAdapter implements SectionIndexer {
    ...
    public void configurePinnedHeaders(PinnedHeaderListView pinnedHeaderListView) {
        ...
        if (getPinnedPartitionHeadersEnabled() && isSectionHeaderDisplayEnabled()) {
            boolean z = true;
            int i = 0;
            boolean z2 = pinnedHeaderListView.getLastVisiblePosition() + 1 < pinnedHeaderListView.getCount() || pinnedHeaderListView.getFirstVisiblePosition() > 0;
            int currentOverScrollDistance = pinnedHeaderListView.getCurrentOverScrollDistance();
            boolean z3 = z2 && currentOverScrollDistance <= 0 && pinnedHeaderListView.getFirstVisiblePosition() == 0;
            if (z3 && this.mLastSectionOverScrollDistance >= 0) {
            ...
            if (this.mIndexer == null || getCount() == 0 || z3) {
    ...
    public android.view.View getView(int r2, int r3, int r4, int r5, android.view.View r6, android.view.ViewGroup r7) {
        ...
        L_0x001b:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meizu.common.widget.PinnedHeaderIndexerListAdapter.getView(int, int, int, int, android.view.View, android.view.ViewGroup):android.view.View");
    }
