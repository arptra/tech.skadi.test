...
public class RoundCornerImageView extends ImageView {
    ...
    public void setImageBitmap(Bitmap bitmap) {
        ...
        Drawable drawable = this.mDstRoundCornerDrawable;
        if (drawable != null && drawable != getDrawable() && this.mRecycle) {
    ...
    public void setImageDrawable(Drawable drawable) {
        ...
        Drawable drawable2 = this.mDstRoundCornerDrawable;
        if (drawable2 != null && drawable2 != getDrawable() && this.mRecycle) {
            ((BitmapDrawable) this.mDstRoundCornerDrawable).getBitmap().recycle();
            this.mDstRoundCornerDrawable = null;
            this.mRecycle = false;
        }
