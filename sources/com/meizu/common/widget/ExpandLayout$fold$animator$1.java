...
public final class ExpandLayout$fold$animator$1 extends Lambda implements Function1<Animator, Unit> {
    final /* synthetic */ ExpandLayout this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ExpandLayout$fold$animator$1(ExpandLayout expandLayout) {
        super(1);
