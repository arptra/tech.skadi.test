...
public class LoadingDialog extends Dialog {
    ...
    private void updateMessageView() {
        if (this.mMessageView != null) {
            ...
            this.mMessageView.setTextColor(this.mContext.getResources().getColor(R.color.fd_sys_color_on_surface_default));
        }
    }
    ...
    public void setMessageTextColorResource(@ColorRes int i) {
