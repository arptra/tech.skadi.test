...
public final class c extends a<f> {
    ...
    public final long a() {
        ...
        try {
            return DatabaseUtils.queryNumEntries(this.f8172a, "apm");
        } catch (Exception e) {
            e.printStackTrace();
            return 0;
        }
    ...
    public final long b(f fVar) {
        ...
        try {
            ...
            return this.f8172a.insert("apm", (String) null, contentValues);
        } catch (Exception e) {
            e.printStackTrace();
            return -1;
        }
    ...
    public final boolean c(ArrayList arrayList) {
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                sQLiteDatabase.delete("apm", "id = " + ((f) it.next()).f8175a, (String[]) null);
            }
            return true;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public final ArrayList f() {
        ...
        try {
            query = this.f8172a.query("apm", e.f8174a, (String) null, (String[]) null, (String) null, (String) null, "id ASC LIMIT + 100");
