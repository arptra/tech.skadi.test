...
public final class CoroutineUtilsKt$launchDefault$2$1 implements Runnable {
    final /* synthetic */ Function0<T> $block;
    final /* synthetic */ Continuation<T> $continuation;

    public CoroutineUtilsKt$launchDefault$2$1(Function0<? extends T> function0, Continuation<? super T> continuation) {
    ...
    public final void run() {
        try {
            ...
            logUtils.e("CoroutineUtils", "suspend launchDefault command error: " + e);
