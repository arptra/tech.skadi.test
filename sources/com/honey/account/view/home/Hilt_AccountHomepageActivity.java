...
public abstract class Hilt_AccountHomepageActivity extends BaseCompatActivity implements GeneratedComponentManagerHolder {
    private volatile ActivityComponentManager componentManager;
    private final Object componentManagerLock = new Object();
    private boolean injected = false;
    private SavedStateHandleHolder savedStateHandleHolder;

    public Hilt_AccountHomepageActivity() {
        _initHiltInternal();
    }
    ...
    private void _initHiltInternal() {
        addOnContextAvailableListener(new OnContextAvailableListener() {
            public void onContextAvailable(Context context) {
                Hilt_AccountHomepageActivity.this.inject();
            }
        });
    }
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((AccountHomepageActivity_GeneratedInjector) generatedComponent()).injectAccountHomepageActivity((AccountHomepageActivity) UnsafeCasts.unsafeCast(this));
        }
    }
