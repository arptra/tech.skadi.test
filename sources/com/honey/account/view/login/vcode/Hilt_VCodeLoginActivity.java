...
public abstract class Hilt_VCodeLoginActivity extends LoginActivity implements GeneratedComponentManagerHolder {
    private volatile ActivityComponentManager componentManager;
    private final Object componentManagerLock = new Object();
    private boolean injected = false;
    private SavedStateHandleHolder savedStateHandleHolder;

    public Hilt_VCodeLoginActivity() {
        _initHiltInternal();
    }
    ...
    private void _initHiltInternal() {
        addOnContextAvailableListener(new OnContextAvailableListener() {
            public void onContextAvailable(Context context) {
                Hilt_VCodeLoginActivity.this.inject();
            }
        });
    }
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((VCodeLoginActivity_GeneratedInjector) generatedComponent()).injectVCodeLoginActivity((VCodeLoginActivity) UnsafeCasts.unsafeCast(this));
        }
    }
