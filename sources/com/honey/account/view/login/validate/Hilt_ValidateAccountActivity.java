...
public abstract class Hilt_ValidateAccountActivity extends BaseCompatActivity implements GeneratedComponentManagerHolder {
    private volatile ActivityComponentManager componentManager;
    private final Object componentManagerLock = new Object();
    private boolean injected = false;
    private SavedStateHandleHolder savedStateHandleHolder;

    public Hilt_ValidateAccountActivity() {
        _initHiltInternal();
    }
    ...
    private void _initHiltInternal() {
        addOnContextAvailableListener(new OnContextAvailableListener() {
            public void onContextAvailable(Context context) {
                Hilt_ValidateAccountActivity.this.inject();
            }
        });
    }
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ValidateAccountActivity_GeneratedInjector) generatedComponent()).injectValidateAccountActivity((ValidateAccountActivity) UnsafeCasts.unsafeCast(this));
        }
    }
