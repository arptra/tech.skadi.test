...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    public BaseWXApiImplV10(Context context2, String str, boolean z, int i) {
        ...
        this.launchMode = i;
        b.f9614a = context2.getApplicationContext();
    }
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        try {
            ...
            if (b.b(queryParameter)) {
                ...
                resp.scene = b.a(parse.getQueryParameter(FastRecordMainViewModel.RECORD_TYPE_SCENE), 0);
                resp.action = parse.getQueryParameter(WebJs.ACTION);
    ...
    private void launchWXUsingPendingIntent() {
        if (this.detached) {
            ...
            try {
                ...
                PendingIntent.getActivity(this.context, 1, this.context.getPackageManager().getLaunchIntentForPackage("com.tencent.mm"), CaptureType.CAPTURE_VIRTUAL_DISPLAY_ENABLE_MAGIC_WINDOW).send(this.context, 2, (Intent) null, new PendingIntent.OnFinished() {
    ...
    private boolean sendLaunchWXMiniprogram(Context context2, BaseReq baseReq) {
        ...
        Cursor query = contentResolver.query(parse, (String[]) null, (String) null, new String[]{str, str2, str3, req.miniprogramType + "", req.extData}, (String) null);
        if (query == null) {
            return true;
        }
        query.close();
    ...
    private boolean sendOpenBusinessWebview(Context context2, BaseReq baseReq) {
        ...
        String str = this.appId;
        Cursor query = contentResolver.query(parse, (String[]) null, (String) null, new String[]{str, req.businessType + "", jSONObject}, (String) null);
        if (query == null) {
            return true;
        }
        query.close();
    ...
    public void unregisterApp() {
        if (this.detached) {
            ...
            a.C0034a aVar = new a.C0034a();
            aVar.f9604a = "com.tencent.mm";
