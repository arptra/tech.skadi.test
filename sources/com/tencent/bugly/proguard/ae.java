...
public final class ae {
    public static bu a(UserInfoBean userInfoBean) {
        ...
        sb3.append(true ^ userInfoBean.l);
        ...
        Map<String, String> map12 = buVar.f;
    ...
    public static bq a(Context context, int i, byte[] bArr) {
        ...
        try {
            ...
            synchronized (b) {
                ...
                if (list != null) {
                    for (o next : list) {
                        String str2 = next.versionKey;
                        if (!(str2 == null || (str = next.version) == null)) {
    ...
    public static byte[] a(m mVar) {
        try {
            ...
            lVar.a("utf-8");
            mVar.a(lVar);
            byte[] bArr = new byte[lVar.f9584a.position()];
            System.arraycopy(lVar.f9584a.array(), 0, bArr, 0, lVar.f9584a.position());
            return bArr;
        } catch (Throwable th) {
            if (al.b(th)) {
                return null;
