...
public class StreamEncoder implements Encoder<InputStream> {
    ...
    public final ArrayPool f2588a;

    public StreamEncoder(ArrayPool arrayPool) {
        this.f2588a = arrayPool;
    }
    ...
    public boolean a(java.io.InputStream r5, java.io.File r6, com.bumptech.glide.load.Options r7) {
        /*
            ...
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r0 = r4.f2588a
        ...
        L_0x002c:
            com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r4 = r4.f2588a
            r4.put(r0)
            r1 = 1
            goto L_0x004c
        L_0x0033:
