...
public final class GlideException extends Exception {
    ...
    public static final class IndentedAppendable implements Appendable {
        ...
        public final Appendable f2495a;
        public boolean b = true;

        public IndentedAppendable(Appendable appendable) {
            this.f2495a = appendable;
        }
        ...
        public Appendable append(char c) {
            ...
            if (this.b) {
                this.b = false;
                this.f2495a.append(FastRecordHistoryDetailActivity.TAG_SPLIT);
            }
            if (c == 10) {
                z = true;
            }
            this.b = z;
            this.f2495a.append(c);
            return this;
        }
