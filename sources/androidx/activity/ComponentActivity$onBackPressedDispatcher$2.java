...
public final class ComponentActivity$onBackPressedDispatcher$2 extends Lambda implements Function0<OnBackPressedDispatcher> {
    ...
    public final OnBackPressedDispatcher invoke() {
        OnBackPressedDispatcher onBackPressedDispatcher = new OnBackPressedDispatcher(new b(this.this$0));
        ComponentActivity componentActivity = this.this$0;
        if (Build.VERSION.SDK_INT >= 33) {
            if (!Intrinsics.areEqual((Object) Looper.myLooper(), (Object) Looper.getMainLooper())) {
                new Handler(Looper.getMainLooper()).post(new c(componentActivity, onBackPressedDispatcher));
            } else {
                componentActivity.S(onBackPressedDispatcher);
            }
        }
