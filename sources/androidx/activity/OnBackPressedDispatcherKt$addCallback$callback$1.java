...
public final class OnBackPressedDispatcherKt$addCallback$callback$1 extends OnBackPressedCallback {
    ...
    public final /* synthetic */ Function1 f104a;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public OnBackPressedDispatcherKt$addCallback$callback$1(boolean z, Function1 function1) {
        super(z);
        this.f104a = function1;
    }

    public void handleOnBackPressed() {
        this.f104a.invoke(this);
    }
}
