...
final class CamUtils {
    ...
    public static final float[][] f695a = {new float[]{0.401288f, 0.650173f, -0.051461f}, new float[]{-0.250268f, 1.204414f, 0.045854f}, new float[]{-0.002079f, 0.048952f, 0.953127f}};
    ...
    public static int a(float f) {
        ...
        float[] fArr = c;
        return ColorUtils.b((double) (f5 * fArr[0]), (double) (f3 * fArr[1]), (double) (f4 * fArr[2]));
    }
