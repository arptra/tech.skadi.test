...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class LayoutManager {
        ...
        public int getMinimumWidth() {
            return ViewCompat.C(this.mRecyclerView);
        }
        ...
        public void onInitializeAccessibilityNodeInfo(@NonNull Recycler recycler, @NonNull State state, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            accessibilityNodeInfoCompat.j0(AccessibilityNodeInfoCompat.CollectionInfoCompat.b(getRowCountForAccessibility(recycler, state), getColumnCountForAccessibility(recycler, state), isLayoutHierarchical(recycler, state), getSelectionModeForAccessibility(recycler, state)));
        }
            ...
            if (this.mAttachedAdaptersForPoolingContainer.size() == 0 && !z) {
                for (int i = 0; i < this.mScrap.size(); i++) {
                    ...
                    for (int i2 = 0; i2 < arrayList.size(); i2++) {
                        PoolingContainer.a(arrayList.get(i2).itemView);
                    }
                }
            }
        }
    ...
    public final class Recycler {
        ...
        private void attachAccessibilityDelegateOnBind(ViewHolder viewHolder) {
            if (RecyclerView.this.isAccessibilityEnabled()) {
                ...
                if (recyclerViewAccessibilityDelegate != null) {
                    ...
                    ViewCompat.u0(view, itemDelegate);
                }
            }
        }
        ...
        public void addViewHolderToRecycledViewPool(@NonNull ViewHolder viewHolder, boolean z) {
            ...
            if (recyclerViewAccessibilityDelegate != null) {
                AccessibilityDelegateCompat itemDelegate = recyclerViewAccessibilityDelegate.getItemDelegate();
                ViewCompat.u0(view, itemDelegate instanceof RecyclerViewAccessibilityDelegate.ItemDelegate ? ((RecyclerViewAccessibilityDelegate.ItemDelegate) itemDelegate).getAndRemoveOriginalDelegateForItem(view) : null);
            }
            if (z) {
        ...
        public void onDetachedFromWindow() {
            for (int i = 0; i < this.mCachedViews.size(); i++) {
                PoolingContainer.a(this.mCachedViews.get(i).itemView);
            }
        ...
        /* JADX WARNING: Removed duplicated region for block: B:85:0x01cf  */
    ...
    private int consumeFlingInStretch(int i, EdgeEffect edgeEffect, EdgeEffect edgeEffect2, int i2) {
        if (i > 0 && edgeEffect != null && EdgeEffectCompat.b(edgeEffect) != DECELERATION_RATE) {
            int round = Math.round((((float) (-i2)) / FLING_DESTRETCH_FACTOR) * EdgeEffectCompat.d(edgeEffect, (((float) (-i)) * FLING_DESTRETCH_FACTOR) / ((float) i2), 0.5f));
            if (round != i) {
                edgeEffect.finish();
            }
            return i - round;
        } else if (i >= 0 || edgeEffect2 == null || EdgeEffectCompat.b(edgeEffect2) == DECELERATION_RATE) {
            return i;
        } else {
            float f = (float) i2;
            int round2 = Math.round((f / FLING_DESTRETCH_FACTOR) * EdgeEffectCompat.d(edgeEffect2, (((float) i) * FLING_DESTRETCH_FACTOR) / f, 0.5f));
            if (round2 != i) {
                edgeEffect2.finish();
            }
            return i - round2;
    ...
    private void pullGlows(float r7, float r8, float r9, float r10) {
        ...
        L_0x007c:
            androidx.core.view.ViewCompat.k0(r6)
        L_0x007f:
            return
        */
        ...
        if (edgeEffect == null || EdgeEffectCompat.b(edgeEffect) == DECELERATION_RATE) {
            ...
            if (!(edgeEffect2 == null || EdgeEffectCompat.b(edgeEffect2) == DECELERATION_RATE)) {
                if (canScrollHorizontally(1)) {
                    ...
                    float d = EdgeEffectCompat.d(this.mRightGlow, width, height);
            ...
            if (canScrollHorizontally(-1)) {
                ...
                float f3 = -EdgeEffectCompat.d(this.mLeftGlow, -width, 1.0f - height);
        ...
        if (edgeEffect == null || EdgeEffectCompat.b(edgeEffect) == DECELERATION_RATE) {
            ...
            if (!(edgeEffect2 == null || EdgeEffectCompat.b(edgeEffect2) == DECELERATION_RATE)) {
                if (canScrollVertically(1)) {
                    ...
                    float d = EdgeEffectCompat.d(this.mBottomGlow, height, 1.0f - width);
            ...
            if (canScrollVertically(-1)) {
                ...
                float f3 = -EdgeEffectCompat.d(this.mTopGlow, -height, width);
    ...
    private boolean shouldAbsorb(@NonNull EdgeEffect edgeEffect, int i, int i2) {
        ...
        return getSplineFlingDistance(-i) < EdgeEffectCompat.b(edgeEffect) * ((float) i2);
    }
    ...
    public void defaultOnMeasure(int i, int i2) {
        setMeasuredDimension(LayoutManager.chooseSize(i, getPaddingLeft() + getPaddingRight(), ViewCompat.C(this)), LayoutManager.chooseSize(i2, getPaddingTop() + getPaddingBottom(), ViewCompat.B(this)));
    }
    ...
    public void dispatchPendingImportantForAccessibilityChanges() {
        ...
        for (int size = this.mPendingAccessibilityImportanceChange.size() - 1; size >= 0; size--) {
            ...
            if (viewHolder.itemView.getParent() == this && !viewHolder.shouldIgnore() && (i = viewHolder.mPendingAccessibilityState) != -1) {
                ViewCompat.G0(viewHolder.itemView, i);
    ...
    public void draw(Canvas canvas) {
        ...
        if (edgeEffect == null || edgeEffect.isFinished()) {
            ...
            canvas.translate((float) ((-getHeight()) + paddingBottom), DECELERATION_RATE);
    ...
    public boolean scrollByInternal(int i, int i2, MotionEvent motionEvent, int i3) {
        ...
        if (getOverScrollMode() != 2) {
            if (motionEvent2 != null && !MotionEventCompat.c(motionEvent2, 8194)) {
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mTouchSlop = viewConfiguration.getScaledTouchSlop();
        this.mScaledHorizontalScrollFactor = ViewConfigurationCompat.e(viewConfiguration, context2);
        this.mScaledVerticalScrollFactor = ViewConfigurationCompat.h(viewConfiguration, context2);
        ...
        ViewCompat.s0(this, context, R.styleable.RecyclerView, attributeSet, obtainStyledAttributes, i, 0);
        ...
        ViewCompat.s0(this, context, iArr, attributeSet, obtainStyledAttributes2, i, 0);
