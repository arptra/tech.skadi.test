...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public static class MessageQueue {
        ...
        public void removeMessages(int r5) {
            /*
                r4 = this;
                java.lang.Object r0 = r4.mLock
                monitor-enter(r0)
            L_0x0003:
                androidx.recyclerview.widget.MessageThreadUtil$SyncQueueItem r1 = r4.mRoot     // Catch:{ all -> 0x0013 }
            ...
            L_0x0015:
                ...
                androidx.recyclerview.widget.MessageThreadUtil$SyncQueueItem r4 = r1.next     // Catch:{ all -> 0x0013 }
            L_0x0019:
                if (r4 == 0) goto L_0x002a
                androidx.recyclerview.widget.MessageThreadUtil$SyncQueueItem r2 = r4.next     // Catch:{ all -> 0x0013 }
                int r3 = r4.what     // Catch:{ all -> 0x0013 }
                if (r3 != r5) goto L_0x0027
                r1.next = r2     // Catch:{ all -> 0x0013 }
                r4.recycle()     // Catch:{ all -> 0x0013 }
                goto L_0x0028
            L_0x0027:
                r1 = r4
            L_0x0028:
