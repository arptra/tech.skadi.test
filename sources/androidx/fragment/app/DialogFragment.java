...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public FragmentContainer createFragmentContainer() {
        ...
        return new FragmentContainer() {
            public View c(int i) {
                return createFragmentContainer.d() ? createFragmentContainer.c(i) : DialogFragment.this.onFindViewById(i);
            }
        ...
        if (!this.mDismissed) {
            ...
            if (this.mBackStackId >= 0) {
                if (z3) {
                    ...
                    getParentFragmentManager().q1(this.mBackStackId, 1, z);
                }
                this.mBackStackId = -1;
                return;
            }
            FragmentTransaction s = getParentFragmentManager().s();
            s.z(true);
            s.s(this);
            if (z3) {
                s.l();
