...
final class PagingDataTransforms$filter$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super PageEvent<Object>>, Object> {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<Object, Continuation<? super Boolean>, Object> {
        ...
        @Nullable
        public final Object invoke(@NotNull Object obj, @Nullable Continuation<? super Boolean> continuation) {
            return ((AnonymousClass1) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public PagingDataTransforms$filter$2$1(PageEvent<Object> pageEvent, Function1<Object, Boolean> function1, Continuation<? super PagingDataTransforms$filter$2$1> continuation) {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            final Function1<Object, Boolean> function1 = this.$predicate;
            AnonymousClass1 r1 = new AnonymousClass1((Continuation<? super AnonymousClass1>) null);
            this.label = 1;
            obj = pageEvent.a(r1, this);
