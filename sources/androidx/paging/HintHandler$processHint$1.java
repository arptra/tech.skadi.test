...
public final class HintHandler$processHint$1 extends Lambda implements Function2<HintHandler.HintFlow, HintHandler.HintFlow, Unit> {
    ...
    public final void invoke(@NotNull HintHandler.HintFlow hintFlow, @NotNull HintHandler.HintFlow hintFlow2) {
        ...
        if (HintHandlerKt.a(this.$viewportHint, hintFlow.b(), LoadType.PREPEND)) {
            hintFlow.c(this.$viewportHint);
        }
        if (HintHandlerKt.a(this.$viewportHint, hintFlow2.b(), LoadType.APPEND)) {
            hintFlow2.c(this.$viewportHint);
        }
    }
}
