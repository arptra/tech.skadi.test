...
public final class FlowExtKt$simpleScan$1$1$emit$1 extends ContinuationImpl {
    ...
    public FlowExtKt$simpleScan$1$1$emit$1(FlowExtKt$simpleScan$1.AnonymousClass1<? super T> r1, Continuation<? super FlowExtKt$simpleScan$1$1$emit$1> continuation) {
        super(continuation);
        this.this$0 = r1;
    }
