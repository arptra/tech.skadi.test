...
final class CachedPagingDataKt$cachedIn$5 extends SuspendLambda implements Function3<FlowCollector<? super PagingData<Object>>, Throwable, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            if (activeFlowTracker != null) {
                ...
                this.label = 1;
                if (activeFlowTracker.a(flowType, this) == coroutine_suspended) {
    ...
    @Nullable
    public final Object invoke(@NotNull FlowCollector<? super PagingData<Object>> flowCollector, @Nullable Throwable th, @Nullable Continuation<? super Unit> continuation) {
