...
public final class FlowExtKt$simpleRunningReduce$1$1$emit$1 extends ContinuationImpl {
    ...
    public FlowExtKt$simpleRunningReduce$1$1$emit$1(FlowExtKt$simpleRunningReduce$1.AnonymousClass1<? super T> r1, Continuation<? super FlowExtKt$simpleRunningReduce$1$1$emit$1> continuation) {
        super(continuation);
        this.this$0 = r1;
    }
