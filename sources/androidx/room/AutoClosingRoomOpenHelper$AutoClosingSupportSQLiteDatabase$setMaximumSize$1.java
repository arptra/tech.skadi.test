...
public final class AutoClosingRoomOpenHelper$AutoClosingSupportSQLiteDatabase$setMaximumSize$1 extends Lambda implements Function1<SupportSQLiteDatabase, Long> {
    ...
    public final Long invoke(@NotNull SupportSQLiteDatabase supportSQLiteDatabase) {
        ...
        return Long.valueOf(supportSQLiteDatabase.X(this.$numBytes));
    }
}
