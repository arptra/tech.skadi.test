...
public final class AutoClosingRoomOpenHelper$AutoClosingSupportSQLiteDatabase$isReadOnly$1 extends Lambda implements Function1<SupportSQLiteDatabase, Boolean> {
    ...
    public final Boolean invoke(@NotNull SupportSQLiteDatabase supportSQLiteDatabase) {
        ...
        return Boolean.valueOf(supportSQLiteDatabase.j0());
    }
}
