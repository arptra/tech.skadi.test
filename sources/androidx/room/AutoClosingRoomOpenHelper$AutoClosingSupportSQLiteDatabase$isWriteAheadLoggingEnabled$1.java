...
public final class AutoClosingRoomOpenHelper$AutoClosingSupportSQLiteDatabase$isWriteAheadLoggingEnabled$1 extends Lambda implements Function1<SupportSQLiteDatabase, Boolean> {
    ...
    public final Boolean invoke(@NotNull SupportSQLiteDatabase supportSQLiteDatabase) {
        ...
        return Boolean.valueOf(supportSQLiteDatabase.u0());
    }
}
