...
public final class AutoClosingRoomOpenHelper$AutoClosingSupportSqliteStatement$simpleQueryForLong$1 extends Lambda implements Function1<SupportSQLiteStatement, Long> {
    ...
    public final Long invoke(@NotNull SupportSQLiteStatement supportSQLiteStatement) {
        ...
        return Long.valueOf(supportSQLiteStatement.A());
    }
}
