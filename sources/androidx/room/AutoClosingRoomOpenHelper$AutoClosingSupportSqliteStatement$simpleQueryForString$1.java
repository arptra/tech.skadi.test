...
public final class AutoClosingRoomOpenHelper$AutoClosingSupportSqliteStatement$simpleQueryForString$1 extends Lambda implements Function1<SupportSQLiteStatement, String> {
    ...
    public final String invoke(@NotNull SupportSQLiteStatement supportSQLiteStatement) {
        ...
        return supportSQLiteStatement.Y();
    }
}
