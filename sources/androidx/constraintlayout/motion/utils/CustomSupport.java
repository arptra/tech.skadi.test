...
public class CustomSupport {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f549a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f549a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f549a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f549a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f549a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f549a     // Catch:{ NoSuchFieldError -> 0x0054 }
    ...
    public static void b(ConstraintAttribute constraintAttribute, View view, float[] fArr) {
        ...
        try {
            boolean z = true;
            switch (AnonymousClass1.f549a[constraintAttribute.d().ordinal()]) {
                case 1:
            ...
            Log.e("CustomSupport", "no method " + str + " on View \"" + Debug.d(view) + "\"");
            e.printStackTrace();
        } catch (IllegalAccessException e2) {
            Log.e("CustomSupport", "cannot access method " + str + " on View \"" + Debug.d(view) + "\"");
            e2.printStackTrace();
