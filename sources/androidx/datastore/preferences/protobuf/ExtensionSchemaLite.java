...
final class ExtensionSchemaLite extends ExtensionSchema<GeneratedMessageLite.ExtensionDescriptor> {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x00cc }
            ...
            L_0x00cc:
                int[] r0 = f1079a     // Catch:{ NoSuchFieldError -> 0x00d8 }
    ...
    public Object g(Reader reader, Object obj, ExtensionRegistryLite extensionRegistryLite, FieldSet fieldSet, Object obj2, UnknownFieldSchema unknownFieldSchema) {
        ...
        if (!generatedExtension.b.isRepeated() || !generatedExtension.b.isPacked()) {
            if (generatedExtension.a() != WireFormat.FieldType.ENUM) {
                switch (AnonymousClass1.f1079a[generatedExtension.a().ordinal()]) {
                    case 1:
                    ...
                    case 16:
                        ...
                        break;
                    case 17:
                        obj3 = reader.e(generatedExtension.b().getClass(), extensionRegistryLite);
                        break;
                    case 18:
                        obj3 = reader.b(generatedExtension.b().getClass(), extensionRegistryLite);
                        break;
                    default:
                        obj3 = null;
                        break;
                ...
                if (generatedExtension.b.d().findValueByNumber(readInt32) == null) {
                    return SchemaUtil.L(c, readInt32, obj2, unknownFieldSchema);
                }
                obj3 = Integer.valueOf(readInt32);
            }
            if (generatedExtension.d()) {
                fieldSet.a(generatedExtension.b, obj3);
            } else {
                int i = AnonymousClass1.f1079a[generatedExtension.a().ordinal()];
                if ((i == 17 || i == 18) && (h = fieldSet.h(generatedExtension.b)) != null) {
                    obj3 = Internal.h(h, obj3);
                }
                fieldSet.w(generatedExtension.b, obj3);
            }
        } else {
            switch (AnonymousClass1.f1079a[generatedExtension.a().ordinal()]) {
                case 1:
                ...
                case 14:
                    ...
                    obj2 = SchemaUtil.z(c, arrayList, generatedExtension.b.d(), obj2, unknownFieldSchema);
                    break;
                default:
                    throw new IllegalStateException("Type cannot be packed: " + generatedExtension.b.getLiteType());
            }
            fieldSet.w(generatedExtension.b, arrayList);
        }
        return obj2;
    }
    ...
    public void h(Reader reader, Object obj, ExtensionRegistryLite extensionRegistryLite, FieldSet fieldSet) {
        GeneratedMessageLite.GeneratedExtension generatedExtension = (GeneratedMessageLite.GeneratedExtension) obj;
        fieldSet.w(generatedExtension.b, reader.b(generatedExtension.b().getClass(), extensionRegistryLite));
    }
    ...
    public void i(ByteString byteString, Object obj, ExtensionRegistryLite extensionRegistryLite, FieldSet fieldSet) {
        ...
        BinaryReader h = BinaryReader.h(ByteBuffer.wrap(byteString.toByteArray()), true);
        Protobuf.a().b(buildPartial, h, extensionRegistryLite);
        fieldSet.w(generatedExtension.b, buildPartial);
    ...
    public void j(Writer writer, Map.Entry entry) {
        ...
        if (extensionDescriptor.isRepeated()) {
            switch (AnonymousClass1.f1079a[extensionDescriptor.getLiteType().ordinal()]) {
                case 1:
            ...
            switch (AnonymousClass1.f1079a[extensionDescriptor.getLiteType().ordinal()]) {
                ...
                case 16:
                    ...
                    return;
                case 17:
                    writer.e(extensionDescriptor.getNumber(), entry.getValue(), Protobuf.a().d(entry.getValue().getClass()));
                    return;
                case 18:
                    writer.b(extensionDescriptor.getNumber(), entry.getValue(), Protobuf.a().d(entry.getValue().getClass()));
                    return;
                default:
                    return;
            }
