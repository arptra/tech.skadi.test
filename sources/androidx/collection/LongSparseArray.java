...
public class LongSparseArray<E> implements Cloneable {
    ...
    public int indexOfKey(long j) {
        ...
        return ContainerHelpers.b(this.mKeys, this.mSize, j);
    }
    ...
    public void put(long j, E e) {
        int b = ContainerHelpers.b(this.mKeys, this.mSize, j);
        if (b >= 0) {
            this.mValues[b] = e;
            return;
        }
        ...
        if (this.mGarbage && i2 >= this.mKeys.length) {
            c();
            i = ~ContainerHelpers.b(this.mKeys, this.mSize, j);
        }
        int i3 = this.mSize;
        if (i3 >= this.mKeys.length) {
            int f = ContainerHelpers.f(i3 + 1);
            long[] jArr = new long[f];
    ...
    public LongSparseArray(int i) {
        ...
        this.mKeys = new long[f];
        this.mValues = new Object[f];
    }
