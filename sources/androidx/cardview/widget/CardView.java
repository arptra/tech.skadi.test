...
public class CardView extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!(cardViewImpl instanceof CardViewApi21Impl)) {
            ...
            if (mode == Integer.MIN_VALUE || mode == 1073741824) {
                i = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil((double) cardViewImpl.f(this.mCardViewDelegate)), View.MeasureSpec.getSize(i)), mode);
            }
            int mode2 = View.MeasureSpec.getMode(i2);
            if (mode2 == Integer.MIN_VALUE || mode2 == 1073741824) {
                i2 = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil((double) cardViewImpl.c(this.mCardViewDelegate)), View.MeasureSpec.getSize(i2)), mode2);
            }
    ...
    public void setCardBackgroundColor(@ColorInt int i) {
        IMPL.o(this.mCardViewDelegate, ColorStateList.valueOf(i));
    }
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        IMPL.l(r3, context, colorStateList, dimension, dimension2, f);
    }
}
