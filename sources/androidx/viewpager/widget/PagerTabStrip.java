...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public void onDraw(Canvas canvas) {
        ...
        this.mTabPaint.setColor((this.mTabAlpha << 24) | (this.mIndicatorColor & Http2CodecUtil.MAX_FRAME_SIZE_UPPER_BOUND));
        float f = (float) height;
        canvas.drawRect((float) left, (float) (height - this.mIndicatorHeight), (float) right, f, this.mTabPaint);
        if (this.mDrawFullUnderline) {
            this.mTabPaint.setColor((this.mIndicatorColor & Http2CodecUtil.MAX_FRAME_SIZE_UPPER_BOUND) | -16777216);
