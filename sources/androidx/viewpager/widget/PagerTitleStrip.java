...
public class PagerTitleStrip extends ViewGroup {
    ...
    public static class SingleLineAllCapsTransform extends SingleLineTransformationMethod {
        ...
        /* renamed from: a  reason: collision with root package name */
        public Locale f1912a;

        public SingleLineAllCapsTransform(Context context) {
            this.f1912a = context.getResources().getConfiguration().locale;
        }

        public CharSequence getTransformation(CharSequence charSequence, View view) {
            CharSequence transformation = super.getTransformation(charSequence, view);
            if (transformation != null) {
                return transformation.toString().toUpperCase(this.f1912a);
            }
            return null;
        }
    }
    ...
    public void setNonPrimaryAlpha(@FloatRange float f) {
        ...
        int i2 = (i << 24) | (this.mTextColor & Http2CodecUtil.MAX_FRAME_SIZE_UPPER_BOUND);
    ...
    public void setTextColor(@ColorInt int i) {
        ...
        int i2 = (this.mNonPrimaryAlpha << 24) | (this.mTextColor & Http2CodecUtil.MAX_FRAME_SIZE_UPPER_BOUND);
        this.mPrevText.setTextColor(i2);
        this.mNextText.setTextColor(i2);
    }
    ...
    public PagerTitleStrip(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        if (resourceId != 0) {
            TextViewCompat.n(this.mPrevText, resourceId);
            TextViewCompat.n(this.mCurrText, resourceId);
            TextViewCompat.n(this.mNextText, resourceId);
        }
