...
public final class ViewModelLazy<VM extends ViewModel> implements Lazy<VM> {
    ...
    public ViewModel getValue() {
        ...
        ViewModel viewModel2 = new ViewModelProvider((ViewModelStore) this.b.invoke(), (ViewModelProvider.Factory) this.c.invoke(), (CreationExtras) this.d.invoke()).get(JvmClassMappingKt.getJavaClass(this.f1394a));
        this.e = viewModel2;
        return viewModel2;
    }
