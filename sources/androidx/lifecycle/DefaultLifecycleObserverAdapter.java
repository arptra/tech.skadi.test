...
public final class DefaultLifecycleObserverAdapter implements LifecycleEventObserver {
    ...
    public DefaultLifecycleObserverAdapter(DefaultLifecycleObserver defaultLifecycleObserver, LifecycleEventObserver lifecycleEventObserver) {
        ...
        this.f1352a = defaultLifecycleObserver;
    ...
    public void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[event.ordinal()]) {
            case 1:
                this.f1352a.onCreate(lifecycleOwner);
                break;
            case 2:
                this.f1352a.onStart(lifecycleOwner);
                break;
            case 3:
                this.f1352a.onResume(lifecycleOwner);
                break;
            case 4:
                this.f1352a.onPause(lifecycleOwner);
                break;
            case 5:
                this.f1352a.onStop(lifecycleOwner);
                break;
            case 6:
                this.f1352a.onDestroy(lifecycleOwner);
                break;
            case 7:
