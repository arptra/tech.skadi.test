...
public class AppCompatViewInflater {
    ...
    public static class DeclaredOnClickListener implements View.OnClickListener {
        ...
        public final void a(Context context) {
            ...
            int id = this.f179a.getId();
            if (id == -1) {
                str = "";
            } else {
                str = " with id '" + this.f179a.getContext().getResources().getResourceEntryName(id) + "'";
            }
            throw new IllegalStateException("Could not find method " + this.b + "(View) in a parent or ancestor Context for android:onClick attribute defined on view " + this.f179a.getClass() + str);
        }

        public void onClick(View view) {
            if (this.c == null) {
                a(this.f179a.getContext());
            }
            try {
    ...
    public final View d(Context context, String str, AttributeSet attributeSet) {
        ...
        try {
            ...
            if (-1 == str.indexOf(46)) {
                ...
                View c2 = c(context, str, (String) null);
    ...
    public final View createView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (view2 == null && context != context2) {
            view2 = d(context2, str, attributeSet);
        }
        if (view2 != null) {
