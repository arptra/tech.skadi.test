...
public class MenuBuilder implements SupportMenu {
    ...
    public static int f(ArrayList arrayList, int i) {
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            if (((MenuItemImpl) arrayList.get(size)).d() <= i) {
                return size + 1;
            }
        }
        return 0;
    ...
    public MenuItem addInternal(int i, int i2, int i3, CharSequence charSequence) {
        int g = g(i3);
        MenuItemImpl a2 = a(i, i2, i3, g, charSequence, this.mDefaultShowAsAction);
        ContextMenu.ContextMenuInfo contextMenuInfo = this.mCurrentMenuInfo;
        if (contextMenuInfo != null) {
            a2.s(contextMenuInfo);
        }
    ...
    public final boolean e(SubMenuBuilder subMenuBuilder, MenuPresenter menuPresenter) {
        boolean z = false;
        if (this.mPresenters.isEmpty()) {
            return false;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:4:0x0019, code lost:
        if (androidx.core.view.ViewConfigurationCompat.k(android.view.ViewConfiguration.get(r2.mContext), r2.mContext) != false) goto L_0x001d;
     */
    ...
    public final void j(boolean r3) {
        /*
            ...
            boolean r3 = androidx.core.view.ViewConfigurationCompat.k(r3, r1)
            if (r3 == 0) goto L_0x001c
            goto L_0x001d
        L_0x001c:
            r0 = 0
        L_0x001d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.view.menu.MenuBuilder.j(boolean):void");
    }
    ...
    public void setExclusiveItemChecked(MenuItem menuItem) {
        ...
        for (int i = 0; i < size; i++) {
            MenuItemImpl menuItemImpl = this.mItems.get(i);
            if (menuItemImpl.getGroupId() == groupId && menuItemImpl.k() && menuItemImpl.isCheckable()) {
    ...
    public void setGroupVisible(int i, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            MenuItemImpl menuItemImpl = this.mItems.get(i2);
            if (menuItemImpl.getGroupId() == i && menuItemImpl.v(z)) {
                z2 = true;
            }
        }
        if (z2) {
    ...
    public boolean performItemAction(MenuItem menuItem, MenuPresenter menuPresenter, int i) {
        ...
        boolean i2 = menuItemImpl.i();
        ActionProvider supportActionProvider = menuItemImpl.getSupportActionProvider();
        boolean z = supportActionProvider != null && supportActionProvider.hasSubMenu();
        if (menuItemImpl.h()) {
            i2 |= menuItemImpl.expandActionView();
            if (i2) {
                close(true);
            }
            ...
            if (!menuItemImpl.hasSubMenu()) {
                menuItemImpl.u(new SubMenuBuilder(getContext(), this, menuItemImpl));
            }
            SubMenuBuilder subMenuBuilder = (SubMenuBuilder) menuItemImpl.getSubMenu();
            if (z) {
                supportActionProvider.onPrepareSubMenu(subMenuBuilder);
            }
            i2 |= e(subMenuBuilder, menuPresenter);
            if (!i2) {
                close(true);
            }
        } else if ((i & 1) == 0) {
    ...
    public MenuBuilder setHeaderIconInt(int i) {
        i(0, (CharSequence) null, i, (Drawable) null, (View) null);
        return this;
    }

    public MenuBuilder setHeaderTitleInt(int i) {
        i(i, (CharSequence) null, 0, (Drawable) null, (View) null);
        return this;
    }
