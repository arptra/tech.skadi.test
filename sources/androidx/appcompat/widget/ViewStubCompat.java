...
public final class ViewStubCompat extends View {
    ...
    public View a() {
        ...
        } else if (this.f376a != 0) {
            ViewGroup viewGroup = (ViewGroup) parent;
            LayoutInflater layoutInflater = this.d;
            if (layoutInflater == null) {
                layoutInflater = LayoutInflater.from(getContext());
            }
            View inflate = layoutInflater.inflate(this.f376a, viewGroup, false);
            int i = this.b;
            if (i != -1) {
                inflate.setId(i);
            }
    ...
    public ViewStubCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.f376a = obtainStyledAttributes.getResourceId(R.styleable.ViewStubCompat_android_layout, 0);
