...
public abstract class ForwardingListener implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public static boolean d(View view, float f, float f2, float f3) {
        float f4 = -f3;
    ...
    public final boolean b(MotionEvent motionEvent) {
        ...
        f(dropDownListView, obtainNoHistory);
        boolean f = dropDownListView.f(obtainNoHistory, this.mActivePointerId);
    ...
    public final boolean c(android.view.MotionEvent r6) {
        ...
        L_0x006d:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.ForwardingListener.c(android.view.MotionEvent):boolean");
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (z2) {
            ...
            z = c(motionEvent) && onForwardingStarted();
            if (z) {
                long uptimeMillis = SystemClock.uptimeMillis();
                MotionEvent obtain = MotionEvent.obtain(uptimeMillis, uptimeMillis, 3, 0.0f, 0.0f, 0);
