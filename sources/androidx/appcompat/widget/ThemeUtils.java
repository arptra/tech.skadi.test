...
public class ThemeUtils {
    ...
    public static final ThreadLocal f362a = new ThreadLocal();
    ...
    public static int c(Context context, int i2) {
        int[] iArr = j;
        iArr[0] = i2;
        TintTypedArray u = TintTypedArray.u(context, (AttributeSet) null, iArr);
        try {
            return u.b(0, 0);
        } finally {
            u.w();
    ...
    public static int d(Context context, int i2, float f2) {
        int c2 = c(context, i2);
        return ColorUtils.k(c2, Math.round(((float) Color.alpha(c2)) * f2));
    }
