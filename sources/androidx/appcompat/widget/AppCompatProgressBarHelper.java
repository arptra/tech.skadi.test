...
class AppCompatProgressBarHelper {
    ...
    public final ProgressBar f290a;
    public Bitmap b;
    ...
    public void c(AttributeSet attributeSet, int i) {
        TintTypedArray v = TintTypedArray.v(this.f290a.getContext(), attributeSet, c, i, 0);
        Drawable h = v.h(0);
        if (h != null) {
            this.f290a.setIndeterminateDrawable(e(h));
        }
        Drawable h2 = v.h(1);
        if (h2 != null) {
            this.f290a.setProgressDrawable(d(h2, false));
        }
        v.w();
    }
    ...
    public Drawable d(Drawable drawable, boolean z) {
        if (drawable instanceof WrappedDrawable) {
            ...
            for (int i2 = 0; i2 < numberOfLayers; i2++) {
                ...
                Api23Impl.a(layerDrawable, layerDrawable2, i2);
            }
