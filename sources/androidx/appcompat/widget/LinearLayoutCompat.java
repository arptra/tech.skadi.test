...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public void drawDividersHorizontal(Canvas canvas) {
        ...
        for (int i3 = 0; i3 < virtualChildCount; i3++) {
            ...
            if (!(virtualChildAt == null || virtualChildAt.getVisibility() == 8 || !hasDividerBeforeChildAt(i3))) {
                LayoutParams layoutParams = (LayoutParams) virtualChildAt.getLayoutParams();
                drawVerticalDivider(canvas, b ? virtualChildAt.getRight() + layoutParams.rightMargin : (virtualChildAt.getLeft() - layoutParams.leftMargin) - this.mDividerWidth);
            }
        }
    ...
    public void layoutHorizontal(int r25, int r26, int r27, int r28) {
        /*
            ...
            int r1 = androidx.core.view.ViewCompat.z(r24)
    ...
    public void layoutVertical(int i, int i2, int i3, int i4) {
        ...
        while (i13 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                int b = GravityCompat.b(i14, ViewCompat.z(this)) & 7;
                if (b == 1) {
                ...
                c(virtualChildAt, i15, i16 + getLocationOffset(virtualChildAt), measuredWidth, measuredHeight);
    ...
    public LinearLayoutCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TintTypedArray v = TintTypedArray.v(context, attributeSet, R.styleable.LinearLayoutCompat, i, 0);
        ViewCompat.s0(this, context, R.styleable.LinearLayoutCompat, attributeSet, v.r(), i, 0);
