        ...
        AnonymousClass1 r0 = new MethodChannel.MethodCallHandler() {
            public void onMethodCall(@NonNull MethodCall methodCall, @NonNull MethodChannel.Result result) {
                if (LocalizationChannel.this.localizationMessageHandler != null) {
                    ...
                    try {
                        result.success(LocalizationChannel.this.localizationMessageHandler.getStringResource(jSONObject.getString(IntentKey.ACTIVITY.ACTION_KEY), jSONObject.has("locale") ? jSONObject.getString("locale") : null));
