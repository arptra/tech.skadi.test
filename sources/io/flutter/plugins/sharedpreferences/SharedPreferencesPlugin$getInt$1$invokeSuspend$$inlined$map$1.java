...
public final class SharedPreferencesPlugin$getInt$1$invokeSuspend$$inlined$map$1 implements Flow<Long> {
    final /* synthetic */ Preferences.Key $preferencesKey$inlined;
    final /* synthetic */ Flow $this_unsafeTransform$inlined;

    public SharedPreferencesPlugin$getInt$1$invokeSuspend$$inlined$map$1(Flow flow, Preferences.Key key) {
