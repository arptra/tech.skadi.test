...
public final class SharedPreferencesPlugin$getString$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull T t) {
        ...
        if (i == 0) {
            ...
            SharedPreferencesPlugin$getString$1$invokeSuspend$$inlined$map$1 sharedPreferencesPlugin$getString$1$invokeSuspend$$inlined$map$1 = new SharedPreferencesPlugin$getString$1$invokeSuspend$$inlined$map$1(SharedPreferencesPluginKt.getSharedPreferencesDataStore(access$getContext$p).getData(), f);
            Ref.ObjectRef<String> objectRef2 = this.$value;
            this.L$0 = objectRef2;
            this.label = 1;
            T y = FlowKt.y(sharedPreferencesPlugin$getString$1$invokeSuspend$$inlined$map$1, this);
