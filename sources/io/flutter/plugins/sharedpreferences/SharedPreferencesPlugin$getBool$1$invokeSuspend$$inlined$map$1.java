...
public final class SharedPreferencesPlugin$getBool$1$invokeSuspend$$inlined$map$1 implements Flow<Boolean> {
    final /* synthetic */ Preferences.Key $preferencesKey$inlined;
    final /* synthetic */ Flow $this_unsafeTransform$inlined;

    public SharedPreferencesPlugin$getBool$1$invokeSuspend$$inlined$map$1(Flow flow, Preferences.Key key) {
