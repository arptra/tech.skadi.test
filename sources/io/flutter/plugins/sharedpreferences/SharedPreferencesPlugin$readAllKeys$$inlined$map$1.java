...
public final class SharedPreferencesPlugin$readAllKeys$$inlined$map$1 implements Flow<Set<? extends Preferences.Key<?>>> {
    final /* synthetic */ Flow $this_unsafeTransform$inlined;

    public SharedPreferencesPlugin$readAllKeys$$inlined$map$1(Flow flow) {
        this.$this_unsafeTransform$inlined = flow;
    }

    @Nullable
    public Object collect(@NotNull final FlowCollector flowCollector, @NotNull Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new FlowCollector<Preferences>() {
