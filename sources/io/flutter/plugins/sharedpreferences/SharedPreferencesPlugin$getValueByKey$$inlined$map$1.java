...
public final class SharedPreferencesPlugin$getValueByKey$$inlined$map$1 implements Flow<Object> {
    final /* synthetic */ Preferences.Key $key$inlined;
    final /* synthetic */ Flow $this_unsafeTransform$inlined;

    public SharedPreferencesPlugin$getValueByKey$$inlined$map$1(Flow flow, Preferences.Key key) {
    ...
    public Object collect(@NotNull final FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        final Preferences.Key key = this.$key$inlined;
