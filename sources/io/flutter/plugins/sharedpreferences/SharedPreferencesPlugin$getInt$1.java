...
public final class SharedPreferencesPlugin$getInt$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull T t) {
        ...
        if (i == 0) {
            ...
            Preferences.Key e = PreferencesKeys.e(this.$key);
            Context access$getContext$p = this.this$0.context;
            if (access$getContext$p == null) {
                Intrinsics.throwUninitializedPropertyAccessException("context");
                access$getContext$p = null;
            }
            SharedPreferencesPlugin$getInt$1$invokeSuspend$$inlined$map$1 sharedPreferencesPlugin$getInt$1$invokeSuspend$$inlined$map$1 = new SharedPreferencesPlugin$getInt$1$invokeSuspend$$inlined$map$1(SharedPreferencesPluginKt.getSharedPreferencesDataStore(access$getContext$p).getData(), e);
            Ref.ObjectRef<Long> objectRef2 = this.$value;
            this.L$0 = objectRef2;
            this.label = 1;
            T y = FlowKt.y(sharedPreferencesPlugin$getInt$1$invokeSuspend$$inlined$map$1, this);
