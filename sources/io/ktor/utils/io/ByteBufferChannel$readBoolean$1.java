...
public final class ByteBufferChannel$readBoolean$1 extends ContinuationImpl {
    ...
    public ByteBufferChannel$readBoolean$1(ByteBufferChannel byteBufferChannel, Continuation<? super ByteBufferChannel$readBoolean$1> continuation) {
        super(continuation);
