...
public final class CaseInsensitiveMap$keys$1 extends Lambda implements Function1<CaseInsensitiveString, String> {
    ...
    @NotNull
    public final String invoke(@NotNull CaseInsensitiveString caseInsensitiveString) {
