...
final class HttpClientEngineKt$config$1$create$1 extends Lambda implements Function1<HttpClientEngineConfig, Unit> {
    final /* synthetic */ Function1<HttpClientEngineConfig, Unit> $block;
    final /* synthetic */ Function1<HttpClientEngineConfig, Unit> $nested;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public HttpClientEngineKt$config$1$create$1(Function1<HttpClientEngineConfig, Unit> function1, Function1<HttpClientEngineConfig, Unit> function12) {
        super(1);
    ...
    public final void invoke(@NotNull HttpClientEngineConfig httpClientEngineConfig) {
        Intrinsics.checkNotNullParameter(httpClientEngineConfig, "$this$create");
