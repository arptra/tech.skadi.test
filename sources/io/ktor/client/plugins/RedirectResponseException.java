...
public final class RedirectResponseException extends ResponseException {
    ...
    public RedirectResponseException(@NotNull HttpResponse httpResponse, @NotNull String str) {
        super(httpResponse, str);
        Intrinsics.checkNotNullParameter(httpResponse, "response");
        Intrinsics.checkNotNullParameter(str, "cachedResponseText");
        this.message = "Unhandled redirect: " + httpResponse.p0().f().getMethod().c() + ' ' + httpResponse.p0().f().T() + ". Status: " + httpResponse.f() + ". Text: \"" + str + '\"';
    }
    ...
    public RedirectResponseException(@NotNull HttpResponse httpResponse) {
