...
final class BuildersKt$webSocket$8 extends Lambda implements Function1<HttpRequestBuilder, Unit> {
    ...
    public BuildersKt$webSocket$8(String str, Function1<? super HttpRequestBuilder, Unit> function1) {
        super(1);
        this.$urlString = str;
    ...
    public final void invoke(@NotNull HttpRequestBuilder httpRequestBuilder) {
        ...
        httpRequestBuilder.i().y(URLProtocol.c.d());
        httpRequestBuilder.i().x(UtilsKt.a(httpRequestBuilder));
        URLParserKt.j(httpRequestBuilder.i(), this.$urlString);
