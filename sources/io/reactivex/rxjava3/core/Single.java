...
public abstract class Single<T> implements SingleSource<T> {
    ...
    public static <T> Single<T> ambArray(@NonNull SingleSource<? extends T>... singleSourceArr) {
        ...
        return singleSourceArr.length == 0 ? error((Supplier<? extends Throwable>) SingleInternalHelper.emptyThrower()) : singleSourceArr.length == 1 ? wrap(singleSourceArr[0]) : RxJavaPlugins.onAssembly(new SingleAmb(singleSourceArr, (Iterable) null));
    }
