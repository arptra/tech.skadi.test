...
public final class ObservableRefCount<T> extends Observable<T> {
    ...
    public void cancel(io.reactivex.rxjava3.internal.operators.observable.ObservableRefCount.RefConnection r5) {
        /*
            r4 = this;
            monitor-enter(r4)
            io.reactivex.rxjava3.internal.operators.observable.ObservableRefCount$RefConnection r0 = r4.connection     // Catch:{ all -> 0x0025 }
