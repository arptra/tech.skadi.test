...
public class Http2FrameLogger extends ChannelHandlerAdapter {
    ...
    public void logPriority(Direction direction, ChannelHandlerContext channelHandlerContext, int i, int i2, short s, boolean z) {
        if (isEnabled()) {
            ...
            InternalLogLevel internalLogLevel = this.level;
            Channel channel = channelHandlerContext.channel();
            String name = direction.name();
            internalLogger.log(internalLogLevel, "{} {} PRIORITY: streamId={} streamDependency={} weight={} exclusive={}", channel, name, Integer.valueOf(i), Integer.valueOf(i2), Short.valueOf(s), Boolean.valueOf(z));
        }
    }
