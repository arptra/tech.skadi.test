...
public class SocksCmdRequestDecoder extends ReplayingDecoder<State> {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                io.netty.handler.codec.socks.SocksCmdRequestDecoder$State[] r0 = io.netty.handler.codec.socks.SocksCmdRequestDecoder.State.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$io$netty$handler$codec$socks$SocksCmdRequestDecoder$State = r0
                r1 = 1
                io.netty.handler.codec.socks.SocksCmdRequestDecoder$State r2 = io.netty.handler.codec.socks.SocksCmdRequestDecoder.State.CHECK_PROTOCOL_VERSION     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r2 = r2.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r0[r2] = r1     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                r0 = 2
                int[] r2 = $SwitchMap$io$netty$handler$codec$socks$SocksCmdRequestDecoder$State     // Catch:{ NoSuchFieldError -> 0x001d }
                io.netty.handler.codec.socks.SocksCmdRequestDecoder$State r3 = io.netty.handler.codec.socks.SocksCmdRequestDecoder.State.READ_CMD_HEADER     // Catch:{ NoSuchFieldError -> 0x001d }
                int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2[r3] = r0     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                r2 = 3
                int[] r3 = $SwitchMap$io$netty$handler$codec$socks$SocksCmdRequestDecoder$State     // Catch:{ NoSuchFieldError -> 0x0028 }
                io.netty.handler.codec.socks.SocksCmdRequestDecoder$State r4 = io.netty.handler.codec.socks.SocksCmdRequestDecoder.State.READ_CMD_ADDRESS     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0058:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: io.netty.handler.codec.socks.SocksCmdRequestDecoder.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public void decode(io.netty.channel.ChannelHandlerContext r6, io.netty.buffer.ByteBuf r7, java.util.List<java.lang.Object> r8) throws java.lang.Exception {
        ...
        L_0x0036:
            byte r0 = r7.readByte()
            io.netty.handler.codec.socks.SocksCmdType r0 = io.netty.handler.codec.socks.SocksCmdType.valueOf((byte) r0)
            r5.cmdType = r0
            r7.skipBytes(r3)
            byte r0 = r7.readByte()
