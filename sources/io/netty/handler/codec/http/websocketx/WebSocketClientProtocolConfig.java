...
public final class WebSocketClientProtocolConfig {
    ...
    public static Builder newBuilder() {
        return new Builder(URI.create("https://localhost/"), (String) null, WebSocketVersion.V13, false, EmptyHttpHeaders.INSTANCE, 65536, true, false, true, WebSocketCloseStatus.NORMAL_CLOSURE, true, 10000, -1, false);
    }
