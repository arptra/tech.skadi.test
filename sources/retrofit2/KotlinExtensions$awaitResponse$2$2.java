...
public final class KotlinExtensions$awaitResponse$2$2 implements Callback<T> {
    ...
    public KotlinExtensions$awaitResponse$2$2(CancellableContinuation<? super Response<T>> cancellableContinuation) {
    ...
    public void onResponse(@NotNull Call<T> call, @NotNull Response<T> response) {
        ...
        this.$continuation.resumeWith(Result.m20constructorimpl(response));
    }
}
