...
public final class KotlinExtensions$await$4$2 implements Callback<T> {
    ...
    public KotlinExtensions$await$4$2(CancellableContinuation<? super T> cancellableContinuation) {
    ...
    public void onResponse(@NotNull Call<T> call, @NotNull Response<T> response) {
        ...
        if (response.isSuccessful()) {
            CancellableContinuation<T> cancellableContinuation = this.$continuation;
            Result.Companion companion = Result.Companion;
            cancellableContinuation.resumeWith(Result.m20constructorimpl(response.body()));
            return;
        }
