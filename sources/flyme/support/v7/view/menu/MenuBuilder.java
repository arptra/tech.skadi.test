...
public class MenuBuilder implements SupportMenu, FMenu {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:4:0x0019, code lost:
        if (shouldShowMenuShortcutsWhenKeyboardPresent(android.view.ViewConfiguration.get(r2.mContext), r2.mContext) != false) goto L_0x001d;
     */
    ...
    private void setShortcutsVisibleInner(boolean r3) {
        /*
            ...
            boolean r3 = shouldShowMenuShortcutsWhenKeyboardPresent(r3, r1)
            if (r3 == 0) goto L_0x001c
            goto L_0x001d
        L_0x001c:
            r0 = 0
        L_0x001d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: flyme.support.v7.view.menu.MenuBuilder.setShortcutsVisibleInner(boolean):void");
    }
    ...
    public FMenuItem findFMenuItem(int i) {
        MenuItem findItem = findItem(i);
        if (findItem == null) {
            return null;
        }
        if (findItem instanceof FMenuItem) {
            return (FMenuItem) findItem;
        }
