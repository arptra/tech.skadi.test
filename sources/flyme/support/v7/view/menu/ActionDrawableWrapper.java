...
public class ActionDrawableWrapper extends Drawable implements Drawable.Callback {
    private Drawable mDrawable;

    public ActionDrawableWrapper(Drawable drawable) {
        setWrappedDrawable(drawable);
    }

    private void setWrappedDrawable(@Nullable Drawable drawable) {
