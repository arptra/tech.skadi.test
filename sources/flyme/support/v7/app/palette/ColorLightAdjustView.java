...
public class ColorLightAdjustView extends View implements ColorChangeListener {
    private int centerY;
    ...
    public ColorLightAdjustView(Context context, @Nullable AttributeSet attributeSet) {
    ...
    private int[] generateLightGradient() {
    ...
    private void init() {
        this.gradientColors = generateLightGradient();
    ...
    private void setColor(int i) {
        this.mLeftSpaceDrawable.setTint(-1);
        this.mRightSpaceDrawable.setTint(-16777216);
        float lightForColor = (((float) this.mGradientColorWidth) * (1.0f - getLightForColor(i))) + ((float) this.mGradientColorStartX);
        this.mTouchPointX = lightForColor;
        adjustTouchX(lightForColor);
        invalidate();
    }
    ...
    public boolean onTouchEvent(android.view.MotionEvent r4) {
        ...
        L_0x0012:
            ...
            flyme.support.v7.app.palette.ColorManager r2 = flyme.support.v7.app.palette.ColorManager.getInstance()
            float r0 = r0 - r4
            r2.setCurrentLight(r0)
            r3.invalidate()
        L_0x0039:
            return r1
        */
