...
public abstract class AppCompatDelegate {
    private static final int FEATURE_ACTION_BAR_FLYME_FIRST = 1000;
    public static final int FEATURE_ACTION_BAR_NESTED_SCROLL = 1001;
    ...
    public abstract void hideBackTopButton();
    ...
    public abstract void setBackTopBackground(Drawable drawable);

    public abstract void setBackTopEnable(boolean z);
    ...
    public abstract void showBackTopButton();

    public abstract ActionMode startMultiChoiceActionMode(ActionMode.Callback callback);
