...
class AlertController {
    ...
    private final View.OnClickListener mButtonHandler = new View.OnClickListener() {
        ...
        public void onClick(android.view.View r3) {
            /*
                r2 = this;
                flyme.support.v7.app.AlertController r0 = flyme.support.v7.app.AlertController.this
            ...
            L_0x002a:
                ...
                r3.sendToTarget()
            L_0x002f:
                flyme.support.v7.app.AlertController r2 = flyme.support.v7.app.AlertController.this
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: flyme.support.v7.app.AlertController.AnonymousClass1.onClick(android.view.View):void");
        }
    };
    ...
    public static class AlertParams {
        ...
        public boolean mIsListItemCenter;
        public boolean mIsMultiChoice;
        public boolean mIsSingleChoice;
        public boolean mIsSingleMultiLines;
        public ArrayList<Pair<String, String>> mItemData;
        public CharSequence[] mItems;
        public String mLabelColumn;
        public ColorStateList mListItemColor;
        public ColorStateList[] mListItemColors;
        ...
        /* JADX WARNING: type inference failed for: r1v20, types: [flyme.support.v7.app.AlertController$AlertParams$2] */
        /* JADX WARNING: type inference failed for: r1v21, types: [flyme.support.v7.app.AlertController$AlertParams$1] */
        /* JADX WARNING: Multi-variable type inference failed */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        private void createListView(final flyme.support.v7.app.AlertController r10) {
            /*
                r9 = this;
                ...
                flyme.support.v7.app.AlertController$RecycleListView r0 = (flyme.support.v7.app.AlertController.RecycleListView) r0
                boolean r1 = r9.mIsMultiChoice
                if (r1 == 0) goto L_0x0034
                android.database.Cursor r1 = r9.mCursor
                if (r1 != 0) goto L_0x0025
                flyme.support.v7.app.AlertController$AlertParams$1 r8 = new flyme.support.v7.app.AlertController$AlertParams$1
                ...
                goto L_0x0069
            L_0x0025:
                flyme.support.v7.app.AlertController$AlertParams$2 r8 = new flyme.support.v7.app.AlertController$AlertParams$2
                android.content.Context r3 = r9.mContext
            ...
            L_0x005b:
                ...
                goto L_0x0069
            L_0x0060:
                flyme.support.v7.app.AlertController$CheckedItemAdapter r8 = new flyme.support.v7.app.AlertController$CheckedItemAdapter
                android.content.Context r1 = r9.mContext
                java.lang.CharSequence[] r3 = r9.mItems
                r8.<init>(r1, r4, r2, r3)
            L_0x0069:
                flyme.support.v7.app.AlertController$AlertParams$OnPrepareListViewListener r1 = r9.mOnPrepareListViewListener
            ...
            L_0x0070:
                ...
                flyme.support.v7.app.AlertController$AlertParams$3 r1 = new flyme.support.v7.app.AlertController$AlertParams$3
                r1.<init>(r10)
            ...
            L_0x0083:
                ...
                flyme.support.v7.app.AlertController$AlertParams$4 r1 = new flyme.support.v7.app.AlertController$AlertParams$4
                r1.<init>(r0, r10)
                r0.setOnItemClickListener(r1)
            L_0x008f:
            ...
            L_0x00a7:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: flyme.support.v7.app.AlertController.AlertParams.createListView(flyme.support.v7.app.AlertController):void");
        }

        public void apply(AlertController alertController) {
            if (alertController instanceof FlymeAlertController) {
                new FlymeAlertController.AlertParamsWrapper(this).apply((FlymeAlertController) alertController);
                return;
            }
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        this.mButtonIconDimen = obtainStyledAttributes.getDimensionPixelSize(R.styleable.AlertDialog_mzButtonIconDimen, 0);
    ...
    private void setupButtons(ViewGroup viewGroup) {
        ...
        this.mAnimationHelper.addTargetView(this.mButtonPositive, false);
        ...
        this.mAnimationHelper.addTargetView(this.mButtonNegative, false);
        ...
        this.mAnimationHelper.addTargetView(this.mButtonNeutral, false);
