...
public class AndroidStockBlurImpl implements BlurImpl {
    ...
    public boolean b(Context context, Bitmap bitmap, float f) {
        ...
        this.b.setRadius(f);
        Allocation createFromBitmap = Allocation.createFromBitmap(this.f4127a, bitmap, Allocation.MipmapControl.MIPMAP_NONE, 1);
        this.c = createFromBitmap;
        this.d = Allocation.createTyped(this.f4127a, createFromBitmap.getType());
        return true;
    }
    ...
    public void release() {
        ...
        RenderScript renderScript = this.f4127a;
