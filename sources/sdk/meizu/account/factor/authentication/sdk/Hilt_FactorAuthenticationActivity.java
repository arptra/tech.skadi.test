...
public abstract class Hilt_FactorAuthenticationActivity extends AppCompatActivity implements GeneratedComponentManagerHolder {
    private volatile ActivityComponentManager componentManager;
    private final Object componentManagerLock = new Object();
    private boolean injected = false;
    private SavedStateHandleHolder savedStateHandleHolder;

    public Hilt_FactorAuthenticationActivity() {
        _initHiltInternal();
    }
    ...
    private void _initHiltInternal() {
        addOnContextAvailableListener(new OnContextAvailableListener() {
            public void onContextAvailable(Context context) {
                Hilt_FactorAuthenticationActivity.this.inject();
            }
        });
    }
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((FactorAuthenticationActivity_GeneratedInjector) generatedComponent()).injectFactorAuthenticationActivity((FactorAuthenticationActivity) UnsafeCasts.unsafeCast(this));
        }
    }
    ...
    public Hilt_FactorAuthenticationActivity(int i) {
        super(i);
        _initHiltInternal();
    }
}
