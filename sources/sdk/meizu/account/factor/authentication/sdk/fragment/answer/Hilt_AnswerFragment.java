...
public abstract class Hilt_AnswerFragment extends BaseFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((AnswerFragment_GeneratedInjector) generatedComponent()).injectAnswerFragment((AnswerFragment) UnsafeCasts.unsafeCast(this));
        }
    }
