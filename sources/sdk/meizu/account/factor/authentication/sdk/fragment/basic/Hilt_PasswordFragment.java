...
public abstract class Hilt_PasswordFragment extends BasicAuthenticationFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((PasswordFragment_GeneratedInjector) generatedComponent()).injectPasswordFragment((PasswordFragment) UnsafeCasts.unsafeCast(this));
        }
    }
