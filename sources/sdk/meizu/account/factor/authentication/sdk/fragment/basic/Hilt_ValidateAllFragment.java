...
public abstract class Hilt_ValidateAllFragment extends BasicAuthFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ValidateAllFragment_GeneratedInjector) generatedComponent()).injectValidateAllFragment((ValidateAllFragment) UnsafeCasts.unsafeCast(this));
        }
    }
