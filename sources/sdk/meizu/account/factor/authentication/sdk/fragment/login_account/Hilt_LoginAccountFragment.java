...
import sdk.meizu.account.factor.authentication.sdk.fragment.base.BaseFragment;

public abstract class Hilt_LoginAccountFragment extends BaseFragment implements GeneratedComponentManagerHolder {
    ...
    public void inject() {
        if (!this.injected) {
            this.injected = true;
            ((LoginAccountFragment_GeneratedInjector) generatedComponent()).injectLoginAccountFragment((LoginAccountFragment) UnsafeCasts.unsafeCast(this));
        }
    }
